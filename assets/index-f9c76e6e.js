(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))r(s);new MutationObserver(s=>{for(const i of s)if(i.type==="childList")for(const o of i.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&r(o)}).observe(document,{childList:!0,subtree:!0});function n(s){const i={};return s.integrity&&(i.integrity=s.integrity),s.referrerPolicy&&(i.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?i.credentials="include":s.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function r(s){if(s.ep)return;s.ep=!0;const i=n(s);fetch(s.href,i)}})();function qu(t,e){const n=Object.create(null),r=t.split(",");for(let s=0;s<r.length;s++)n[r[s]]=!0;return e?s=>!!n[s.toLowerCase()]:s=>!!n[s]}const xe={},ds=[],Jt=()=>{},rw=()=>!1,sw=/^on[^a-z]/,Ga=t=>sw.test(t),Hu=t=>t.startsWith("onUpdate:"),at=Object.assign,Ku=(t,e)=>{const n=t.indexOf(e);n>-1&&t.splice(n,1)},iw=Object.prototype.hasOwnProperty,be=(t,e)=>iw.call(t,e),ce=Array.isArray,fs=t=>Qa(t)==="[object Map]",vg=t=>Qa(t)==="[object Set]",ge=t=>typeof t=="function",tt=t=>typeof t=="string",zu=t=>typeof t=="symbol",Be=t=>t!==null&&typeof t=="object",Eg=t=>Be(t)&&ge(t.then)&&ge(t.catch),wg=Object.prototype.toString,Qa=t=>wg.call(t),ow=t=>Qa(t).slice(8,-1),Tg=t=>Qa(t)==="[object Object]",Wu=t=>tt(t)&&t!=="NaN"&&t[0]!=="-"&&""+parseInt(t,10)===t,Yo=qu(",key,ref,ref_for,ref_key,onVnodeBeforeMount,onVnodeMounted,onVnodeBeforeUpdate,onVnodeUpdated,onVnodeBeforeUnmount,onVnodeUnmounted"),Ya=t=>{const e=Object.create(null);return n=>e[n]||(e[n]=t(n))},aw=/-(\w)/g,mn=Ya(t=>t.replace(aw,(e,n)=>n?n.toUpperCase():"")),cw=/\B([A-Z])/g,Fs=Ya(t=>t.replace(cw,"-$1").toLowerCase()),Ja=Ya(t=>t.charAt(0).toUpperCase()+t.slice(1)),ll=Ya(t=>t?`on${Ja(t)}`:""),Pi=(t,e)=>!Object.is(t,e),Jo=(t,e)=>{for(let n=0;n<t.length;n++)t[n](e)},pa=(t,e,n)=>{Object.defineProperty(t,e,{configurable:!0,enumerable:!1,value:n})},Bl=t=>{const e=parseFloat(t);return isNaN(e)?t:e};let zd;const jl=()=>zd||(zd=typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:typeof global<"u"?global:{});function Gu(t){if(ce(t)){const e={};for(let n=0;n<t.length;n++){const r=t[n],s=tt(r)?dw(r):Gu(r);if(s)for(const i in s)e[i]=s[i]}return e}else{if(tt(t))return t;if(Be(t))return t}}const lw=/;(?![^(]*\))/g,uw=/:([^]+)/,hw=/\/\*[^]*?\*\//g;function dw(t){const e={};return t.replace(hw,"").split(lw).forEach(n=>{if(n){const r=n.split(uw);r.length>1&&(e[r[0].trim()]=r[1].trim())}}),e}function Ft(t){let e="";if(tt(t))e=t;else if(ce(t))for(let n=0;n<t.length;n++){const r=Ft(t[n]);r&&(e+=r+" ")}else if(Be(t))for(const n in t)t[n]&&(e+=n+" ");return e.trim()}const fw="itemscope,allowfullscreen,formnovalidate,ismap,nomodule,novalidate,readonly",pw=qu(fw);function Ig(t){return!!t||t===""}const lD=t=>tt(t)?t:t==null?"":ce(t)||Be(t)&&(t.toString===wg||!ge(t.toString))?JSON.stringify(t,Ag,2):String(t),Ag=(t,e)=>e&&e.__v_isRef?Ag(t,e.value):fs(e)?{[`Map(${e.size})`]:[...e.entries()].reduce((n,[r,s])=>(n[`${r} =>`]=s,n),{})}:vg(e)?{[`Set(${e.size})`]:[...e.values()]}:Be(e)&&!ce(e)&&!Tg(e)?String(e):e;let Lt;class Rg{constructor(e=!1){this.detached=e,this._active=!0,this.effects=[],this.cleanups=[],this.parent=Lt,!e&&Lt&&(this.index=(Lt.scopes||(Lt.scopes=[])).push(this)-1)}get active(){return this._active}run(e){if(this._active){const n=Lt;try{return Lt=this,e()}finally{Lt=n}}}on(){Lt=this}off(){Lt=this.parent}stop(e){if(this._active){let n,r;for(n=0,r=this.effects.length;n<r;n++)this.effects[n].stop();for(n=0,r=this.cleanups.length;n<r;n++)this.cleanups[n]();if(this.scopes)for(n=0,r=this.scopes.length;n<r;n++)this.scopes[n].stop(!0);if(!this.detached&&this.parent&&!e){const s=this.parent.scopes.pop();s&&s!==this&&(this.parent.scopes[this.index]=s,s.index=this.index)}this.parent=void 0,this._active=!1}}}function Sg(t){return new Rg(t)}function gw(t,e=Lt){e&&e.active&&e.effects.push(t)}function Qu(){return Lt}function bg(t){Lt&&Lt.cleanups.push(t)}const Yu=t=>{const e=new Set(t);return e.w=0,e.n=0,e},Cg=t=>(t.w&ar)>0,Pg=t=>(t.n&ar)>0,mw=({deps:t})=>{if(t.length)for(let e=0;e<t.length;e++)t[e].w|=ar},_w=t=>{const{deps:e}=t;if(e.length){let n=0;for(let r=0;r<e.length;r++){const s=e[r];Cg(s)&&!Pg(s)?s.delete(t):e[n++]=s,s.w&=~ar,s.n&=~ar}e.length=n}},ga=new WeakMap;let ii=0,ar=1;const ql=30;let Qt;const Pr=Symbol(""),Hl=Symbol("");class Ju{constructor(e,n=null,r){this.fn=e,this.scheduler=n,this.active=!0,this.deps=[],this.parent=void 0,gw(this,r)}run(){if(!this.active)return this.fn();let e=Qt,n=Zn;for(;e;){if(e===this)return;e=e.parent}try{return this.parent=Qt,Qt=this,Zn=!0,ar=1<<++ii,ii<=ql?mw(this):Wd(this),this.fn()}finally{ii<=ql&&_w(this),ar=1<<--ii,Qt=this.parent,Zn=n,this.parent=void 0,this.deferStop&&this.stop()}}stop(){Qt===this?this.deferStop=!0:this.active&&(Wd(this),this.onStop&&this.onStop(),this.active=!1)}}function Wd(t){const{deps:e}=t;if(e.length){for(let n=0;n<e.length;n++)e[n].delete(t);e.length=0}}let Zn=!0;const Og=[];function Us(){Og.push(Zn),Zn=!1}function $s(){const t=Og.pop();Zn=t===void 0?!0:t}function Mt(t,e,n){if(Zn&&Qt){let r=ga.get(t);r||ga.set(t,r=new Map);let s=r.get(n);s||r.set(n,s=Yu()),kg(s)}}function kg(t,e){let n=!1;ii<=ql?Pg(t)||(t.n|=ar,n=!Cg(t)):n=!t.has(Qt),n&&(t.add(Qt),Qt.deps.push(t))}function Pn(t,e,n,r,s,i){const o=ga.get(t);if(!o)return;let a=[];if(e==="clear")a=[...o.values()];else if(n==="length"&&ce(t)){const c=Number(r);o.forEach((l,u)=>{(u==="length"||u>=c)&&a.push(l)})}else switch(n!==void 0&&a.push(o.get(n)),e){case"add":ce(t)?Wu(n)&&a.push(o.get("length")):(a.push(o.get(Pr)),fs(t)&&a.push(o.get(Hl)));break;case"delete":ce(t)||(a.push(o.get(Pr)),fs(t)&&a.push(o.get(Hl)));break;case"set":fs(t)&&a.push(o.get(Pr));break}if(a.length===1)a[0]&&Kl(a[0]);else{const c=[];for(const l of a)l&&c.push(...l);Kl(Yu(c))}}function Kl(t,e){const n=ce(t)?t:[...t];for(const r of n)r.computed&&Gd(r);for(const r of n)r.computed||Gd(r)}function Gd(t,e){(t!==Qt||t.allowRecurse)&&(t.scheduler?t.scheduler():t.run())}function yw(t,e){var n;return(n=ga.get(t))==null?void 0:n.get(e)}const vw=qu("__proto__,__v_isRef,__isVue"),Dg=new Set(Object.getOwnPropertyNames(Symbol).filter(t=>t!=="arguments"&&t!=="caller").map(t=>Symbol[t]).filter(zu)),Ew=Xu(),ww=Xu(!1,!0),Tw=Xu(!0),Qd=Iw();function Iw(){const t={};return["includes","indexOf","lastIndexOf"].forEach(e=>{t[e]=function(...n){const r=fe(this);for(let i=0,o=this.length;i<o;i++)Mt(r,"get",i+"");const s=r[e](...n);return s===-1||s===!1?r[e](...n.map(fe)):s}}),["push","pop","shift","unshift","splice"].forEach(e=>{t[e]=function(...n){Us();const r=fe(this)[e].apply(this,n);return $s(),r}}),t}function Aw(t){const e=fe(this);return Mt(e,"has",t),e.hasOwnProperty(t)}function Xu(t=!1,e=!1){return function(r,s,i){if(s==="__v_isReactive")return!t;if(s==="__v_isReadonly")return t;if(s==="__v_isShallow")return e;if(s==="__v_raw"&&i===(t?e?$w:Lg:e?xg:Mg).get(r))return r;const o=ce(r);if(!t){if(o&&be(Qd,s))return Reflect.get(Qd,s,i);if(s==="hasOwnProperty")return Aw}const a=Reflect.get(r,s,i);return(zu(s)?Dg.has(s):vw(s))||(t||Mt(r,"get",s),e)?a:qe(a)?o&&Wu(s)?a:a.value:Be(a)?t?Za(a):rn(a):a}}const Rw=Ng(),Sw=Ng(!0);function Ng(t=!1){return function(n,r,s,i){let o=n[r];if(Ts(o)&&qe(o)&&!qe(s))return!1;if(!t&&(!ma(s)&&!Ts(s)&&(o=fe(o),s=fe(s)),!ce(n)&&qe(o)&&!qe(s)))return o.value=s,!0;const a=ce(n)&&Wu(r)?Number(r)<n.length:be(n,r),c=Reflect.set(n,r,s,i);return n===fe(i)&&(a?Pi(s,o)&&Pn(n,"set",r,s):Pn(n,"add",r,s)),c}}function bw(t,e){const n=be(t,e);t[e];const r=Reflect.deleteProperty(t,e);return r&&n&&Pn(t,"delete",e,void 0),r}function Cw(t,e){const n=Reflect.has(t,e);return(!zu(e)||!Dg.has(e))&&Mt(t,"has",e),n}function Pw(t){return Mt(t,"iterate",ce(t)?"length":Pr),Reflect.ownKeys(t)}const Vg={get:Ew,set:Rw,deleteProperty:bw,has:Cw,ownKeys:Pw},Ow={get:Tw,set(t,e){return!0},deleteProperty(t,e){return!0}},kw=at({},Vg,{get:ww,set:Sw}),Zu=t=>t,Xa=t=>Reflect.getPrototypeOf(t);function No(t,e,n=!1,r=!1){t=t.__v_raw;const s=fe(t),i=fe(e);n||(e!==i&&Mt(s,"get",e),Mt(s,"get",i));const{has:o}=Xa(s),a=r?Zu:n?nh:Oi;if(o.call(s,e))return a(t.get(e));if(o.call(s,i))return a(t.get(i));t!==s&&t.get(e)}function Vo(t,e=!1){const n=this.__v_raw,r=fe(n),s=fe(t);return e||(t!==s&&Mt(r,"has",t),Mt(r,"has",s)),t===s?n.has(t):n.has(t)||n.has(s)}function Mo(t,e=!1){return t=t.__v_raw,!e&&Mt(fe(t),"iterate",Pr),Reflect.get(t,"size",t)}function Yd(t){t=fe(t);const e=fe(this);return Xa(e).has.call(e,t)||(e.add(t),Pn(e,"add",t,t)),this}function Jd(t,e){e=fe(e);const n=fe(this),{has:r,get:s}=Xa(n);let i=r.call(n,t);i||(t=fe(t),i=r.call(n,t));const o=s.call(n,t);return n.set(t,e),i?Pi(e,o)&&Pn(n,"set",t,e):Pn(n,"add",t,e),this}function Xd(t){const e=fe(this),{has:n,get:r}=Xa(e);let s=n.call(e,t);s||(t=fe(t),s=n.call(e,t)),r&&r.call(e,t);const i=e.delete(t);return s&&Pn(e,"delete",t,void 0),i}function Zd(){const t=fe(this),e=t.size!==0,n=t.clear();return e&&Pn(t,"clear",void 0,void 0),n}function xo(t,e){return function(r,s){const i=this,o=i.__v_raw,a=fe(o),c=e?Zu:t?nh:Oi;return!t&&Mt(a,"iterate",Pr),o.forEach((l,u)=>r.call(s,c(l),c(u),i))}}function Lo(t,e,n){return function(...r){const s=this.__v_raw,i=fe(s),o=fs(i),a=t==="entries"||t===Symbol.iterator&&o,c=t==="keys"&&o,l=s[t](...r),u=n?Zu:e?nh:Oi;return!e&&Mt(i,"iterate",c?Hl:Pr),{next(){const{value:h,done:d}=l.next();return d?{value:h,done:d}:{value:a?[u(h[0]),u(h[1])]:u(h),done:d}},[Symbol.iterator](){return this}}}}function $n(t){return function(...e){return t==="delete"?!1:this}}function Dw(){const t={get(i){return No(this,i)},get size(){return Mo(this)},has:Vo,add:Yd,set:Jd,delete:Xd,clear:Zd,forEach:xo(!1,!1)},e={get(i){return No(this,i,!1,!0)},get size(){return Mo(this)},has:Vo,add:Yd,set:Jd,delete:Xd,clear:Zd,forEach:xo(!1,!0)},n={get(i){return No(this,i,!0)},get size(){return Mo(this,!0)},has(i){return Vo.call(this,i,!0)},add:$n("add"),set:$n("set"),delete:$n("delete"),clear:$n("clear"),forEach:xo(!0,!1)},r={get(i){return No(this,i,!0,!0)},get size(){return Mo(this,!0)},has(i){return Vo.call(this,i,!0)},add:$n("add"),set:$n("set"),delete:$n("delete"),clear:$n("clear"),forEach:xo(!0,!0)};return["keys","values","entries",Symbol.iterator].forEach(i=>{t[i]=Lo(i,!1,!1),n[i]=Lo(i,!0,!1),e[i]=Lo(i,!1,!0),r[i]=Lo(i,!0,!0)}),[t,n,e,r]}const[Nw,Vw,Mw,xw]=Dw();function eh(t,e){const n=e?t?xw:Mw:t?Vw:Nw;return(r,s,i)=>s==="__v_isReactive"?!t:s==="__v_isReadonly"?t:s==="__v_raw"?r:Reflect.get(be(n,s)&&s in r?n:r,s,i)}const Lw={get:eh(!1,!1)},Fw={get:eh(!1,!0)},Uw={get:eh(!0,!1)},Mg=new WeakMap,xg=new WeakMap,Lg=new WeakMap,$w=new WeakMap;function Bw(t){switch(t){case"Object":case"Array":return 1;case"Map":case"Set":case"WeakMap":case"WeakSet":return 2;default:return 0}}function jw(t){return t.__v_skip||!Object.isExtensible(t)?0:Bw(ow(t))}function rn(t){return Ts(t)?t:th(t,!1,Vg,Lw,Mg)}function Fg(t){return th(t,!1,kw,Fw,xg)}function Za(t){return th(t,!0,Ow,Uw,Lg)}function th(t,e,n,r,s){if(!Be(t)||t.__v_raw&&!(e&&t.__v_isReactive))return t;const i=s.get(t);if(i)return i;const o=jw(t);if(o===0)return t;const a=new Proxy(t,o===2?r:n);return s.set(t,a),a}function er(t){return Ts(t)?er(t.__v_raw):!!(t&&t.__v_isReactive)}function Ts(t){return!!(t&&t.__v_isReadonly)}function ma(t){return!!(t&&t.__v_isShallow)}function Ug(t){return er(t)||Ts(t)}function fe(t){const e=t&&t.__v_raw;return e?fe(e):t}function ec(t){return pa(t,"__v_skip",!0),t}const Oi=t=>Be(t)?rn(t):t,nh=t=>Be(t)?Za(t):t;function rh(t){Zn&&Qt&&(t=fe(t),kg(t.dep||(t.dep=Yu())))}function sh(t,e){t=fe(t);const n=t.dep;n&&Kl(n)}function qe(t){return!!(t&&t.__v_isRef===!0)}function He(t){return Bg(t,!1)}function $g(t){return Bg(t,!0)}function Bg(t,e){return qe(t)?t:new qw(t,e)}class qw{constructor(e,n){this.__v_isShallow=n,this.dep=void 0,this.__v_isRef=!0,this._rawValue=n?e:fe(e),this._value=n?e:Oi(e)}get value(){return rh(this),this._value}set value(e){const n=this.__v_isShallow||ma(e)||Ts(e);e=n?e:fe(e),Pi(e,this._rawValue)&&(this._rawValue=e,this._value=n?e:Oi(e),sh(this))}}function ot(t){return qe(t)?t.value:t}const Hw={get:(t,e,n)=>ot(Reflect.get(t,e,n)),set:(t,e,n,r)=>{const s=t[e];return qe(s)&&!qe(n)?(s.value=n,!0):Reflect.set(t,e,n,r)}};function jg(t){return er(t)?t:new Proxy(t,Hw)}class Kw{constructor(e){this.dep=void 0,this.__v_isRef=!0;const{get:n,set:r}=e(()=>rh(this),()=>sh(this));this._get=n,this._set=r}get value(){return this._get()}set value(e){this._set(e)}}function zw(t){return new Kw(t)}function Ww(t){const e=ce(t)?new Array(t.length):{};for(const n in t)e[n]=qg(t,n);return e}class Gw{constructor(e,n,r){this._object=e,this._key=n,this._defaultValue=r,this.__v_isRef=!0}get value(){const e=this._object[this._key];return e===void 0?this._defaultValue:e}set value(e){this._object[this._key]=e}get dep(){return yw(fe(this._object),this._key)}}class Qw{constructor(e){this._getter=e,this.__v_isRef=!0,this.__v_isReadonly=!0}get value(){return this._getter()}}function Yw(t,e,n){return qe(t)?t:ge(t)?new Qw(t):Be(t)&&arguments.length>1?qg(t,e,n):He(t)}function qg(t,e,n){const r=t[e];return qe(r)?r:new Gw(t,e,n)}class Jw{constructor(e,n,r,s){this._setter=n,this.dep=void 0,this.__v_isRef=!0,this.__v_isReadonly=!1,this._dirty=!0,this.effect=new Ju(e,()=>{this._dirty||(this._dirty=!0,sh(this))}),this.effect.computed=this,this.effect.active=this._cacheable=!s,this.__v_isReadonly=r}get value(){const e=fe(this);return rh(e),(e._dirty||!e._cacheable)&&(e._dirty=!1,e._value=e.effect.run()),e._value}set value(e){this._setter(e)}}function Xw(t,e,n=!1){let r,s;const i=ge(t);return i?(r=t,s=Jt):(r=t.get,s=t.set),new Jw(r,s,i||!s,n)}function tr(t,e,n,r){let s;try{s=r?t(...r):t()}catch(i){tc(i,e,n)}return s}function Xt(t,e,n,r){if(ge(t)){const i=tr(t,e,n,r);return i&&Eg(i)&&i.catch(o=>{tc(o,e,n)}),i}const s=[];for(let i=0;i<t.length;i++)s.push(Xt(t[i],e,n,r));return s}function tc(t,e,n,r=!0){const s=e?e.vnode:null;if(e){let i=e.parent;const o=e.proxy,a=n;for(;i;){const l=i.ec;if(l){for(let u=0;u<l.length;u++)if(l[u](t,o,a)===!1)return}i=i.parent}const c=e.appContext.config.errorHandler;if(c){tr(c,null,10,[t,o,a]);return}}Zw(t,n,s,r)}function Zw(t,e,n,r=!0){console.error(t)}let ki=!1,zl=!1;const _t=[];let an=0;const ps=[];let In=null,Tr=0;const Hg=Promise.resolve();let ih=null;function jr(t){const e=ih||Hg;return t?e.then(this?t.bind(this):t):e}function eT(t){let e=an+1,n=_t.length;for(;e<n;){const r=e+n>>>1;Di(_t[r])<t?e=r+1:n=r}return e}function oh(t){(!_t.length||!_t.includes(t,ki&&t.allowRecurse?an+1:an))&&(t.id==null?_t.push(t):_t.splice(eT(t.id),0,t),Kg())}function Kg(){!ki&&!zl&&(zl=!0,ih=Hg.then(Wg))}function tT(t){const e=_t.indexOf(t);e>an&&_t.splice(e,1)}function nT(t){ce(t)?ps.push(...t):(!In||!In.includes(t,t.allowRecurse?Tr+1:Tr))&&ps.push(t),Kg()}function ef(t,e=ki?an+1:0){for(;e<_t.length;e++){const n=_t[e];n&&n.pre&&(_t.splice(e,1),e--,n())}}function zg(t){if(ps.length){const e=[...new Set(ps)];if(ps.length=0,In){In.push(...e);return}for(In=e,In.sort((n,r)=>Di(n)-Di(r)),Tr=0;Tr<In.length;Tr++)In[Tr]();In=null,Tr=0}}const Di=t=>t.id==null?1/0:t.id,rT=(t,e)=>{const n=Di(t)-Di(e);if(n===0){if(t.pre&&!e.pre)return-1;if(e.pre&&!t.pre)return 1}return n};function Wg(t){zl=!1,ki=!0,_t.sort(rT);const e=Jt;try{for(an=0;an<_t.length;an++){const n=_t[an];n&&n.active!==!1&&tr(n,null,14)}}finally{an=0,_t.length=0,zg(),ki=!1,ih=null,(_t.length||ps.length)&&Wg()}}function sT(t,e,...n){if(t.isUnmounted)return;const r=t.vnode.props||xe;let s=n;const i=e.startsWith("update:"),o=i&&e.slice(7);if(o&&o in r){const u=`${o==="modelValue"?"model":o}Modifiers`,{number:h,trim:d}=r[u]||xe;d&&(s=n.map(p=>tt(p)?p.trim():p)),h&&(s=n.map(Bl))}let a,c=r[a=ll(e)]||r[a=ll(mn(e))];!c&&i&&(c=r[a=ll(Fs(e))]),c&&Xt(c,t,6,s);const l=r[a+"Once"];if(l){if(!t.emitted)t.emitted={};else if(t.emitted[a])return;t.emitted[a]=!0,Xt(l,t,6,s)}}function Gg(t,e,n=!1){const r=e.emitsCache,s=r.get(t);if(s!==void 0)return s;const i=t.emits;let o={},a=!1;if(!ge(t)){const c=l=>{const u=Gg(l,e,!0);u&&(a=!0,at(o,u))};!n&&e.mixins.length&&e.mixins.forEach(c),t.extends&&c(t.extends),t.mixins&&t.mixins.forEach(c)}return!i&&!a?(Be(t)&&r.set(t,null),null):(ce(i)?i.forEach(c=>o[c]=null):at(o,i),Be(t)&&r.set(t,o),o)}function nc(t,e){return!t||!Ga(e)?!1:(e=e.slice(2).replace(/Once$/,""),be(t,e[0].toLowerCase()+e.slice(1))||be(t,Fs(e))||be(t,e))}let Nt=null,Qg=null;function _a(t){const e=Nt;return Nt=t,Qg=t&&t.type.__scopeId||null,e}function wn(t,e=Nt,n){if(!e||t._n)return t;const r=(...s)=>{r._d&&df(-1);const i=_a(e);let o;try{o=t(...s)}finally{_a(i),r._d&&df(1)}return o};return r._n=!0,r._c=!0,r._d=!0,r}function ul(t){const{type:e,vnode:n,proxy:r,withProxy:s,props:i,propsOptions:[o],slots:a,attrs:c,emit:l,render:u,renderCache:h,data:d,setupState:p,ctx:y,inheritAttrs:E}=t;let I,C;const V=_a(t);try{if(n.shapeFlag&4){const N=s||r;I=on(u.call(N,N,h,i,p,d,y)),C=c}else{const N=e;I=on(N.length>1?N(i,{attrs:c,slots:a,emit:l}):N(i,null)),C=e.props?c:iT(c)}}catch(N){_i.length=0,tc(N,t,1),I=_e(Nr)}let q=I;if(C&&E!==!1){const N=Object.keys(C),{shapeFlag:ee}=q;N.length&&ee&7&&(o&&N.some(Hu)&&(C=oT(C,o)),q=Vr(q,C))}return n.dirs&&(q=Vr(q),q.dirs=q.dirs?q.dirs.concat(n.dirs):n.dirs),n.transition&&(q.transition=n.transition),I=q,_a(V),I}const iT=t=>{let e;for(const n in t)(n==="class"||n==="style"||Ga(n))&&((e||(e={}))[n]=t[n]);return e},oT=(t,e)=>{const n={};for(const r in t)(!Hu(r)||!(r.slice(9)in e))&&(n[r]=t[r]);return n};function aT(t,e,n){const{props:r,children:s,component:i}=t,{props:o,children:a,patchFlag:c}=e,l=i.emitsOptions;if(e.dirs||e.transition)return!0;if(n&&c>=0){if(c&1024)return!0;if(c&16)return r?tf(r,o,l):!!o;if(c&8){const u=e.dynamicProps;for(let h=0;h<u.length;h++){const d=u[h];if(o[d]!==r[d]&&!nc(l,d))return!0}}}else return(s||a)&&(!a||!a.$stable)?!0:r===o?!1:r?o?tf(r,o,l):!0:!!o;return!1}function tf(t,e,n){const r=Object.keys(e);if(r.length!==Object.keys(t).length)return!0;for(let s=0;s<r.length;s++){const i=r[s];if(e[i]!==t[i]&&!nc(n,i))return!0}return!1}function cT({vnode:t,parent:e},n){for(;e&&e.subTree===t;)(t=e.vnode).el=n,e=e.parent}const lT=t=>t.__isSuspense;function uT(t,e){e&&e.pendingBranch?ce(t)?e.effects.push(...t):e.effects.push(t):nT(t)}function gi(t,e){return ah(t,null,e)}const Fo={};function nr(t,e,n){return ah(t,e,n)}function ah(t,e,{immediate:n,deep:r,flush:s,onTrack:i,onTrigger:o}=xe){var a;const c=Qu()===((a=et)==null?void 0:a.scope)?et:null;let l,u=!1,h=!1;if(qe(t)?(l=()=>t.value,u=ma(t)):er(t)?(l=()=>t,r=!0):ce(t)?(h=!0,u=t.some(N=>er(N)||ma(N)),l=()=>t.map(N=>{if(qe(N))return N.value;if(er(N))return Ar(N);if(ge(N))return tr(N,c,2)})):ge(t)?e?l=()=>tr(t,c,2):l=()=>{if(!(c&&c.isUnmounted))return d&&d(),Xt(t,c,3,[p])}:l=Jt,e&&r){const N=l;l=()=>Ar(N())}let d,p=N=>{d=V.onStop=()=>{tr(N,c,4)}},y;if(xi)if(p=Jt,e?n&&Xt(e,c,3,[l(),h?[]:void 0,p]):l(),s==="sync"){const N=rI();y=N.__watcherHandles||(N.__watcherHandles=[])}else return Jt;let E=h?new Array(t.length).fill(Fo):Fo;const I=()=>{if(V.active)if(e){const N=V.run();(r||u||(h?N.some((ee,ie)=>Pi(ee,E[ie])):Pi(N,E)))&&(d&&d(),Xt(e,c,3,[N,E===Fo?void 0:h&&E[0]===Fo?[]:E,p]),E=N)}else V.run()};I.allowRecurse=!!e;let C;s==="sync"?C=I:s==="post"?C=()=>kt(I,c&&c.suspense):(I.pre=!0,c&&(I.id=c.uid),C=()=>oh(I));const V=new Ju(l,C);e?n?I():E=V.run():s==="post"?kt(V.run.bind(V),c&&c.suspense):V.run();const q=()=>{V.stop(),c&&c.scope&&Ku(c.scope.effects,V)};return y&&y.push(q),q}function hT(t,e,n){const r=this.proxy,s=tt(t)?t.includes(".")?Yg(r,t):()=>r[t]:t.bind(r,r);let i;ge(e)?i=e:(i=e.handler,n=e);const o=et;Is(this);const a=ah(s,i.bind(r),n);return o?Is(o):Or(),a}function Yg(t,e){const n=e.split(".");return()=>{let r=t;for(let s=0;s<n.length&&r;s++)r=r[n[s]];return r}}function Ar(t,e){if(!Be(t)||t.__v_skip||(e=e||new Set,e.has(t)))return t;if(e.add(t),qe(t))Ar(t.value,e);else if(ce(t))for(let n=0;n<t.length;n++)Ar(t[n],e);else if(vg(t)||fs(t))t.forEach(n=>{Ar(n,e)});else if(Tg(t))for(const n in t)Ar(t[n],e);return t}function uD(t,e){const n=Nt;if(n===null)return t;const r=ac(n)||n.proxy,s=t.dirs||(t.dirs=[]);for(let i=0;i<e.length;i++){let[o,a,c,l=xe]=e[i];o&&(ge(o)&&(o={mounted:o,updated:o}),o.deep&&Ar(a),s.push({dir:o,instance:r,value:a,oldValue:void 0,arg:c,modifiers:l}))}return t}function vr(t,e,n,r){const s=t.dirs,i=e&&e.dirs;for(let o=0;o<s.length;o++){const a=s[o];i&&(a.oldValue=i[o].value);let c=a.dir[r];c&&(Us(),Xt(c,n,8,[t.el,a,t,e]),$s())}}function Bs(t,e){return ge(t)?(()=>at({name:t.name},e,{setup:t}))():t}const Xo=t=>!!t.type.__asyncLoader,Jg=t=>t.type.__isKeepAlive;function dT(t,e){Xg(t,"a",e)}function fT(t,e){Xg(t,"da",e)}function Xg(t,e,n=et){const r=t.__wdc||(t.__wdc=()=>{let s=n;for(;s;){if(s.isDeactivated)return;s=s.parent}return t()});if(rc(e,r,n),n){let s=n.parent;for(;s&&s.parent;)Jg(s.parent.vnode)&&pT(r,e,n,s),s=s.parent}}function pT(t,e,n,r){const s=rc(e,t,r,!0);sc(()=>{Ku(r[e],s)},n)}function rc(t,e,n=et,r=!1){if(n){const s=n[t]||(n[t]=[]),i=e.__weh||(e.__weh=(...o)=>{if(n.isUnmounted)return;Us(),Is(n);const a=Xt(e,n,t,o);return Or(),$s(),a});return r?s.unshift(i):s.push(i),i}}const Mn=t=>(e,n=et)=>(!xi||t==="sp")&&rc(t,(...r)=>e(...r),n),gT=Mn("bm"),ro=Mn("m"),mT=Mn("bu"),_T=Mn("u"),yT=Mn("bum"),sc=Mn("um"),vT=Mn("sp"),ET=Mn("rtg"),wT=Mn("rtc");function TT(t,e=et){rc("ec",t,e)}const Zg="components",IT="directives";function AT(t,e){return em(Zg,t,!0,e)||t}const RT=Symbol.for("v-ndc");function hD(t){return em(IT,t)}function em(t,e,n=!0,r=!1){const s=Nt||et;if(s){const i=s.type;if(t===Zg){const a=eI(i,!1);if(a&&(a===e||a===mn(e)||a===Ja(mn(e))))return i}const o=nf(s[t]||i[t],e)||nf(s.appContext[t],e);return!o&&r?i:o}}function nf(t,e){return t&&(t[e]||t[mn(e)]||t[Ja(mn(e))])}function dD(t,e,n,r){let s;const i=n&&n[r];if(ce(t)||tt(t)){s=new Array(t.length);for(let o=0,a=t.length;o<a;o++)s[o]=e(t[o],o,void 0,i&&i[o])}else if(typeof t=="number"){s=new Array(t);for(let o=0;o<t;o++)s[o]=e(o+1,o,void 0,i&&i[o])}else if(Be(t))if(t[Symbol.iterator])s=Array.from(t,(o,a)=>e(o,a,void 0,i&&i[a]));else{const o=Object.keys(t);s=new Array(o.length);for(let a=0,c=o.length;a<c;a++){const l=o[a];s[a]=e(t[l],l,a,i&&i[a])}}else s=[];return n&&(n[r]=s),s}const Wl=t=>t?dm(t)?ac(t)||t.proxy:Wl(t.parent):null,mi=at(Object.create(null),{$:t=>t,$el:t=>t.vnode.el,$data:t=>t.data,$props:t=>t.props,$attrs:t=>t.attrs,$slots:t=>t.slots,$refs:t=>t.refs,$parent:t=>Wl(t.parent),$root:t=>Wl(t.root),$emit:t=>t.emit,$options:t=>ch(t),$forceUpdate:t=>t.f||(t.f=()=>oh(t.update)),$nextTick:t=>t.n||(t.n=jr.bind(t.proxy)),$watch:t=>hT.bind(t)}),hl=(t,e)=>t!==xe&&!t.__isScriptSetup&&be(t,e),ST={get({_:t},e){const{ctx:n,setupState:r,data:s,props:i,accessCache:o,type:a,appContext:c}=t;let l;if(e[0]!=="$"){const p=o[e];if(p!==void 0)switch(p){case 1:return r[e];case 2:return s[e];case 4:return n[e];case 3:return i[e]}else{if(hl(r,e))return o[e]=1,r[e];if(s!==xe&&be(s,e))return o[e]=2,s[e];if((l=t.propsOptions[0])&&be(l,e))return o[e]=3,i[e];if(n!==xe&&be(n,e))return o[e]=4,n[e];Gl&&(o[e]=0)}}const u=mi[e];let h,d;if(u)return e==="$attrs"&&Mt(t,"get",e),u(t);if((h=a.__cssModules)&&(h=h[e]))return h;if(n!==xe&&be(n,e))return o[e]=4,n[e];if(d=c.config.globalProperties,be(d,e))return d[e]},set({_:t},e,n){const{data:r,setupState:s,ctx:i}=t;return hl(s,e)?(s[e]=n,!0):r!==xe&&be(r,e)?(r[e]=n,!0):be(t.props,e)||e[0]==="$"&&e.slice(1)in t?!1:(i[e]=n,!0)},has({_:{data:t,setupState:e,accessCache:n,ctx:r,appContext:s,propsOptions:i}},o){let a;return!!n[o]||t!==xe&&be(t,o)||hl(e,o)||(a=i[0])&&be(a,o)||be(r,o)||be(mi,o)||be(s.config.globalProperties,o)},defineProperty(t,e,n){return n.get!=null?t._.accessCache[e]=0:be(n,"value")&&this.set(t,e,n.value,null),Reflect.defineProperty(t,e,n)}};function rf(t){return ce(t)?t.reduce((e,n)=>(e[n]=null,e),{}):t}let Gl=!0;function bT(t){const e=ch(t),n=t.proxy,r=t.ctx;Gl=!1,e.beforeCreate&&sf(e.beforeCreate,t,"bc");const{data:s,computed:i,methods:o,watch:a,provide:c,inject:l,created:u,beforeMount:h,mounted:d,beforeUpdate:p,updated:y,activated:E,deactivated:I,beforeDestroy:C,beforeUnmount:V,destroyed:q,unmounted:N,render:ee,renderTracked:ie,renderTriggered:we,errorCaptured:B,serverPrefetch:G,expose:Y,inheritAttrs:ae,components:We,directives:rt,filters:ne}=e;if(l&&CT(l,r,null),o)for(const L in o){const O=o[L];ge(O)&&(r[L]=O.bind(n))}if(s){const L=s.call(n,n);Be(L)&&(t.data=rn(L))}if(Gl=!0,i)for(const L in i){const O=i[L],se=ge(O)?O.bind(n,n):ge(O.get)?O.get.bind(n,n):Jt,$=!ge(O)&&ge(O.set)?O.set.bind(n):Jt,ye=Se({get:se,set:$});Object.defineProperty(r,L,{enumerable:!0,configurable:!0,get:()=>ye.value,set:ve=>ye.value=ve})}if(a)for(const L in a)tm(a[L],r,n,L);if(c){const L=ge(c)?c.call(n):c;Reflect.ownKeys(L).forEach(O=>{Zo(O,L[O])})}u&&sf(u,t,"c");function b(L,O){ce(O)?O.forEach(se=>L(se.bind(n))):O&&L(O.bind(n))}if(b(gT,h),b(ro,d),b(mT,p),b(_T,y),b(dT,E),b(fT,I),b(TT,B),b(wT,ie),b(ET,we),b(yT,V),b(sc,N),b(vT,G),ce(Y))if(Y.length){const L=t.exposed||(t.exposed={});Y.forEach(O=>{Object.defineProperty(L,O,{get:()=>n[O],set:se=>n[O]=se})})}else t.exposed||(t.exposed={});ee&&t.render===Jt&&(t.render=ee),ae!=null&&(t.inheritAttrs=ae),We&&(t.components=We),rt&&(t.directives=rt)}function CT(t,e,n=Jt){ce(t)&&(t=Ql(t));for(const r in t){const s=t[r];let i;Be(s)?"default"in s?i=Kt(s.from||r,s.default,!0):i=Kt(s.from||r):i=Kt(s),qe(i)?Object.defineProperty(e,r,{enumerable:!0,configurable:!0,get:()=>i.value,set:o=>i.value=o}):e[r]=i}}function sf(t,e,n){Xt(ce(t)?t.map(r=>r.bind(e.proxy)):t.bind(e.proxy),e,n)}function tm(t,e,n,r){const s=r.includes(".")?Yg(n,r):()=>n[r];if(tt(t)){const i=e[t];ge(i)&&nr(s,i)}else if(ge(t))nr(s,t.bind(n));else if(Be(t))if(ce(t))t.forEach(i=>tm(i,e,n,r));else{const i=ge(t.handler)?t.handler.bind(n):e[t.handler];ge(i)&&nr(s,i,t)}}function ch(t){const e=t.type,{mixins:n,extends:r}=e,{mixins:s,optionsCache:i,config:{optionMergeStrategies:o}}=t.appContext,a=i.get(e);let c;return a?c=a:!s.length&&!n&&!r?c=e:(c={},s.length&&s.forEach(l=>ya(c,l,o,!0)),ya(c,e,o)),Be(e)&&i.set(e,c),c}function ya(t,e,n,r=!1){const{mixins:s,extends:i}=e;i&&ya(t,i,n,!0),s&&s.forEach(o=>ya(t,o,n,!0));for(const o in e)if(!(r&&o==="expose")){const a=PT[o]||n&&n[o];t[o]=a?a(t[o],e[o]):e[o]}return t}const PT={data:of,props:af,emits:af,methods:oi,computed:oi,beforeCreate:bt,created:bt,beforeMount:bt,mounted:bt,beforeUpdate:bt,updated:bt,beforeDestroy:bt,beforeUnmount:bt,destroyed:bt,unmounted:bt,activated:bt,deactivated:bt,errorCaptured:bt,serverPrefetch:bt,components:oi,directives:oi,watch:kT,provide:of,inject:OT};function of(t,e){return e?t?function(){return at(ge(t)?t.call(this,this):t,ge(e)?e.call(this,this):e)}:e:t}function OT(t,e){return oi(Ql(t),Ql(e))}function Ql(t){if(ce(t)){const e={};for(let n=0;n<t.length;n++)e[t[n]]=t[n];return e}return t}function bt(t,e){return t?[...new Set([].concat(t,e))]:e}function oi(t,e){return t?at(Object.create(null),t,e):e}function af(t,e){return t?ce(t)&&ce(e)?[...new Set([...t,...e])]:at(Object.create(null),rf(t),rf(e??{})):e}function kT(t,e){if(!t)return e;if(!e)return t;const n=at(Object.create(null),t);for(const r in e)n[r]=bt(t[r],e[r]);return n}function nm(){return{app:null,config:{isNativeTag:rw,performance:!1,globalProperties:{},optionMergeStrategies:{},errorHandler:void 0,warnHandler:void 0,compilerOptions:{}},mixins:[],components:{},directives:{},provides:Object.create(null),optionsCache:new WeakMap,propsCache:new WeakMap,emitsCache:new WeakMap}}let DT=0;function NT(t,e){return function(r,s=null){ge(r)||(r=at({},r)),s!=null&&!Be(s)&&(s=null);const i=nm(),o=new Set;let a=!1;const c=i.app={_uid:DT++,_component:r,_props:s,_container:null,_context:i,_instance:null,version:sI,get config(){return i.config},set config(l){},use(l,...u){return o.has(l)||(l&&ge(l.install)?(o.add(l),l.install(c,...u)):ge(l)&&(o.add(l),l(c,...u))),c},mixin(l){return i.mixins.includes(l)||i.mixins.push(l),c},component(l,u){return u?(i.components[l]=u,c):i.components[l]},directive(l,u){return u?(i.directives[l]=u,c):i.directives[l]},mount(l,u,h){if(!a){const d=_e(r,s);return d.appContext=i,u&&e?e(d,l):t(d,l,h),a=!0,c._container=l,l.__vue_app__=c,ac(d.component)||d.component.proxy}},unmount(){a&&(t(null,c._container),delete c._container.__vue_app__)},provide(l,u){return i.provides[l]=u,c},runWithContext(l){Ni=c;try{return l()}finally{Ni=null}}};return c}}let Ni=null;function Zo(t,e){if(et){let n=et.provides;const r=et.parent&&et.parent.provides;r===n&&(n=et.provides=Object.create(r)),n[t]=e}}function Kt(t,e,n=!1){const r=et||Nt;if(r||Ni){const s=r?r.parent==null?r.vnode.appContext&&r.vnode.appContext.provides:r.parent.provides:Ni._context.provides;if(s&&t in s)return s[t];if(arguments.length>1)return n&&ge(e)?e.call(r&&r.proxy):e}}function VT(){return!!(et||Nt||Ni)}function MT(t,e,n,r=!1){const s={},i={};pa(i,oc,1),t.propsDefaults=Object.create(null),rm(t,e,s,i);for(const o in t.propsOptions[0])o in s||(s[o]=void 0);n?t.props=r?s:Fg(s):t.type.props?t.props=s:t.props=i,t.attrs=i}function xT(t,e,n,r){const{props:s,attrs:i,vnode:{patchFlag:o}}=t,a=fe(s),[c]=t.propsOptions;let l=!1;if((r||o>0)&&!(o&16)){if(o&8){const u=t.vnode.dynamicProps;for(let h=0;h<u.length;h++){let d=u[h];if(nc(t.emitsOptions,d))continue;const p=e[d];if(c)if(be(i,d))p!==i[d]&&(i[d]=p,l=!0);else{const y=mn(d);s[y]=Yl(c,a,y,p,t,!1)}else p!==i[d]&&(i[d]=p,l=!0)}}}else{rm(t,e,s,i)&&(l=!0);let u;for(const h in a)(!e||!be(e,h)&&((u=Fs(h))===h||!be(e,u)))&&(c?n&&(n[h]!==void 0||n[u]!==void 0)&&(s[h]=Yl(c,a,h,void 0,t,!0)):delete s[h]);if(i!==a)for(const h in i)(!e||!be(e,h))&&(delete i[h],l=!0)}l&&Pn(t,"set","$attrs")}function rm(t,e,n,r){const[s,i]=t.propsOptions;let o=!1,a;if(e)for(let c in e){if(Yo(c))continue;const l=e[c];let u;s&&be(s,u=mn(c))?!i||!i.includes(u)?n[u]=l:(a||(a={}))[u]=l:nc(t.emitsOptions,c)||(!(c in r)||l!==r[c])&&(r[c]=l,o=!0)}if(i){const c=fe(n),l=a||xe;for(let u=0;u<i.length;u++){const h=i[u];n[h]=Yl(s,c,h,l[h],t,!be(l,h))}}return o}function Yl(t,e,n,r,s,i){const o=t[n];if(o!=null){const a=be(o,"default");if(a&&r===void 0){const c=o.default;if(o.type!==Function&&!o.skipFactory&&ge(c)){const{propsDefaults:l}=s;n in l?r=l[n]:(Is(s),r=l[n]=c.call(null,e),Or())}else r=c}o[0]&&(i&&!a?r=!1:o[1]&&(r===""||r===Fs(n))&&(r=!0))}return r}function sm(t,e,n=!1){const r=e.propsCache,s=r.get(t);if(s)return s;const i=t.props,o={},a=[];let c=!1;if(!ge(t)){const u=h=>{c=!0;const[d,p]=sm(h,e,!0);at(o,d),p&&a.push(...p)};!n&&e.mixins.length&&e.mixins.forEach(u),t.extends&&u(t.extends),t.mixins&&t.mixins.forEach(u)}if(!i&&!c)return Be(t)&&r.set(t,ds),ds;if(ce(i))for(let u=0;u<i.length;u++){const h=mn(i[u]);cf(h)&&(o[h]=xe)}else if(i)for(const u in i){const h=mn(u);if(cf(h)){const d=i[u],p=o[h]=ce(d)||ge(d)?{type:d}:at({},d);if(p){const y=hf(Boolean,p.type),E=hf(String,p.type);p[0]=y>-1,p[1]=E<0||y<E,(y>-1||be(p,"default"))&&a.push(h)}}}const l=[o,a];return Be(t)&&r.set(t,l),l}function cf(t){return t[0]!=="$"}function lf(t){const e=t&&t.toString().match(/^\s*(function|class) (\w+)/);return e?e[2]:t===null?"null":""}function uf(t,e){return lf(t)===lf(e)}function hf(t,e){return ce(e)?e.findIndex(n=>uf(n,t)):ge(e)&&uf(e,t)?0:-1}const im=t=>t[0]==="_"||t==="$stable",lh=t=>ce(t)?t.map(on):[on(t)],LT=(t,e,n)=>{if(e._n)return e;const r=wn((...s)=>lh(e(...s)),n);return r._c=!1,r},om=(t,e,n)=>{const r=t._ctx;for(const s in t){if(im(s))continue;const i=t[s];if(ge(i))e[s]=LT(s,i,r);else if(i!=null){const o=lh(i);e[s]=()=>o}}},am=(t,e)=>{const n=lh(e);t.slots.default=()=>n},FT=(t,e)=>{if(t.vnode.shapeFlag&32){const n=e._;n?(t.slots=fe(e),pa(e,"_",n)):om(e,t.slots={})}else t.slots={},e&&am(t,e);pa(t.slots,oc,1)},UT=(t,e,n)=>{const{vnode:r,slots:s}=t;let i=!0,o=xe;if(r.shapeFlag&32){const a=e._;a?n&&a===1?i=!1:(at(s,e),!n&&a===1&&delete s._):(i=!e.$stable,om(e,s)),o=e}else e&&(am(t,e),o={default:1});if(i)for(const a in s)!im(a)&&!(a in o)&&delete s[a]};function Jl(t,e,n,r,s=!1){if(ce(t)){t.forEach((d,p)=>Jl(d,e&&(ce(e)?e[p]:e),n,r,s));return}if(Xo(r)&&!s)return;const i=r.shapeFlag&4?ac(r.component)||r.component.proxy:r.el,o=s?null:i,{i:a,r:c}=t,l=e&&e.r,u=a.refs===xe?a.refs={}:a.refs,h=a.setupState;if(l!=null&&l!==c&&(tt(l)?(u[l]=null,be(h,l)&&(h[l]=null)):qe(l)&&(l.value=null)),ge(c))tr(c,a,12,[o,u]);else{const d=tt(c),p=qe(c);if(d||p){const y=()=>{if(t.f){const E=d?be(h,c)?h[c]:u[c]:c.value;s?ce(E)&&Ku(E,i):ce(E)?E.includes(i)||E.push(i):d?(u[c]=[i],be(h,c)&&(h[c]=u[c])):(c.value=[i],t.k&&(u[t.k]=c.value))}else d?(u[c]=o,be(h,c)&&(h[c]=o)):p&&(c.value=o,t.k&&(u[t.k]=o))};o?(y.id=-1,kt(y,n)):y()}}}const kt=uT;function $T(t){return BT(t)}function BT(t,e){const n=jl();n.__VUE__=!0;const{insert:r,remove:s,patchProp:i,createElement:o,createText:a,createComment:c,setText:l,setElementText:u,parentNode:h,nextSibling:d,setScopeId:p=Jt,insertStaticContent:y}=t,E=(g,m,_,w=null,S=null,P=null,z=!1,x=null,F=!!m.dynamicChildren)=>{if(g===m)return;g&&!ei(g,m)&&(w=T(g),ve(g,S,P,!0),g=null),m.patchFlag===-2&&(F=!1,m.dynamicChildren=null);const{type:k,ref:te,shapeFlag:Q}=m;switch(k){case ic:I(g,m,_,w);break;case Nr:C(g,m,_,w);break;case dl:g==null&&V(m,_,w,z);break;case Gt:We(g,m,_,w,S,P,z,x,F);break;default:Q&1?ee(g,m,_,w,S,P,z,x,F):Q&6?rt(g,m,_,w,S,P,z,x,F):(Q&64||Q&128)&&k.process(g,m,_,w,S,P,z,x,F,M)}te!=null&&S&&Jl(te,g&&g.ref,P,m||g,!m)},I=(g,m,_,w)=>{if(g==null)r(m.el=a(m.children),_,w);else{const S=m.el=g.el;m.children!==g.children&&l(S,m.children)}},C=(g,m,_,w)=>{g==null?r(m.el=c(m.children||""),_,w):m.el=g.el},V=(g,m,_,w)=>{[g.el,g.anchor]=y(g.children,m,_,w,g.el,g.anchor)},q=({el:g,anchor:m},_,w)=>{let S;for(;g&&g!==m;)S=d(g),r(g,_,w),g=S;r(m,_,w)},N=({el:g,anchor:m})=>{let _;for(;g&&g!==m;)_=d(g),s(g),g=_;s(m)},ee=(g,m,_,w,S,P,z,x,F)=>{z=z||m.type==="svg",g==null?ie(m,_,w,S,P,z,x,F):G(g,m,S,P,z,x,F)},ie=(g,m,_,w,S,P,z,x)=>{let F,k;const{type:te,props:Q,shapeFlag:J,transition:oe,dirs:Ee}=g;if(F=g.el=o(g.type,P,Q&&Q.is,Q),J&8?u(F,g.children):J&16&&B(g.children,F,null,w,S,P&&te!=="foreignObject",z,x),Ee&&vr(g,null,w,"created"),we(F,g,g.scopeId,z,w),Q){for(const Ce in Q)Ce!=="value"&&!Yo(Ce)&&i(F,Ce,null,Q[Ce],P,g.children,w,S,Me);"value"in Q&&i(F,"value",null,Q.value),(k=Q.onVnodeBeforeMount)&&sn(k,w,g)}Ee&&vr(g,null,w,"beforeMount");const ke=(!S||S&&!S.pendingBranch)&&oe&&!oe.persisted;ke&&oe.beforeEnter(F),r(F,m,_),((k=Q&&Q.onVnodeMounted)||ke||Ee)&&kt(()=>{k&&sn(k,w,g),ke&&oe.enter(F),Ee&&vr(g,null,w,"mounted")},S)},we=(g,m,_,w,S)=>{if(_&&p(g,_),w)for(let P=0;P<w.length;P++)p(g,w[P]);if(S){let P=S.subTree;if(m===P){const z=S.vnode;we(g,z,z.scopeId,z.slotScopeIds,S.parent)}}},B=(g,m,_,w,S,P,z,x,F=0)=>{for(let k=F;k<g.length;k++){const te=g[k]=x?zn(g[k]):on(g[k]);E(null,te,m,_,w,S,P,z,x)}},G=(g,m,_,w,S,P,z)=>{const x=m.el=g.el;let{patchFlag:F,dynamicChildren:k,dirs:te}=m;F|=g.patchFlag&16;const Q=g.props||xe,J=m.props||xe;let oe;_&&Er(_,!1),(oe=J.onVnodeBeforeUpdate)&&sn(oe,_,m,g),te&&vr(m,g,_,"beforeUpdate"),_&&Er(_,!0);const Ee=S&&m.type!=="foreignObject";if(k?Y(g.dynamicChildren,k,x,_,w,Ee,P):z||O(g,m,x,null,_,w,Ee,P,!1),F>0){if(F&16)ae(x,m,Q,J,_,w,S);else if(F&2&&Q.class!==J.class&&i(x,"class",null,J.class,S),F&4&&i(x,"style",Q.style,J.style,S),F&8){const ke=m.dynamicProps;for(let Ce=0;Ce<ke.length;Ce++){const je=ke[Ce],xt=Q[je],Un=J[je];(Un!==xt||je==="value")&&i(x,je,xt,Un,S,g.children,_,w,Me)}}F&1&&g.children!==m.children&&u(x,m.children)}else!z&&k==null&&ae(x,m,Q,J,_,w,S);((oe=J.onVnodeUpdated)||te)&&kt(()=>{oe&&sn(oe,_,m,g),te&&vr(m,g,_,"updated")},w)},Y=(g,m,_,w,S,P,z)=>{for(let x=0;x<m.length;x++){const F=g[x],k=m[x],te=F.el&&(F.type===Gt||!ei(F,k)||F.shapeFlag&70)?h(F.el):_;E(F,k,te,null,w,S,P,z,!0)}},ae=(g,m,_,w,S,P,z)=>{if(_!==w){if(_!==xe)for(const x in _)!Yo(x)&&!(x in w)&&i(g,x,_[x],null,z,m.children,S,P,Me);for(const x in w){if(Yo(x))continue;const F=w[x],k=_[x];F!==k&&x!=="value"&&i(g,x,k,F,z,m.children,S,P,Me)}"value"in w&&i(g,"value",_.value,w.value)}},We=(g,m,_,w,S,P,z,x,F)=>{const k=m.el=g?g.el:a(""),te=m.anchor=g?g.anchor:a("");let{patchFlag:Q,dynamicChildren:J,slotScopeIds:oe}=m;oe&&(x=x?x.concat(oe):oe),g==null?(r(k,_,w),r(te,_,w),B(m.children,_,te,S,P,z,x,F)):Q>0&&Q&64&&J&&g.dynamicChildren?(Y(g.dynamicChildren,J,_,S,P,z,x),(m.key!=null||S&&m===S.subTree)&&cm(g,m,!0)):O(g,m,_,te,S,P,z,x,F)},rt=(g,m,_,w,S,P,z,x,F)=>{m.slotScopeIds=x,g==null?m.shapeFlag&512?S.ctx.activate(m,_,w,z,F):ne(m,_,w,S,P,z,F):U(g,m,F)},ne=(g,m,_,w,S,P,z)=>{const x=g.component=QT(g,w,S);if(Jg(g)&&(x.ctx.renderer=M),YT(x),x.asyncDep){if(S&&S.registerDep(x,b),!g.el){const F=x.subTree=_e(Nr);C(null,F,m,_)}return}b(x,g,m,_,S,P,z)},U=(g,m,_)=>{const w=m.component=g.component;if(aT(g,m,_))if(w.asyncDep&&!w.asyncResolved){L(w,m,_);return}else w.next=m,tT(w.update),w.update();else m.el=g.el,w.vnode=m},b=(g,m,_,w,S,P,z)=>{const x=()=>{if(g.isMounted){let{next:te,bu:Q,u:J,parent:oe,vnode:Ee}=g,ke=te,Ce;Er(g,!1),te?(te.el=Ee.el,L(g,te,z)):te=Ee,Q&&Jo(Q),(Ce=te.props&&te.props.onVnodeBeforeUpdate)&&sn(Ce,oe,te,Ee),Er(g,!0);const je=ul(g),xt=g.subTree;g.subTree=je,E(xt,je,h(xt.el),T(xt),g,S,P),te.el=je.el,ke===null&&cT(g,je.el),J&&kt(J,S),(Ce=te.props&&te.props.onVnodeUpdated)&&kt(()=>sn(Ce,oe,te,Ee),S)}else{let te;const{el:Q,props:J}=m,{bm:oe,m:Ee,parent:ke}=g,Ce=Xo(m);if(Er(g,!1),oe&&Jo(oe),!Ce&&(te=J&&J.onVnodeBeforeMount)&&sn(te,ke,m),Er(g,!0),Q&&pe){const je=()=>{g.subTree=ul(g),pe(Q,g.subTree,g,S,null)};Ce?m.type.__asyncLoader().then(()=>!g.isUnmounted&&je()):je()}else{const je=g.subTree=ul(g);E(null,je,_,w,g,S,P),m.el=je.el}if(Ee&&kt(Ee,S),!Ce&&(te=J&&J.onVnodeMounted)){const je=m;kt(()=>sn(te,ke,je),S)}(m.shapeFlag&256||ke&&Xo(ke.vnode)&&ke.vnode.shapeFlag&256)&&g.a&&kt(g.a,S),g.isMounted=!0,m=_=w=null}},F=g.effect=new Ju(x,()=>oh(k),g.scope),k=g.update=()=>F.run();k.id=g.uid,Er(g,!0),k()},L=(g,m,_)=>{m.component=g;const w=g.vnode.props;g.vnode=m,g.next=null,xT(g,m.props,w,_),UT(g,m.children,_),Us(),ef(),$s()},O=(g,m,_,w,S,P,z,x,F=!1)=>{const k=g&&g.children,te=g?g.shapeFlag:0,Q=m.children,{patchFlag:J,shapeFlag:oe}=m;if(J>0){if(J&128){$(k,Q,_,w,S,P,z,x,F);return}else if(J&256){se(k,Q,_,w,S,P,z,x,F);return}}oe&8?(te&16&&Me(k,S,P),Q!==k&&u(_,Q)):te&16?oe&16?$(k,Q,_,w,S,P,z,x,F):Me(k,S,P,!0):(te&8&&u(_,""),oe&16&&B(Q,_,w,S,P,z,x,F))},se=(g,m,_,w,S,P,z,x,F)=>{g=g||ds,m=m||ds;const k=g.length,te=m.length,Q=Math.min(k,te);let J;for(J=0;J<Q;J++){const oe=m[J]=F?zn(m[J]):on(m[J]);E(g[J],oe,_,null,S,P,z,x,F)}k>te?Me(g,S,P,!0,!1,Q):B(m,_,w,S,P,z,x,F,Q)},$=(g,m,_,w,S,P,z,x,F)=>{let k=0;const te=m.length;let Q=g.length-1,J=te-1;for(;k<=Q&&k<=J;){const oe=g[k],Ee=m[k]=F?zn(m[k]):on(m[k]);if(ei(oe,Ee))E(oe,Ee,_,null,S,P,z,x,F);else break;k++}for(;k<=Q&&k<=J;){const oe=g[Q],Ee=m[J]=F?zn(m[J]):on(m[J]);if(ei(oe,Ee))E(oe,Ee,_,null,S,P,z,x,F);else break;Q--,J--}if(k>Q){if(k<=J){const oe=J+1,Ee=oe<te?m[oe].el:w;for(;k<=J;)E(null,m[k]=F?zn(m[k]):on(m[k]),_,Ee,S,P,z,x,F),k++}}else if(k>J)for(;k<=Q;)ve(g[k],S,P,!0),k++;else{const oe=k,Ee=k,ke=new Map;for(k=Ee;k<=J;k++){const Rt=m[k]=F?zn(m[k]):on(m[k]);Rt.key!=null&&ke.set(Rt.key,k)}let Ce,je=0;const xt=J-Ee+1;let Un=!1,Co=0;const gr=new Array(xt);for(k=0;k<xt;k++)gr[k]=0;for(k=oe;k<=Q;k++){const Rt=g[k];if(je>=xt){ve(Rt,S,P,!0);continue}let Bt;if(Rt.key!=null)Bt=ke.get(Rt.key);else for(Ce=Ee;Ce<=J;Ce++)if(gr[Ce-Ee]===0&&ei(Rt,m[Ce])){Bt=Ce;break}Bt===void 0?ve(Rt,S,P,!0):(gr[Bt-Ee]=k+1,Bt>=Co?Co=Bt:Un=!0,E(Rt,m[Bt],_,null,S,P,z,x,F),je++)}const Js=Un?jT(gr):ds;for(Ce=Js.length-1,k=xt-1;k>=0;k--){const Rt=Ee+k,Bt=m[Rt],Qr=Rt+1<te?m[Rt+1].el:w;gr[k]===0?E(null,Bt,_,Qr,S,P,z,x,F):Un&&(Ce<0||k!==Js[Ce]?ye(Bt,_,Qr,2):Ce--)}}},ye=(g,m,_,w,S=null)=>{const{el:P,type:z,transition:x,children:F,shapeFlag:k}=g;if(k&6){ye(g.component.subTree,m,_,w);return}if(k&128){g.suspense.move(m,_,w);return}if(k&64){z.move(g,m,_,M);return}if(z===Gt){r(P,m,_);for(let Q=0;Q<F.length;Q++)ye(F[Q],m,_,w);r(g.anchor,m,_);return}if(z===dl){q(g,m,_);return}if(w!==2&&k&1&&x)if(w===0)x.beforeEnter(P),r(P,m,_),kt(()=>x.enter(P),S);else{const{leave:Q,delayLeave:J,afterLeave:oe}=x,Ee=()=>r(P,m,_),ke=()=>{Q(P,()=>{Ee(),oe&&oe()})};J?J(P,Ee,ke):ke()}else r(P,m,_)},ve=(g,m,_,w=!1,S=!1)=>{const{type:P,props:z,ref:x,children:F,dynamicChildren:k,shapeFlag:te,patchFlag:Q,dirs:J}=g;if(x!=null&&Jl(x,null,_,g,!0),te&256){m.ctx.deactivate(g);return}const oe=te&1&&J,Ee=!Xo(g);let ke;if(Ee&&(ke=z&&z.onVnodeBeforeUnmount)&&sn(ke,m,g),te&6)Qe(g.component,_,w);else{if(te&128){g.suspense.unmount(_,w);return}oe&&vr(g,null,m,"beforeUnmount"),te&64?g.type.remove(g,m,_,S,M,w):k&&(P!==Gt||Q>0&&Q&64)?Me(k,m,_,!1,!0):(P===Gt&&Q&384||!S&&te&16)&&Me(F,m,_),w&&Ie(g)}(Ee&&(ke=z&&z.onVnodeUnmounted)||oe)&&kt(()=>{ke&&sn(ke,m,g),oe&&vr(g,null,m,"unmounted")},_)},Ie=g=>{const{type:m,el:_,anchor:w,transition:S}=g;if(m===Gt){Ve(_,w);return}if(m===dl){N(g);return}const P=()=>{s(_),S&&!S.persisted&&S.afterLeave&&S.afterLeave()};if(g.shapeFlag&1&&S&&!S.persisted){const{leave:z,delayLeave:x}=S,F=()=>z(_,P);x?x(g.el,P,F):F()}else P()},Ve=(g,m)=>{let _;for(;g!==m;)_=d(g),s(g),g=_;s(m)},Qe=(g,m,_)=>{const{bum:w,scope:S,update:P,subTree:z,um:x}=g;w&&Jo(w),S.stop(),P&&(P.active=!1,ve(z,g,m,_)),x&&kt(x,m),kt(()=>{g.isUnmounted=!0},m),m&&m.pendingBranch&&!m.isUnmounted&&g.asyncDep&&!g.asyncResolved&&g.suspenseId===m.pendingId&&(m.deps--,m.deps===0&&m.resolve())},Me=(g,m,_,w=!1,S=!1,P=0)=>{for(let z=P;z<g.length;z++)ve(g[z],m,_,w,S)},T=g=>g.shapeFlag&6?T(g.component.subTree):g.shapeFlag&128?g.suspense.next():d(g.anchor||g.el),H=(g,m,_)=>{g==null?m._vnode&&ve(m._vnode,null,null,!0):E(m._vnode||null,g,m,null,null,null,_),ef(),zg(),m._vnode=g},M={p:E,um:ve,m:ye,r:Ie,mt:ne,mc:B,pc:O,pbc:Y,n:T,o:t};let K,pe;return e&&([K,pe]=e(M)),{render:H,hydrate:K,createApp:NT(H,K)}}function Er({effect:t,update:e},n){t.allowRecurse=e.allowRecurse=n}function cm(t,e,n=!1){const r=t.children,s=e.children;if(ce(r)&&ce(s))for(let i=0;i<r.length;i++){const o=r[i];let a=s[i];a.shapeFlag&1&&!a.dynamicChildren&&((a.patchFlag<=0||a.patchFlag===32)&&(a=s[i]=zn(s[i]),a.el=o.el),n||cm(o,a)),a.type===ic&&(a.el=o.el)}}function jT(t){const e=t.slice(),n=[0];let r,s,i,o,a;const c=t.length;for(r=0;r<c;r++){const l=t[r];if(l!==0){if(s=n[n.length-1],t[s]<l){e[r]=s,n.push(r);continue}for(i=0,o=n.length-1;i<o;)a=i+o>>1,t[n[a]]<l?i=a+1:o=a;l<t[n[i]]&&(i>0&&(e[r]=n[i-1]),n[i]=r)}}for(i=n.length,o=n[i-1];i-- >0;)n[i]=o,o=e[o];return n}const qT=t=>t.__isTeleport,Gt=Symbol.for("v-fgt"),ic=Symbol.for("v-txt"),Nr=Symbol.for("v-cmt"),dl=Symbol.for("v-stc"),_i=[];let Yt=null;function Kn(t=!1){_i.push(Yt=t?null:[])}function HT(){_i.pop(),Yt=_i[_i.length-1]||null}let Vi=1;function df(t){Vi+=t}function lm(t){return t.dynamicChildren=Vi>0?Yt||ds:null,HT(),Vi>0&&Yt&&Yt.push(t),t}function ai(t,e,n,r,s,i){return lm(Ge(t,e,n,r,s,i,!0))}function Xl(t,e,n,r,s){return lm(_e(t,e,n,r,s,!0))}function Mi(t){return t?t.__v_isVNode===!0:!1}function ei(t,e){return t.type===e.type&&t.key===e.key}const oc="__vInternal",um=({key:t})=>t??null,ea=({ref:t,ref_key:e,ref_for:n})=>(typeof t=="number"&&(t=""+t),t!=null?tt(t)||qe(t)||ge(t)?{i:Nt,r:t,k:e,f:!!n}:t:null);function Ge(t,e=null,n=null,r=0,s=null,i=t===Gt?0:1,o=!1,a=!1){const c={__v_isVNode:!0,__v_skip:!0,type:t,props:e,key:e&&um(e),ref:e&&ea(e),scopeId:Qg,slotScopeIds:null,children:n,component:null,suspense:null,ssContent:null,ssFallback:null,dirs:null,transition:null,el:null,anchor:null,target:null,targetAnchor:null,staticCount:0,shapeFlag:i,patchFlag:r,dynamicProps:s,dynamicChildren:null,appContext:null,ctx:Nt};return a?(uh(c,n),i&128&&t.normalize(c)):n&&(c.shapeFlag|=tt(n)?8:16),Vi>0&&!o&&Yt&&(c.patchFlag>0||i&6)&&c.patchFlag!==32&&Yt.push(c),c}const _e=KT;function KT(t,e=null,n=null,r=0,s=null,i=!1){if((!t||t===RT)&&(t=Nr),Mi(t)){const a=Vr(t,e,!0);return n&&uh(a,n),Vi>0&&!i&&Yt&&(a.shapeFlag&6?Yt[Yt.indexOf(t)]=a:Yt.push(a)),a.patchFlag|=-2,a}if(tI(t)&&(t=t.__vccOpts),e){e=zT(e);let{class:a,style:c}=e;a&&!tt(a)&&(e.class=Ft(a)),Be(c)&&(Ug(c)&&!ce(c)&&(c=at({},c)),e.style=Gu(c))}const o=tt(t)?1:lT(t)?128:qT(t)?64:Be(t)?4:ge(t)?2:0;return Ge(t,e,n,r,s,o,i,!0)}function zT(t){return t?Ug(t)||oc in t?at({},t):t:null}function Vr(t,e,n=!1){const{props:r,ref:s,patchFlag:i,children:o}=t,a=e?xn(r||{},e):r;return{__v_isVNode:!0,__v_skip:!0,type:t.type,props:a,key:a&&um(a),ref:e&&e.ref?n&&s?ce(s)?s.concat(ea(e)):[s,ea(e)]:ea(e):s,scopeId:t.scopeId,slotScopeIds:t.slotScopeIds,children:o,target:t.target,targetAnchor:t.targetAnchor,staticCount:t.staticCount,shapeFlag:t.shapeFlag,patchFlag:e&&t.type!==Gt?i===-1?16:i|16:i,dynamicProps:t.dynamicProps,dynamicChildren:t.dynamicChildren,appContext:t.appContext,dirs:t.dirs,transition:t.transition,component:t.component,suspense:t.suspense,ssContent:t.ssContent&&Vr(t.ssContent),ssFallback:t.ssFallback&&Vr(t.ssFallback),el:t.el,anchor:t.anchor,ctx:t.ctx,ce:t.ce}}function Tn(t=" ",e=0){return _e(ic,null,t,e)}function fl(t="",e=!1){return e?(Kn(),Xl(Nr,null,t)):_e(Nr,null,t)}function on(t){return t==null||typeof t=="boolean"?_e(Nr):ce(t)?_e(Gt,null,t.slice()):typeof t=="object"?zn(t):_e(ic,null,String(t))}function zn(t){return t.el===null&&t.patchFlag!==-1||t.memo?t:Vr(t)}function uh(t,e){let n=0;const{shapeFlag:r}=t;if(e==null)e=null;else if(ce(e))n=16;else if(typeof e=="object")if(r&65){const s=e.default;s&&(s._c&&(s._d=!1),uh(t,s()),s._c&&(s._d=!0));return}else{n=32;const s=e._;!s&&!(oc in e)?e._ctx=Nt:s===3&&Nt&&(Nt.slots._===1?e._=1:(e._=2,t.patchFlag|=1024))}else ge(e)?(e={default:e,_ctx:Nt},n=32):(e=String(e),r&64?(n=16,e=[Tn(e)]):n=8);t.children=e,t.shapeFlag|=n}function xn(...t){const e={};for(let n=0;n<t.length;n++){const r=t[n];for(const s in r)if(s==="class")e.class!==r.class&&(e.class=Ft([e.class,r.class]));else if(s==="style")e.style=Gu([e.style,r.style]);else if(Ga(s)){const i=e[s],o=r[s];o&&i!==o&&!(ce(i)&&i.includes(o))&&(e[s]=i?[].concat(i,o):o)}else s!==""&&(e[s]=r[s])}return e}function sn(t,e,n,r=null){Xt(t,e,7,[n,r])}const WT=nm();let GT=0;function QT(t,e,n){const r=t.type,s=(e?e.appContext:t.appContext)||WT,i={uid:GT++,vnode:t,type:r,parent:e,appContext:s,root:null,next:null,subTree:null,effect:null,update:null,scope:new Rg(!0),render:null,proxy:null,exposed:null,exposeProxy:null,withProxy:null,provides:e?e.provides:Object.create(s.provides),accessCache:null,renderCache:[],components:null,directives:null,propsOptions:sm(r,s),emitsOptions:Gg(r,s),emit:null,emitted:null,propsDefaults:xe,inheritAttrs:r.inheritAttrs,ctx:xe,data:xe,props:xe,attrs:xe,slots:xe,refs:xe,setupState:xe,setupContext:null,attrsProxy:null,slotsProxy:null,suspense:n,suspenseId:n?n.pendingId:0,asyncDep:null,asyncResolved:!1,isMounted:!1,isUnmounted:!1,isDeactivated:!1,bc:null,c:null,bm:null,m:null,bu:null,u:null,um:null,bum:null,da:null,a:null,rtg:null,rtc:null,ec:null,sp:null};return i.ctx={_:i},i.root=e?e.root:i,i.emit=sT.bind(null,i),t.ce&&t.ce(i),i}let et=null;const hm=()=>et||Nt;let hh,es,ff="__VUE_INSTANCE_SETTERS__";(es=jl()[ff])||(es=jl()[ff]=[]),es.push(t=>et=t),hh=t=>{es.length>1?es.forEach(e=>e(t)):es[0](t)};const Is=t=>{hh(t),t.scope.on()},Or=()=>{et&&et.scope.off(),hh(null)};function dm(t){return t.vnode.shapeFlag&4}let xi=!1;function YT(t,e=!1){xi=e;const{props:n,children:r}=t.vnode,s=dm(t);MT(t,n,s,e),FT(t,r);const i=s?JT(t,e):void 0;return xi=!1,i}function JT(t,e){const n=t.type;t.accessCache=Object.create(null),t.proxy=ec(new Proxy(t.ctx,ST));const{setup:r}=n;if(r){const s=t.setupContext=r.length>1?ZT(t):null;Is(t),Us();const i=tr(r,t,0,[t.props,s]);if($s(),Or(),Eg(i)){if(i.then(Or,Or),e)return i.then(o=>{pf(t,o,e)}).catch(o=>{tc(o,t,0)});t.asyncDep=i}else pf(t,i,e)}else fm(t,e)}function pf(t,e,n){ge(e)?t.type.__ssrInlineRender?t.ssrRender=e:t.render=e:Be(e)&&(t.setupState=jg(e)),fm(t,n)}let gf;function fm(t,e,n){const r=t.type;if(!t.render){if(!e&&gf&&!r.render){const s=r.template||ch(t).template;if(s){const{isCustomElement:i,compilerOptions:o}=t.appContext.config,{delimiters:a,compilerOptions:c}=r,l=at(at({isCustomElement:i,delimiters:a},o),c);r.render=gf(s,l)}}t.render=r.render||Jt}Is(t),Us(),bT(t),$s(),Or()}function XT(t){return t.attrsProxy||(t.attrsProxy=new Proxy(t.attrs,{get(e,n){return Mt(t,"get","$attrs"),e[n]}}))}function ZT(t){const e=n=>{t.exposed=n||{}};return{get attrs(){return XT(t)},slots:t.slots,emit:t.emit,expose:e}}function ac(t){if(t.exposed)return t.exposeProxy||(t.exposeProxy=new Proxy(jg(ec(t.exposed)),{get(e,n){if(n in e)return e[n];if(n in mi)return mi[n](t)},has(e,n){return n in e||n in mi}}))}function eI(t,e=!0){return ge(t)?t.displayName||t.name:t.name||e&&t.__name}function tI(t){return ge(t)&&"__vccOpts"in t}const Se=(t,e)=>Xw(t,e,xi);function cs(t,e,n){const r=arguments.length;return r===2?Be(e)&&!ce(e)?Mi(e)?_e(t,null,[e]):_e(t,e):_e(t,null,e):(r>3?n=Array.prototype.slice.call(arguments,2):r===3&&Mi(n)&&(n=[n]),_e(t,e,n))}const nI=Symbol.for("v-scx"),rI=()=>Kt(nI),sI="3.3.4",iI="http://www.w3.org/2000/svg",Ir=typeof document<"u"?document:null,mf=Ir&&Ir.createElement("template"),oI={insert:(t,e,n)=>{e.insertBefore(t,n||null)},remove:t=>{const e=t.parentNode;e&&e.removeChild(t)},createElement:(t,e,n,r)=>{const s=e?Ir.createElementNS(iI,t):Ir.createElement(t,n?{is:n}:void 0);return t==="select"&&r&&r.multiple!=null&&s.setAttribute("multiple",r.multiple),s},createText:t=>Ir.createTextNode(t),createComment:t=>Ir.createComment(t),setText:(t,e)=>{t.nodeValue=e},setElementText:(t,e)=>{t.textContent=e},parentNode:t=>t.parentNode,nextSibling:t=>t.nextSibling,querySelector:t=>Ir.querySelector(t),setScopeId(t,e){t.setAttribute(e,"")},insertStaticContent(t,e,n,r,s,i){const o=n?n.previousSibling:e.lastChild;if(s&&(s===i||s.nextSibling))for(;e.insertBefore(s.cloneNode(!0),n),!(s===i||!(s=s.nextSibling)););else{mf.innerHTML=r?`<svg>${t}</svg>`:t;const a=mf.content;if(r){const c=a.firstChild;for(;c.firstChild;)a.appendChild(c.firstChild);a.removeChild(c)}e.insertBefore(a,n)}return[o?o.nextSibling:e.firstChild,n?n.previousSibling:e.lastChild]}};function aI(t,e,n){const r=t._vtc;r&&(e=(e?[e,...r]:[...r]).join(" ")),e==null?t.removeAttribute("class"):n?t.setAttribute("class",e):t.className=e}function cI(t,e,n){const r=t.style,s=tt(n);if(n&&!s){if(e&&!tt(e))for(const i in e)n[i]==null&&Zl(r,i,"");for(const i in n)Zl(r,i,n[i])}else{const i=r.display;s?e!==n&&(r.cssText=n):e&&t.removeAttribute("style"),"_vod"in t&&(r.display=i)}}const _f=/\s*!important$/;function Zl(t,e,n){if(ce(n))n.forEach(r=>Zl(t,e,r));else if(n==null&&(n=""),e.startsWith("--"))t.setProperty(e,n);else{const r=lI(t,e);_f.test(n)?t.setProperty(Fs(r),n.replace(_f,""),"important"):t[r]=n}}const yf=["Webkit","Moz","ms"],pl={};function lI(t,e){const n=pl[e];if(n)return n;let r=mn(e);if(r!=="filter"&&r in t)return pl[e]=r;r=Ja(r);for(let s=0;s<yf.length;s++){const i=yf[s]+r;if(i in t)return pl[e]=i}return e}const vf="http://www.w3.org/1999/xlink";function uI(t,e,n,r,s){if(r&&e.startsWith("xlink:"))n==null?t.removeAttributeNS(vf,e.slice(6,e.length)):t.setAttributeNS(vf,e,n);else{const i=pw(e);n==null||i&&!Ig(n)?t.removeAttribute(e):t.setAttribute(e,i?"":n)}}function hI(t,e,n,r,s,i,o){if(e==="innerHTML"||e==="textContent"){r&&o(r,s,i),t[e]=n??"";return}const a=t.tagName;if(e==="value"&&a!=="PROGRESS"&&!a.includes("-")){t._value=n;const l=a==="OPTION"?t.getAttribute("value"):t.value,u=n??"";l!==u&&(t.value=u),n==null&&t.removeAttribute(e);return}let c=!1;if(n===""||n==null){const l=typeof t[e];l==="boolean"?n=Ig(n):n==null&&l==="string"?(n="",c=!0):l==="number"&&(n=0,c=!0)}try{t[e]=n}catch{}c&&t.removeAttribute(e)}function rs(t,e,n,r){t.addEventListener(e,n,r)}function dI(t,e,n,r){t.removeEventListener(e,n,r)}function fI(t,e,n,r,s=null){const i=t._vei||(t._vei={}),o=i[e];if(r&&o)o.value=r;else{const[a,c]=pI(e);if(r){const l=i[e]=_I(r,s);rs(t,a,l,c)}else o&&(dI(t,a,o,c),i[e]=void 0)}}const Ef=/(?:Once|Passive|Capture)$/;function pI(t){let e;if(Ef.test(t)){e={};let r;for(;r=t.match(Ef);)t=t.slice(0,t.length-r[0].length),e[r[0].toLowerCase()]=!0}return[t[2]===":"?t.slice(3):Fs(t.slice(2)),e]}let gl=0;const gI=Promise.resolve(),mI=()=>gl||(gI.then(()=>gl=0),gl=Date.now());function _I(t,e){const n=r=>{if(!r._vts)r._vts=Date.now();else if(r._vts<=n.attached)return;Xt(yI(r,n.value),e,5,[r])};return n.value=t,n.attached=mI(),n}function yI(t,e){if(ce(e)){const n=t.stopImmediatePropagation;return t.stopImmediatePropagation=()=>{n.call(t),t._stopped=!0},e.map(r=>s=>!s._stopped&&r&&r(s))}else return e}const wf=/^on[a-z]/,vI=(t,e,n,r,s=!1,i,o,a,c)=>{e==="class"?aI(t,r,s):e==="style"?cI(t,n,r):Ga(e)?Hu(e)||fI(t,e,n,r,o):(e[0]==="."?(e=e.slice(1),!0):e[0]==="^"?(e=e.slice(1),!1):EI(t,e,r,s))?hI(t,e,r,i,o,a,c):(e==="true-value"?t._trueValue=r:e==="false-value"&&(t._falseValue=r),uI(t,e,r,s))};function EI(t,e,n,r){return r?!!(e==="innerHTML"||e==="textContent"||e in t&&wf.test(e)&&ge(n)):e==="spellcheck"||e==="draggable"||e==="translate"||e==="form"||e==="list"&&t.tagName==="INPUT"||e==="type"&&t.tagName==="TEXTAREA"||wf.test(e)&&tt(n)?!1:e in t}const Tf=t=>{const e=t.props["onUpdate:modelValue"]||!1;return ce(e)?n=>Jo(e,n):e};function wI(t){t.target.composing=!0}function If(t){const e=t.target;e.composing&&(e.composing=!1,e.dispatchEvent(new Event("input")))}const fD={created(t,{modifiers:{lazy:e,trim:n,number:r}},s){t._assign=Tf(s);const i=r||s.props&&s.props.type==="number";rs(t,e?"change":"input",o=>{if(o.target.composing)return;let a=t.value;n&&(a=a.trim()),i&&(a=Bl(a)),t._assign(a)}),n&&rs(t,"change",()=>{t.value=t.value.trim()}),e||(rs(t,"compositionstart",wI),rs(t,"compositionend",If),rs(t,"change",If))},mounted(t,{value:e}){t.value=e??""},beforeUpdate(t,{value:e,modifiers:{lazy:n,trim:r,number:s}},i){if(t._assign=Tf(i),t.composing||document.activeElement===t&&t.type!=="range"&&(n||r&&t.value.trim()===e||(s||t.type==="number")&&Bl(t.value)===e))return;const o=e??"";t.value!==o&&(t.value=o)}},TI=["ctrl","shift","alt","meta"],II={stop:t=>t.stopPropagation(),prevent:t=>t.preventDefault(),self:t=>t.target!==t.currentTarget,ctrl:t=>!t.ctrlKey,shift:t=>!t.shiftKey,alt:t=>!t.altKey,meta:t=>!t.metaKey,left:t=>"button"in t&&t.button!==0,middle:t=>"button"in t&&t.button!==1,right:t=>"button"in t&&t.button!==2,exact:(t,e)=>TI.some(n=>t[`${n}Key`]&&!e.includes(n))},pD=(t,e)=>(n,...r)=>{for(let s=0;s<e.length;s++){const i=II[e[s]];if(i&&i(n,e))return}return t(n,...r)},AI=at({patchProp:vI},oI);let Af;function RI(){return Af||(Af=$T(AI))}const pm=(...t)=>{const e=RI().createApp(...t),{mount:n}=e;return e.mount=r=>{const s=SI(r);if(!s)return;const i=e._component;!ge(i)&&!i.render&&!i.template&&(i.template=s.innerHTML),s.innerHTML="";const o=n(s,!1,s instanceof SVGElement);return s instanceof Element&&(s.removeAttribute("v-cloak"),s.setAttribute("data-v-app","")),o},e};function SI(t){return tt(t)?document.querySelector(t):t}var ls=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};function dh(t){return t&&t.__esModule&&Object.prototype.hasOwnProperty.call(t,"default")?t.default:t}var gm={exports:{}};(function(t,e){(function(n,r){t.exports=r()})(ls,function(){var n=function(o,a){typeof o.scroll=="function"?o.scroll({top:o.scrollHeight,behavior:a?"smooth":"instant"}):o.scrollTop=o.scrollHeight},r={bind:function(o,a){var c=!1;o.addEventListener("scroll",function(l){c=o.scrollTop+o.clientHeight+1<o.scrollHeight,c&&o.scrollTop===0&&o.dispatchEvent(new Event("v-chat-scroll-top-reached"))}),new MutationObserver(function(l){var u=a.value||{};if(u.enabled!==!1){var h=u.always===!1&&c,d=l[l.length-1].addedNodes.length,p=l[l.length-1].removedNodes.length;if(u.scrollonremoved){if(h||d!=1&&p!=1)return}else if(h||d!=1)return;var y=u.smooth,E=!d&&p===1;E&&u.scrollonremoved&&"smoothonremoved"in u&&(y=u.smoothonremoved),n(o,y)}}).observe(o,{childList:!0,subtree:!0})},inserted:function(o,a){var c=a.value||{};n(o,c.notSmoothOnInit?!1:c.smooth)}},s={install:function(o,a){o.directive("chat-scroll",r)}};return typeof window<"u"&&window.Vue&&window.Vue.use(s),s})})(gm);var bI=gm.exports;const CI=dh(bI);var va={exports:{}};va.exports;(function(t,e){var n=200,r="__lodash_hash_undefined__",s=9007199254740991,i="[object Arguments]",o="[object Array]",a="[object Boolean]",c="[object Date]",l="[object Error]",u="[object Function]",h="[object GeneratorFunction]",d="[object Map]",p="[object Number]",y="[object Object]",E="[object Promise]",I="[object RegExp]",C="[object Set]",V="[object String]",q="[object Symbol]",N="[object WeakMap]",ee="[object ArrayBuffer]",ie="[object DataView]",we="[object Float32Array]",B="[object Float64Array]",G="[object Int8Array]",Y="[object Int16Array]",ae="[object Int32Array]",We="[object Uint8Array]",rt="[object Uint8ClampedArray]",ne="[object Uint16Array]",U="[object Uint32Array]",b=/[\\^$.*+?()[\]{}|]/g,L=/\w*$/,O=/^\[object .+?Constructor\]$/,se=/^(?:0|[1-9]\d*)$/,$={};$[i]=$[o]=$[ee]=$[ie]=$[a]=$[c]=$[we]=$[B]=$[G]=$[Y]=$[ae]=$[d]=$[p]=$[y]=$[I]=$[C]=$[V]=$[q]=$[We]=$[rt]=$[ne]=$[U]=!0,$[l]=$[u]=$[N]=!1;var ye=typeof ls=="object"&&ls&&ls.Object===Object&&ls,ve=typeof self=="object"&&self&&self.Object===Object&&self,Ie=ye||ve||Function("return this")(),Ve=e&&!e.nodeType&&e,Qe=Ve&&!0&&t&&!t.nodeType&&t,Me=Qe&&Qe.exports===Ve;function T(f,v){return f.set(v[0],v[1]),f}function H(f,v){return f.add(v),f}function M(f,v){for(var A=-1,Z=f?f.length:0;++A<Z&&v(f[A],A,f)!==!1;);return f}function K(f,v){for(var A=-1,Z=v.length,st=f.length;++A<Z;)f[st+A]=v[A];return f}function pe(f,v,A,Z){var st=-1,St=f?f.length:0;for(Z&&St&&(A=f[++st]);++st<St;)A=v(A,f[st],st,f);return A}function g(f,v){for(var A=-1,Z=Array(f);++A<f;)Z[A]=v(A);return Z}function m(f,v){return f==null?void 0:f[v]}function _(f){var v=!1;if(f!=null&&typeof f.toString!="function")try{v=!!(f+"")}catch{}return v}function w(f){var v=-1,A=Array(f.size);return f.forEach(function(Z,st){A[++v]=[st,Z]}),A}function S(f,v){return function(A){return f(v(A))}}function P(f){var v=-1,A=Array(f.size);return f.forEach(function(Z){A[++v]=Z}),A}var z=Array.prototype,x=Function.prototype,F=Object.prototype,k=Ie["__core-js_shared__"],te=function(){var f=/[^.]+$/.exec(k&&k.keys&&k.keys.IE_PROTO||"");return f?"Symbol(src)_1."+f:""}(),Q=x.toString,J=F.hasOwnProperty,oe=F.toString,Ee=RegExp("^"+Q.call(J).replace(b,"\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g,"$1.*?")+"$"),ke=Me?Ie.Buffer:void 0,Ce=Ie.Symbol,je=Ie.Uint8Array,xt=S(Object.getPrototypeOf,Object),Un=Object.create,Co=F.propertyIsEnumerable,gr=z.splice,Js=Object.getOwnPropertySymbols,Rt=ke?ke.isBuffer:void 0,Bt=S(Object.keys,Object),Qr=Xr(Ie,"DataView"),Xs=Xr(Ie,"Map"),tl=Xr(Ie,"Promise"),nl=Xr(Ie,"Set"),rl=Xr(Ie,"WeakMap"),Zs=Xr(Object,"create"),tE=yr(Qr),nE=yr(Xs),rE=yr(tl),sE=yr(nl),iE=yr(rl),Nd=Ce?Ce.prototype:void 0,Vd=Nd?Nd.valueOf:void 0;function mr(f){var v=-1,A=f?f.length:0;for(this.clear();++v<A;){var Z=f[v];this.set(Z[0],Z[1])}}function oE(){this.__data__=Zs?Zs(null):{}}function aE(f){return this.has(f)&&delete this.__data__[f]}function cE(f){var v=this.__data__;if(Zs){var A=v[f];return A===r?void 0:A}return J.call(v,f)?v[f]:void 0}function lE(f){var v=this.__data__;return Zs?v[f]!==void 0:J.call(v,f)}function uE(f,v){var A=this.__data__;return A[f]=Zs&&v===void 0?r:v,this}mr.prototype.clear=oE,mr.prototype.delete=aE,mr.prototype.get=cE,mr.prototype.has=lE,mr.prototype.set=uE;function vn(f){var v=-1,A=f?f.length:0;for(this.clear();++v<A;){var Z=f[v];this.set(Z[0],Z[1])}}function hE(){this.__data__=[]}function dE(f){var v=this.__data__,A=Po(v,f);if(A<0)return!1;var Z=v.length-1;return A==Z?v.pop():gr.call(v,A,1),!0}function fE(f){var v=this.__data__,A=Po(v,f);return A<0?void 0:v[A][1]}function pE(f){return Po(this.__data__,f)>-1}function gE(f,v){var A=this.__data__,Z=Po(A,f);return Z<0?A.push([f,v]):A[Z][1]=v,this}vn.prototype.clear=hE,vn.prototype.delete=dE,vn.prototype.get=fE,vn.prototype.has=pE,vn.prototype.set=gE;function Yr(f){var v=-1,A=f?f.length:0;for(this.clear();++v<A;){var Z=f[v];this.set(Z[0],Z[1])}}function mE(){this.__data__={hash:new mr,map:new(Xs||vn),string:new mr}}function _E(f){return Oo(this,f).delete(f)}function yE(f){return Oo(this,f).get(f)}function vE(f){return Oo(this,f).has(f)}function EE(f,v){return Oo(this,f).set(f,v),this}Yr.prototype.clear=mE,Yr.prototype.delete=_E,Yr.prototype.get=yE,Yr.prototype.has=vE,Yr.prototype.set=EE;function Jr(f){this.__data__=new vn(f)}function wE(){this.__data__=new vn}function TE(f){return this.__data__.delete(f)}function IE(f){return this.__data__.get(f)}function AE(f){return this.__data__.has(f)}function RE(f,v){var A=this.__data__;if(A instanceof vn){var Z=A.__data__;if(!Xs||Z.length<n-1)return Z.push([f,v]),this;A=this.__data__=new Yr(Z)}return A.set(f,v),this}Jr.prototype.clear=wE,Jr.prototype.delete=TE,Jr.prototype.get=IE,Jr.prototype.has=AE,Jr.prototype.set=RE;function SE(f,v){var A=ol(f)||YE(f)?g(f.length,String):[],Z=A.length,st=!!Z;for(var St in f)(v||J.call(f,St))&&!(st&&(St=="length"||zE(St,Z)))&&A.push(St);return A}function Md(f,v,A){var Z=f[v];(!(J.call(f,v)&&Ud(Z,A))||A===void 0&&!(v in f))&&(f[v]=A)}function Po(f,v){for(var A=f.length;A--;)if(Ud(f[A][0],v))return A;return-1}function bE(f,v){return f&&xd(v,al(v),f)}function sl(f,v,A,Z,st,St,jt){var Ot;if(Z&&(Ot=St?Z(f,st,St,jt):Z(f)),Ot!==void 0)return Ot;if(!ko(f))return f;var jd=ol(f);if(jd){if(Ot=qE(f),!v)return $E(f,Ot)}else{var Zr=_r(f),qd=Zr==u||Zr==h;if(XE(f))return NE(f,v);if(Zr==y||Zr==i||qd&&!St){if(_(f))return St?f:{};if(Ot=HE(qd?{}:f),!v)return BE(f,bE(Ot,f))}else{if(!$[Zr])return St?f:{};Ot=KE(f,Zr,sl,v)}}jt||(jt=new Jr);var Hd=jt.get(f);if(Hd)return Hd;if(jt.set(f,Ot),!jd)var Kd=A?jE(f):al(f);return M(Kd||f,function(cl,Do){Kd&&(Do=cl,cl=f[Do]),Md(Ot,Do,sl(cl,v,A,Z,Do,f,jt))}),Ot}function CE(f){return ko(f)?Un(f):{}}function PE(f,v,A){var Z=v(f);return ol(f)?Z:K(Z,A(f))}function OE(f){return oe.call(f)}function kE(f){if(!ko(f)||GE(f))return!1;var v=Bd(f)||_(f)?Ee:O;return v.test(yr(f))}function DE(f){if(!Fd(f))return Bt(f);var v=[];for(var A in Object(f))J.call(f,A)&&A!="constructor"&&v.push(A);return v}function NE(f,v){if(v)return f.slice();var A=new f.constructor(f.length);return f.copy(A),A}function il(f){var v=new f.constructor(f.byteLength);return new je(v).set(new je(f)),v}function VE(f,v){var A=v?il(f.buffer):f.buffer;return new f.constructor(A,f.byteOffset,f.byteLength)}function ME(f,v,A){var Z=v?A(w(f),!0):w(f);return pe(Z,T,new f.constructor)}function xE(f){var v=new f.constructor(f.source,L.exec(f));return v.lastIndex=f.lastIndex,v}function LE(f,v,A){var Z=v?A(P(f),!0):P(f);return pe(Z,H,new f.constructor)}function FE(f){return Vd?Object(Vd.call(f)):{}}function UE(f,v){var A=v?il(f.buffer):f.buffer;return new f.constructor(A,f.byteOffset,f.length)}function $E(f,v){var A=-1,Z=f.length;for(v||(v=Array(Z));++A<Z;)v[A]=f[A];return v}function xd(f,v,A,Z){A||(A={});for(var st=-1,St=v.length;++st<St;){var jt=v[st],Ot=Z?Z(A[jt],f[jt],jt,A,f):void 0;Md(A,jt,Ot===void 0?f[jt]:Ot)}return A}function BE(f,v){return xd(f,Ld(f),v)}function jE(f){return PE(f,al,Ld)}function Oo(f,v){var A=f.__data__;return WE(v)?A[typeof v=="string"?"string":"hash"]:A.map}function Xr(f,v){var A=m(f,v);return kE(A)?A:void 0}var Ld=Js?S(Js,Object):tw,_r=OE;(Qr&&_r(new Qr(new ArrayBuffer(1)))!=ie||Xs&&_r(new Xs)!=d||tl&&_r(tl.resolve())!=E||nl&&_r(new nl)!=C||rl&&_r(new rl)!=N)&&(_r=function(f){var v=oe.call(f),A=v==y?f.constructor:void 0,Z=A?yr(A):void 0;if(Z)switch(Z){case tE:return ie;case nE:return d;case rE:return E;case sE:return C;case iE:return N}return v});function qE(f){var v=f.length,A=f.constructor(v);return v&&typeof f[0]=="string"&&J.call(f,"index")&&(A.index=f.index,A.input=f.input),A}function HE(f){return typeof f.constructor=="function"&&!Fd(f)?CE(xt(f)):{}}function KE(f,v,A,Z){var st=f.constructor;switch(v){case ee:return il(f);case a:case c:return new st(+f);case ie:return VE(f,Z);case we:case B:case G:case Y:case ae:case We:case rt:case ne:case U:return UE(f,Z);case d:return ME(f,Z,A);case p:case V:return new st(f);case I:return xE(f);case C:return LE(f,Z,A);case q:return FE(f)}}function zE(f,v){return v=v??s,!!v&&(typeof f=="number"||se.test(f))&&f>-1&&f%1==0&&f<v}function WE(f){var v=typeof f;return v=="string"||v=="number"||v=="symbol"||v=="boolean"?f!=="__proto__":f===null}function GE(f){return!!te&&te in f}function Fd(f){var v=f&&f.constructor,A=typeof v=="function"&&v.prototype||F;return f===A}function yr(f){if(f!=null){try{return Q.call(f)}catch{}try{return f+""}catch{}}return""}function QE(f){return sl(f,!0,!0)}function Ud(f,v){return f===v||f!==f&&v!==v}function YE(f){return JE(f)&&J.call(f,"callee")&&(!Co.call(f,"callee")||oe.call(f)==i)}var ol=Array.isArray;function $d(f){return f!=null&&ZE(f.length)&&!Bd(f)}function JE(f){return ew(f)&&$d(f)}var XE=Rt||nw;function Bd(f){var v=ko(f)?oe.call(f):"";return v==u||v==h}function ZE(f){return typeof f=="number"&&f>-1&&f%1==0&&f<=s}function ko(f){var v=typeof f;return!!f&&(v=="object"||v=="function")}function ew(f){return!!f&&typeof f=="object"}function al(f){return $d(f)?SE(f):DE(f)}function tw(){return[]}function nw(){return!1}t.exports=QE})(va,va.exports);var PI=va.exports;const Rf=dh(PI);function OI({store:t}){const e=Rf(t.$state);t.$reset=()=>t.$patch(Rf(e))}var kI=!1;/*!
 * pinia v2.1.6
 * (c) 2023 Eduardo San Martin Morote
 * @license MIT
 */let mm;const cc=t=>mm=t,_m=Symbol();function eu(t){return t&&typeof t=="object"&&Object.prototype.toString.call(t)==="[object Object]"&&typeof t.toJSON!="function"}var yi;(function(t){t.direct="direct",t.patchObject="patch object",t.patchFunction="patch function"})(yi||(yi={}));function DI(){const t=Sg(!0),e=t.run(()=>He({}));let n=[],r=[];const s=ec({install(i){cc(s),s._a=i,i.provide(_m,s),i.config.globalProperties.$pinia=s,r.forEach(o=>n.push(o)),r=[]},use(i){return!this._a&&!kI?r.push(i):n.push(i),this},_p:n,_a:null,_e:t,_s:new Map,state:e});return s}const ym=()=>{};function Sf(t,e,n,r=ym){t.push(e);const s=()=>{const i=t.indexOf(e);i>-1&&(t.splice(i,1),r())};return!n&&Qu()&&bg(s),s}function ts(t,...e){t.slice().forEach(n=>{n(...e)})}const NI=t=>t();function tu(t,e){t instanceof Map&&e instanceof Map&&e.forEach((n,r)=>t.set(r,n)),t instanceof Set&&e instanceof Set&&e.forEach(t.add,t);for(const n in e){if(!e.hasOwnProperty(n))continue;const r=e[n],s=t[n];eu(s)&&eu(r)&&t.hasOwnProperty(n)&&!qe(r)&&!er(r)?t[n]=tu(s,r):t[n]=r}return t}const VI=Symbol();function MI(t){return!eu(t)||!t.hasOwnProperty(VI)}const{assign:Hn}=Object;function xI(t){return!!(qe(t)&&t.effect)}function LI(t,e,n,r){const{state:s,actions:i,getters:o}=e,a=n.state.value[t];let c;function l(){a||(n.state.value[t]=s?s():{});const u=Ww(n.state.value[t]);return Hn(u,i,Object.keys(o||{}).reduce((h,d)=>(h[d]=ec(Se(()=>{cc(n);const p=n._s.get(t);return o[d].call(p,p)})),h),{}))}return c=vm(t,l,e,n,r,!0),c}function vm(t,e,n={},r,s,i){let o;const a=Hn({actions:{}},n),c={deep:!0};let l,u,h=[],d=[],p;const y=r.state.value[t];!i&&!y&&(r.state.value[t]={}),He({});let E;function I(B){let G;l=u=!1,typeof B=="function"?(B(r.state.value[t]),G={type:yi.patchFunction,storeId:t,events:p}):(tu(r.state.value[t],B),G={type:yi.patchObject,payload:B,storeId:t,events:p});const Y=E=Symbol();jr().then(()=>{E===Y&&(l=!0)}),u=!0,ts(h,G,r.state.value[t])}const C=i?function(){const{state:G}=n,Y=G?G():{};this.$patch(ae=>{Hn(ae,Y)})}:ym;function V(){o.stop(),h=[],d=[],r._s.delete(t)}function q(B,G){return function(){cc(r);const Y=Array.from(arguments),ae=[],We=[];function rt(b){ae.push(b)}function ne(b){We.push(b)}ts(d,{args:Y,name:B,store:ee,after:rt,onError:ne});let U;try{U=G.apply(this&&this.$id===t?this:ee,Y)}catch(b){throw ts(We,b),b}return U instanceof Promise?U.then(b=>(ts(ae,b),b)).catch(b=>(ts(We,b),Promise.reject(b))):(ts(ae,U),U)}}const N={_p:r,$id:t,$onAction:Sf.bind(null,d),$patch:I,$reset:C,$subscribe(B,G={}){const Y=Sf(h,B,G.detached,()=>ae()),ae=o.run(()=>nr(()=>r.state.value[t],We=>{(G.flush==="sync"?u:l)&&B({storeId:t,type:yi.direct,events:p},We)},Hn({},c,G)));return Y},$dispose:V},ee=rn(N);r._s.set(t,ee);const ie=r._a&&r._a.runWithContext||NI,we=r._e.run(()=>(o=Sg(),ie(()=>o.run(e))));for(const B in we){const G=we[B];if(qe(G)&&!xI(G)||er(G))i||(y&&MI(G)&&(qe(G)?G.value=y[B]:tu(G,y[B])),r.state.value[t][B]=G);else if(typeof G=="function"){const Y=q(B,G);we[B]=Y,a.actions[B]=G}}return Hn(ee,we),Hn(fe(ee),we),Object.defineProperty(ee,"$state",{get:()=>r.state.value[t],set:B=>{I(G=>{Hn(G,B)})}}),r._p.forEach(B=>{Hn(ee,o.run(()=>B({store:ee,app:r._a,pinia:r,options:a})))}),y&&i&&n.hydrate&&n.hydrate(ee.$state,y),l=!0,u=!0,ee}function fh(t,e,n){let r,s;const i=typeof e=="function";typeof t=="string"?(r=t,s=i?n:e):(s=t,r=t.id);function o(a,c){const l=VT();return a=a||(l?Kt(_m,null):null),a&&cc(a),a=mm,a._s.has(r)||(i?vm(r,e,s,a):LI(r,s,a)),a._s.get(r)}return o.$id=r,o}const so={TOP_LEFT:"top-left",TOP_RIGHT:"top-right",TOP_CENTER:"top-center",BOTTOM_LEFT:"bottom-left",BOTTOM_RIGHT:"bottom-right",BOTTOM_CENTER:"bottom-center"},As={LIGHT:"light",DARK:"dark",COLORED:"colored",AUTO:"auto"},Pt={INFO:"info",SUCCESS:"success",WARNING:"warning",ERROR:"error",DEFAULT:"default"},FI={BOUNCE:"bounce",SLIDE:"slide",FLIP:"flip",ZOOM:"zoom"},Em={dangerouslyHTMLString:!1,multiple:!0,position:so.TOP_RIGHT,autoClose:5e3,transition:"bounce",hideProgressBar:!1,pauseOnHover:!0,pauseOnFocusLoss:!0,closeOnClick:!0,className:"",bodyClassName:"",style:{},progressClassName:"",progressStyle:{},role:"alert",theme:"light"},UI={rtl:!1,newestOnTop:!1,toastClassName:""},wm={...Em,...UI};({...Em,type:Pt.DEFAULT});var Oe=(t=>(t[t.COLLAPSE_DURATION=300]="COLLAPSE_DURATION",t[t.DEBOUNCE_DURATION=50]="DEBOUNCE_DURATION",t.CSS_NAMESPACE="Toastify",t))(Oe||{}),nu=(t=>(t.ENTRANCE_ANIMATION_END="d",t))(nu||{});const $I={enter:"Toastify--animate Toastify__bounce-enter",exit:"Toastify--animate Toastify__bounce-exit",appendPosition:!0},BI={enter:"Toastify--animate Toastify__slide-enter",exit:"Toastify--animate Toastify__slide-exit",appendPosition:!0},jI={enter:"Toastify--animate Toastify__zoom-enter",exit:"Toastify--animate Toastify__zoom-exit"},qI={enter:"Toastify--animate Toastify__flip-enter",exit:"Toastify--animate Toastify__flip-exit"};function Tm(t){let e=$I;if(!t||typeof t=="string")switch(t){case"flip":e=qI;break;case"zoom":e=jI;break;case"slide":e=BI;break}else e=t;return e}function HI(t){return t.containerId||String(t.position)}const lc="will-unmount";function KI(t=so.TOP_RIGHT){return!!document.querySelector(".".concat(Oe.CSS_NAMESPACE,"__toast-container--").concat(t))}function zI(t=so.TOP_RIGHT){return"".concat(Oe.CSS_NAMESPACE,"__toast-container--").concat(t)}function WI(t,e,n=!1){const r=["".concat(Oe.CSS_NAMESPACE,"__toast-container"),"".concat(Oe.CSS_NAMESPACE,"__toast-container--").concat(t),n?"".concat(Oe.CSS_NAMESPACE,"__toast-container--rtl"):null].filter(Boolean).join(" ");return gs(e)?e({position:t,rtl:n,defaultClassName:r}):"".concat(r," ").concat(e||"")}function GI(t){var e;const{position:n,containerClassName:r,rtl:s=!1,style:i={}}=t,o=Oe.CSS_NAMESPACE,a=zI(n),c=document.querySelector(".".concat(o)),l=document.querySelector(".".concat(a)),u=!!l&&!((e=l.className)!=null&&e.includes(lc)),h=c||document.createElement("div"),d=document.createElement("div");d.className=WI(n,r,s),d.dataset.testid="".concat(Oe.CSS_NAMESPACE,"__toast-container--").concat(n),d.id=HI(t);for(const p in i)if(Object.prototype.hasOwnProperty.call(i,p)){const y=i[p];d.style[p]=y}return c||(h.className=Oe.CSS_NAMESPACE,document.body.appendChild(h)),u||h.appendChild(d),d}function ru(t){var e,n,r;const s=typeof t=="string"?t:((e=t.currentTarget)==null?void 0:e.id)||((n=t.target)==null?void 0:n.id),i=document.getElementById(s);i&&i.removeEventListener("animationend",ru,!1);try{Li[s].unmount(),(r=document.getElementById(s))==null||r.remove(),delete Li[s],delete ut[s]}catch{}}const Li=rn({});function QI(t,e){const n=document.getElementById(String(e));n&&(Li[n.id]=t)}function su(t,e=!0){const n=String(t);if(!Li[n])return;const r=document.getElementById(n);r&&r.classList.add(lc),e?(JI(t),r&&r.addEventListener("animationend",ru,!1)):ru(n),_n.items=_n.items.filter(s=>s.containerId!==t)}function YI(t){for(const e in Li)su(e,t);_n.items=[]}function Im(t,e){const n=document.getElementById(t.toastId);if(n){let r=t;r={...r,...Tm(r.transition)};const s=r.appendPosition?"".concat(r.exit,"--").concat(r.position):r.exit;n.className+=" ".concat(s),e&&e(n)}}function JI(t){for(const e in ut)if(e===t)for(const n of ut[e]||[])Im(n)}function XI(t){const e=io().find(n=>n.toastId===t);return e==null?void 0:e.containerId}function ph(t){return document.getElementById(t)}function ZI(t){const e=ph(t.containerId);return e&&e.classList.contains(lc)}function bf(t){var e;const n=Mi(t.content)?fe(t.content.props):null;return n??fe((e=t.data)!=null?e:{})}function e0(t){return t?_n.items.filter(e=>e.containerId===t).length>0:_n.items.length>0}function t0(){if(_n.items.length>0){const t=_n.items.shift();ta(t==null?void 0:t.toastContent,t==null?void 0:t.toastProps)}}const ut=rn({}),_n=rn({items:[]});function io(){const t=fe(ut);return Object.values(t).reduce((e,n)=>[...e,...n],[])}function n0(t){return io().find(e=>e.toastId===t)}function ta(t,e={}){if(ZI(e)){const n=ph(e.containerId);n&&n.addEventListener("animationend",iu.bind(null,t,e),!1)}else iu(t,e)}function iu(t,e={}){const n=ph(e.containerId);n&&n.removeEventListener("animationend",iu.bind(null,t,e),!1);const r=ut[e.containerId]||[],s=r.length>0;if(!s&&!KI(e.position)){const i=GI(e),o=pm(w0,e);o.mount(i),QI(o,i.id)}s&&(e.position=r[0].position),jr(()=>{e.updateId?hn.update(e):hn.add(t,e)})}const hn={add(t,e){const{containerId:n=""}=e;n&&(ut[n]=ut[n]||[],ut[n].find(r=>r.toastId===e.toastId)||setTimeout(()=>{var r,s;e.newestOnTop?(r=ut[n])==null||r.unshift(e):(s=ut[n])==null||s.push(e),e.onOpen&&e.onOpen(bf(e))},e.delay||0))},remove(t){if(t){const e=XI(t);if(e){const n=ut[e];let r=n.find(s=>s.toastId===t);ut[e]=n.filter(s=>s.toastId!==t),!ut[e].length&&!e0(e)&&su(e,!1),t0(),jr(()=>{r!=null&&r.onClose&&(r.onClose(bf(r)),r=void 0)})}}},update(t={}){const{containerId:e=""}=t;if(e&&t.updateId){ut[e]=ut[e]||[];const n=ut[e].find(r=>r.toastId===t.toastId);n&&setTimeout(()=>{for(const r in t)if(Object.prototype.hasOwnProperty.call(t,r)){const s=t[r];n[r]=s}},t.delay||0)}},clear(t,e=!0){t?su(t,e):YI(e)},dismissCallback(t){var e;const n=(e=t.currentTarget)==null?void 0:e.id,r=document.getElementById(n);r&&(r.removeEventListener("animationend",hn.dismissCallback,!1),setTimeout(()=>{hn.remove(n)}))},dismiss(t){if(t){const e=io();for(const n of e)if(n.toastId===t){Im(n,r=>{r.addEventListener("animationend",hn.dismissCallback,!1)});break}}}},Am=rn({}),Ea=rn({});function Rm(){return Math.random().toString(36).substring(2,9)}function r0(t){return typeof t=="number"&&!isNaN(t)}function ou(t){return typeof t=="string"}function gs(t){return typeof t=="function"}function uc(...t){return xn(...t)}function na(t){return typeof t=="object"&&(!!(t!=null&&t.render)||!!(t!=null&&t.setup)||typeof(t==null?void 0:t.type)=="object")}function s0(t={}){Am["".concat(Oe.CSS_NAMESPACE,"-default-options")]=t}function i0(){return Am["".concat(Oe.CSS_NAMESPACE,"-default-options")]||wm}function o0(){return document.documentElement.classList.contains("dark")?"dark":"light"}var ra=(t=>(t[t.Enter=0]="Enter",t[t.Exit=1]="Exit",t))(ra||{});const Sm={containerId:{type:[String,Number],required:!1,default:""},clearOnUrlChange:{type:Boolean,required:!1,default:!0},dangerouslyHTMLString:{type:Boolean,required:!1,default:!1},multiple:{type:Boolean,required:!1,default:!0},limit:{type:Number,required:!1,default:void 0},position:{type:String,required:!1,default:so.TOP_LEFT},bodyClassName:{type:String,required:!1,default:""},autoClose:{type:[Number,Boolean],required:!1,default:!1},closeButton:{type:[Boolean,Function,Object],required:!1,default:void 0},transition:{type:[String,Object],required:!1,default:"bounce"},hideProgressBar:{type:Boolean,required:!1,default:!1},pauseOnHover:{type:Boolean,required:!1,default:!0},pauseOnFocusLoss:{type:Boolean,required:!1,default:!0},closeOnClick:{type:Boolean,required:!1,default:!0},progress:{type:Number,required:!1,default:void 0},progressClassName:{type:String,required:!1,default:""},toastStyle:{type:Object,required:!1,default(){return{}}},progressStyle:{type:Object,required:!1,default(){return{}}},role:{type:String,required:!1,default:"alert"},theme:{type:String,required:!1,default:As.AUTO},content:{type:[String,Object,Function],required:!1,default:""},toastId:{type:[String,Number],required:!1,default:""},data:{type:[Object,String],required:!1,default(){return{}}},type:{type:String,required:!1,default:Pt.DEFAULT},icon:{type:[Boolean,String,Number,Object,Function],required:!1,default:void 0},delay:{type:Number,required:!1,default:void 0},onOpen:{type:Function,required:!1,default:void 0},onClose:{type:Function,required:!1,default:void 0},onClick:{type:Function,required:!1,default:void 0},isLoading:{type:Boolean,required:!1,default:void 0},rtl:{type:Boolean,required:!1,default:!1},toastClassName:{type:String,required:!1,default:""},updateId:{type:[String,Number],required:!1,default:""}},a0={autoClose:{type:[Number,Boolean],required:!0},isRunning:{type:Boolean,required:!1,default:void 0},type:{type:String,required:!1,default:Pt.DEFAULT},theme:{type:String,required:!1,default:As.AUTO},hide:{type:Boolean,required:!1,default:void 0},className:{type:[String,Function],required:!1,default:""},controlledProgress:{type:Boolean,required:!1,default:void 0},rtl:{type:Boolean,required:!1,default:void 0},isIn:{type:Boolean,required:!1,default:void 0},progress:{type:Number,required:!1,default:void 0},closeToast:{type:Function,required:!1,default:void 0}},c0=Bs({name:"ProgressBar",props:a0,setup(t,{attrs:e}){const n=He(),r=Se(()=>t.hide?"true":"false"),s=Se(()=>({...e.style||{},animationDuration:"".concat(t.autoClose===!0?5e3:t.autoClose,"ms"),animationPlayState:t.isRunning?"running":"paused",opacity:t.hide?0:1,transform:t.controlledProgress?"scaleX(".concat(t.progress,")"):"none"})),i=Se(()=>["".concat(Oe.CSS_NAMESPACE,"__progress-bar"),t.controlledProgress?"".concat(Oe.CSS_NAMESPACE,"__progress-bar--controlled"):"".concat(Oe.CSS_NAMESPACE,"__progress-bar--animated"),"".concat(Oe.CSS_NAMESPACE,"__progress-bar-theme--").concat(t.theme),"".concat(Oe.CSS_NAMESPACE,"__progress-bar--").concat(t.type),t.rtl?"".concat(Oe.CSS_NAMESPACE,"__progress-bar--rtl"):null].filter(Boolean).join(" ")),o=Se(()=>"".concat(i.value," ").concat((e==null?void 0:e.class)||"")),a=()=>{n.value&&(n.value.onanimationend=null,n.value.ontransitionend=null)},c=()=>{t.isIn&&t.closeToast&&t.autoClose!==!1&&(t.closeToast(),a())},l=Se(()=>t.controlledProgress?null:c),u=Se(()=>t.controlledProgress?c:null);return gi(()=>{n.value&&(a(),n.value.onanimationend=l.value,n.value.ontransitionend=u.value)}),()=>_e("div",{ref:n,role:"progressbar","aria-hidden":r.value,"aria-label":"notification timer",class:o.value,style:s.value},null)}}),l0=Bs({name:"CloseButton",inheritAttrs:!1,props:{theme:{type:String,required:!1,default:As.AUTO},type:{type:String,required:!1,default:As.LIGHT},ariaLabel:{type:String,required:!1,default:"close"},closeToast:{type:Function,required:!1,default:void 0}},setup(t){return()=>_e("button",{class:"".concat(Oe.CSS_NAMESPACE,"__close-button ").concat(Oe.CSS_NAMESPACE,"__close-button--").concat(t.theme),type:"button",onClick:e=>{e.stopPropagation(),t.closeToast&&t.closeToast(e)},"aria-label":t.ariaLabel},[_e("svg",{"aria-hidden":"true",viewBox:"0 0 14 16"},[_e("path",{"fill-rule":"evenodd",d:"M7.71 8.23l3.75 3.75-1.48 1.48-3.75-3.75-3.75 3.75L1 11.98l3.75-3.75L1 4.48 2.48 3l3.75 3.75L9.98 3l1.48 1.48-3.75 3.75z"},null)])])}}),hc=({theme:t,type:e,path:n,...r})=>_e("svg",xn({viewBox:"0 0 24 24",width:"100%",height:"100%",fill:t==="colored"?"currentColor":"var(--toastify-icon-color-".concat(e,")")},r),[_e("path",{d:n},null)]);function u0(t){return _e(hc,xn(t,{path:"M23.32 17.191L15.438 2.184C14.728.833 13.416 0 11.996 0c-1.42 0-2.733.833-3.443 2.184L.533 17.448a4.744 4.744 0 000 4.368C1.243 23.167 2.555 24 3.975 24h16.05C22.22 24 24 22.044 24 19.632c0-.904-.251-1.746-.68-2.44zm-9.622 1.46c0 1.033-.724 1.823-1.698 1.823s-1.698-.79-1.698-1.822v-.043c0-1.028.724-1.822 1.698-1.822s1.698.79 1.698 1.822v.043zm.039-12.285l-.84 8.06c-.057.581-.408.943-.897.943-.49 0-.84-.367-.896-.942l-.84-8.065c-.057-.624.25-1.095.779-1.095h1.91c.528.005.84.476.784 1.1z"}),null)}function h0(t){return _e(hc,xn(t,{path:"M12 0a12 12 0 1012 12A12.013 12.013 0 0012 0zm.25 5a1.5 1.5 0 11-1.5 1.5 1.5 1.5 0 011.5-1.5zm2.25 13.5h-4a1 1 0 010-2h.75a.25.25 0 00.25-.25v-4.5a.25.25 0 00-.25-.25h-.75a1 1 0 010-2h1a2 2 0 012 2v4.75a.25.25 0 00.25.25h.75a1 1 0 110 2z"}),null)}function d0(t){return _e(hc,xn(t,{path:"M12 0a12 12 0 1012 12A12.014 12.014 0 0012 0zm6.927 8.2l-6.845 9.289a1.011 1.011 0 01-1.43.188l-4.888-3.908a1 1 0 111.25-1.562l4.076 3.261 6.227-8.451a1 1 0 111.61 1.183z"}),null)}function f0(t){return _e(hc,xn(t,{path:"M11.983 0a12.206 12.206 0 00-8.51 3.653A11.8 11.8 0 000 12.207 11.779 11.779 0 0011.8 24h.214A12.111 12.111 0 0024 11.791 11.766 11.766 0 0011.983 0zM10.5 16.542a1.476 1.476 0 011.449-1.53h.027a1.527 1.527 0 011.523 1.47 1.475 1.475 0 01-1.449 1.53h-.027a1.529 1.529 0 01-1.523-1.47zM11 12.5v-6a1 1 0 012 0v6a1 1 0 11-2 0z"}),null)}function p0(){return _e("div",{class:"".concat(Oe.CSS_NAMESPACE,"__spinner")},null)}const au={info:h0,warning:u0,success:d0,error:f0,spinner:p0},g0=t=>t in au;function m0({theme:t,type:e,isLoading:n,icon:r}){let s;const i={theme:t,type:e};return n?s=au.spinner():r===!1?s=void 0:na(r)?s=fe(r):gs(r)?s=r(i):Mi(r)?s=Vr(r,i):ou(r)||r0(r)?s=r:g0(e)&&(s=au[e](i)),s}const _0=()=>{};function y0(t,e,n=Oe.COLLAPSE_DURATION){const{scrollHeight:r,style:s}=t,i=n;requestAnimationFrame(()=>{s.minHeight="initial",s.height=r+"px",s.transition="all ".concat(i,"ms"),requestAnimationFrame(()=>{s.height="0",s.padding="0",s.margin="0",setTimeout(e,i)})})}function v0(t){const e=He(!1),n=He(!1),r=He(!1),s=He(ra.Enter),i=rn({...t,appendPosition:t.appendPosition||!1,collapse:typeof t.collapse>"u"?!0:t.collapse,collapseDuration:t.collapseDuration||Oe.COLLAPSE_DURATION}),o=i.done||_0,a=Se(()=>i.appendPosition?"".concat(i.enter,"--").concat(i.position):i.enter),c=Se(()=>i.appendPosition?"".concat(i.exit,"--").concat(i.position):i.exit),l=Se(()=>t.pauseOnHover?{onMouseenter:I,onMouseleave:E}:{});function u(){const V=a.value.split(" ");d().addEventListener(nu.ENTRANCE_ANIMATION_END,E,{once:!0});const q=ee=>{const ie=d();ee.target===ie&&(ie.dispatchEvent(new Event(nu.ENTRANCE_ANIMATION_END)),ie.removeEventListener("animationend",q),ie.removeEventListener("animationcancel",q),s.value===ra.Enter&&ee.type!=="animationcancel"&&ie.classList.remove(...V))},N=()=>{const ee=d();ee.classList.add(...V),ee.addEventListener("animationend",q),ee.addEventListener("animationcancel",q)};t.pauseOnFocusLoss&&p(),N()}function h(){if(!d())return;const V=()=>{const N=d();N.removeEventListener("animationend",V),i.collapse?y0(N,o,i.collapseDuration):o()},q=()=>{const N=d();s.value=ra.Exit,N&&(N.className+=" ".concat(c.value),N.addEventListener("animationend",V))};n.value||(r.value?V():setTimeout(q))}function d(){return t.toastRef.value}function p(){document.hasFocus()||I(),window.addEventListener("focus",E),window.addEventListener("blur",I)}function y(){window.removeEventListener("focus",E),window.removeEventListener("blur",I)}function E(){(!t.loading.value||t.isLoading===void 0)&&(e.value=!0)}function I(){e.value=!1}function C(V){V&&(V.stopPropagation(),V.preventDefault()),n.value=!1}return gi(h),gi(()=>{const V=io();n.value=V.findIndex(q=>q.toastId===i.toastId)>-1}),gi(()=>{t.isLoading!==void 0&&(t.loading.value?I():E())}),ro(u),sc(()=>{t.pauseOnFocusLoss&&y()}),{isIn:n,isRunning:e,hideToast:C,eventHandlers:l}}const E0=Bs({name:"ToastItem",inheritAttrs:!1,props:Sm,setup(t){const e=He(),n=Se(()=>!!t.isLoading),r=Se(()=>t.progress!==void 0&&t.progress!==null),s=Se(()=>m0(t)),i=Se(()=>["".concat(Oe.CSS_NAMESPACE,"__toast"),"".concat(Oe.CSS_NAMESPACE,"__toast-theme--").concat(t.theme),"".concat(Oe.CSS_NAMESPACE,"__toast--").concat(t.type),t.rtl?"".concat(Oe.CSS_NAMESPACE,"__toast--rtl"):void 0,t.toastClassName||""].filter(Boolean).join(" ")),{isRunning:o,isIn:a,hideToast:c,eventHandlers:l}=v0({toastRef:e,loading:n,done:()=>{hn.remove(t.toastId)},...Tm(t.transition),...t});return()=>_e("div",xn({id:t.toastId,class:i.value,style:t.toastStyle||{},ref:e,"data-testid":"toast-item-".concat(t.toastId),onClick:u=>{t.closeOnClick&&c(),t.onClick&&t.onClick(u)}},l.value),[_e("div",{role:t.role,"data-testid":"toast-body",class:"".concat(Oe.CSS_NAMESPACE,"__toast-body ").concat(t.bodyClassName||"")},[s.value!=null&&_e("div",{"data-testid":"toast-icon-".concat(t.type),class:["".concat(Oe.CSS_NAMESPACE,"__toast-icon"),t.isLoading?"":"".concat(Oe.CSS_NAMESPACE,"--animate-icon ").concat(Oe.CSS_NAMESPACE,"__zoom-enter")].join(" ")},[na(s.value)?cs(fe(s.value),{theme:t.theme,type:t.type}):gs(s.value)?s.value({theme:t.theme,type:t.type}):s.value]),_e("div",{"data-testid":"toast-content"},[na(t.content)?cs(fe(t.content),{toastProps:fe(t),closeToast:c,data:t.data}):gs(t.content)?t.content({toastProps:fe(t),closeToast:c,data:t.data}):t.dangerouslyHTMLString?cs("div",{innerHTML:t.content}):t.content])]),(t.closeButton===void 0||t.closeButton===!0)&&_e(l0,{theme:t.theme,closeToast:u=>{u.stopPropagation(),u.preventDefault(),c()}},null),na(t.closeButton)?cs(fe(t.closeButton),{closeToast:c,type:t.type,theme:t.theme}):gs(t.closeButton)?t.closeButton({closeToast:c,type:t.type,theme:t.theme}):null,_e(c0,{className:t.progressClassName,style:t.progressStyle,rtl:t.rtl,theme:t.theme,isIn:a.value,type:t.type,hide:t.hideProgressBar,isRunning:o.value,autoClose:t.autoClose,controlledProgress:r.value,progress:t.progress,closeToast:t.isLoading?void 0:c},null)])}});let vi=0;function bm(){typeof window>"u"||(vi&&window.cancelAnimationFrame(vi),vi=window.requestAnimationFrame(bm),Ea.lastUrl!==window.location.href&&(Ea.lastUrl=window.location.href,hn.clear()))}const w0=Bs({name:"ToastifyContainer",inheritAttrs:!1,props:Sm,setup(t){const e=Se(()=>t.containerId),n=Se(()=>ut[e.value]||[]),r=Se(()=>n.value.filter(s=>s.position===t.position));return ro(()=>{typeof window<"u"&&t.clearOnUrlChange&&window.requestAnimationFrame(bm)}),sc(()=>{typeof window<"u"&&vi&&(window.cancelAnimationFrame(vi),Ea.lastUrl="")}),()=>_e(Gt,null,[r.value.map(s=>{const{toastId:i=""}=s;return _e(E0,xn({key:i},s),null)})])}});let ml=!1;function Cm(){const t=[];return io().forEach(e=>{const n=document.getElementById(e.containerId);n&&!n.classList.contains(lc)&&t.push(e)}),t}function T0(t){const e=Cm().length,n=t??0;return n>0&&e+_n.items.length>=n}function I0(t){T0(t.limit)&&!t.updateId&&_n.items.push({toastId:t.toastId,containerId:t.containerId,toastContent:t.content,toastProps:t})}function hr(t,e,n={}){if(ml)return;n=uc(i0(),{type:e},fe(n)),(!n.toastId||typeof n.toastId!="string"&&typeof n.toastId!="number")&&(n.toastId=Rm()),n={...n,content:t,containerId:n.containerId||String(n.position)};const r=Number(n==null?void 0:n.progress);return r<0&&(n.progress=0),r>1&&(n.progress=1),n.theme==="auto"&&(n.theme=o0()),I0(n),Ea.lastUrl=window.location.href,n.multiple?_n.items.length?n.updateId&&ta(t,n):ta(t,n):(ml=!0,Ue.clearAll(void 0,!1),setTimeout(()=>{ta(t,n)},0),setTimeout(()=>{ml=!1},390)),n.toastId}const Ue=(t,e)=>hr(t,Pt.DEFAULT,e);Ue.info=(t,e)=>hr(t,Pt.DEFAULT,{...e,type:Pt.INFO});Ue.error=(t,e)=>hr(t,Pt.DEFAULT,{...e,type:Pt.ERROR});Ue.warning=(t,e)=>hr(t,Pt.DEFAULT,{...e,type:Pt.WARNING});Ue.warn=Ue.warning;Ue.success=(t,e)=>hr(t,Pt.DEFAULT,{...e,type:Pt.SUCCESS});Ue.loading=(t,e)=>hr(t,Pt.DEFAULT,uc(e,{isLoading:!0,autoClose:!1,closeOnClick:!1,closeButton:!1,draggable:!1}));Ue.dark=(t,e)=>hr(t,Pt.DEFAULT,uc(e,{theme:As.DARK}));Ue.remove=t=>{t?hn.dismiss(t):hn.clear()};Ue.clearAll=(t,e)=>{hn.clear(t,e)};Ue.isActive=t=>{let e=!1;return e=Cm().findIndex(n=>n.toastId===t)>-1,e};Ue.update=(t,e={})=>{setTimeout(()=>{const n=n0(t);if(n){const r=fe(n),{content:s}=r,i={...r,...e,toastId:e.toastId||t,updateId:Rm()},o=i.render||s;delete i.render,hr(o,i.type,i)}},0)};Ue.done=t=>{Ue.update(t,{isLoading:!1,progress:1})};Ue.promise=A0;function A0(t,{pending:e,error:n,success:r},s){var i,o,a;let c;const l={...s||{},autoClose:!1};e&&(c=ou(e)?Ue.loading(e,l):Ue.loading(e.render,{...l,...e}));const u={autoClose:(i=s==null?void 0:s.autoClose)!=null?i:!0,closeOnClick:(o=s==null?void 0:s.closeOnClick)!=null?o:!0,closeButton:(a=s==null?void 0:s.autoClose)!=null?a:null,isLoading:void 0,draggable:null,delay:100},h=(p,y,E)=>{if(y==null){Ue.remove(c);return}const I={type:p,...u,...s,data:E},C=ou(y)?{render:y}:y;return c?Ue.update(c,{...I,...C,isLoading:!1}):Ue(C.render,{...I,...C,isLoading:!1}),E},d=gs(t)?t():t;return d.then(p=>{h("success",r,p)}).catch(p=>{h("error",n,p)}),d}Ue.POSITION=so;Ue.THEME=As;Ue.TYPE=Pt;Ue.TRANSITIONS=FI;const Pm={install(t,e={}){R0(e)}};typeof window<"u"&&(window.Vue3Toastify=Pm);function R0(t={}){const e=uc(wm,t);s0(e)}/*!
  * vue-router v4.2.5
  * (c) 2023 Eduardo San Martin Morote
  * @license MIT
  */const ss=typeof window<"u";function S0(t){return t.__esModule||t[Symbol.toStringTag]==="Module"}const De=Object.assign;function _l(t,e){const n={};for(const r in e){const s=e[r];n[r]=Zt(s)?s.map(t):t(s)}return n}const Ei=()=>{},Zt=Array.isArray,b0=/\/$/,C0=t=>t.replace(b0,"");function yl(t,e,n="/"){let r,s={},i="",o="";const a=e.indexOf("#");let c=e.indexOf("?");return a<c&&a>=0&&(c=-1),c>-1&&(r=e.slice(0,c),i=e.slice(c+1,a>-1?a:e.length),s=t(i)),a>-1&&(r=r||e.slice(0,a),o=e.slice(a,e.length)),r=D0(r??e,n),{fullPath:r+(i&&"?")+i+o,path:r,query:s,hash:o}}function P0(t,e){const n=e.query?t(e.query):"";return e.path+(n&&"?")+n+(e.hash||"")}function Cf(t,e){return!e||!t.toLowerCase().startsWith(e.toLowerCase())?t:t.slice(e.length)||"/"}function O0(t,e,n){const r=e.matched.length-1,s=n.matched.length-1;return r>-1&&r===s&&Rs(e.matched[r],n.matched[s])&&Om(e.params,n.params)&&t(e.query)===t(n.query)&&e.hash===n.hash}function Rs(t,e){return(t.aliasOf||t)===(e.aliasOf||e)}function Om(t,e){if(Object.keys(t).length!==Object.keys(e).length)return!1;for(const n in t)if(!k0(t[n],e[n]))return!1;return!0}function k0(t,e){return Zt(t)?Pf(t,e):Zt(e)?Pf(e,t):t===e}function Pf(t,e){return Zt(e)?t.length===e.length&&t.every((n,r)=>n===e[r]):t.length===1&&t[0]===e}function D0(t,e){if(t.startsWith("/"))return t;if(!t)return e;const n=e.split("/"),r=t.split("/"),s=r[r.length-1];(s===".."||s===".")&&r.push("");let i=n.length-1,o,a;for(o=0;o<r.length;o++)if(a=r[o],a!==".")if(a==="..")i>1&&i--;else break;return n.slice(0,i).join("/")+"/"+r.slice(o-(o===r.length?1:0)).join("/")}var Fi;(function(t){t.pop="pop",t.push="push"})(Fi||(Fi={}));var wi;(function(t){t.back="back",t.forward="forward",t.unknown=""})(wi||(wi={}));function N0(t){if(!t)if(ss){const e=document.querySelector("base");t=e&&e.getAttribute("href")||"/",t=t.replace(/^\w+:\/\/[^\/]+/,"")}else t="/";return t[0]!=="/"&&t[0]!=="#"&&(t="/"+t),C0(t)}const V0=/^[^#]+#/;function M0(t,e){return t.replace(V0,"#")+e}function x0(t,e){const n=document.documentElement.getBoundingClientRect(),r=t.getBoundingClientRect();return{behavior:e.behavior,left:r.left-n.left-(e.left||0),top:r.top-n.top-(e.top||0)}}const dc=()=>({left:window.pageXOffset,top:window.pageYOffset});function L0(t){let e;if("el"in t){const n=t.el,r=typeof n=="string"&&n.startsWith("#"),s=typeof n=="string"?r?document.getElementById(n.slice(1)):document.querySelector(n):n;if(!s)return;e=x0(s,t)}else e=t;"scrollBehavior"in document.documentElement.style?window.scrollTo(e):window.scrollTo(e.left!=null?e.left:window.pageXOffset,e.top!=null?e.top:window.pageYOffset)}function Of(t,e){return(history.state?history.state.position-e:-1)+t}const cu=new Map;function F0(t,e){cu.set(t,e)}function U0(t){const e=cu.get(t);return cu.delete(t),e}let $0=()=>location.protocol+"//"+location.host;function km(t,e){const{pathname:n,search:r,hash:s}=e,i=t.indexOf("#");if(i>-1){let a=s.includes(t.slice(i))?t.slice(i).length:1,c=s.slice(a);return c[0]!=="/"&&(c="/"+c),Cf(c,"")}return Cf(n,t)+r+s}function B0(t,e,n,r){let s=[],i=[],o=null;const a=({state:d})=>{const p=km(t,location),y=n.value,E=e.value;let I=0;if(d){if(n.value=p,e.value=d,o&&o===y){o=null;return}I=E?d.position-E.position:0}else r(p);s.forEach(C=>{C(n.value,y,{delta:I,type:Fi.pop,direction:I?I>0?wi.forward:wi.back:wi.unknown})})};function c(){o=n.value}function l(d){s.push(d);const p=()=>{const y=s.indexOf(d);y>-1&&s.splice(y,1)};return i.push(p),p}function u(){const{history:d}=window;d.state&&d.replaceState(De({},d.state,{scroll:dc()}),"")}function h(){for(const d of i)d();i=[],window.removeEventListener("popstate",a),window.removeEventListener("beforeunload",u)}return window.addEventListener("popstate",a),window.addEventListener("beforeunload",u,{passive:!0}),{pauseListeners:c,listen:l,destroy:h}}function kf(t,e,n,r=!1,s=!1){return{back:t,current:e,forward:n,replaced:r,position:window.history.length,scroll:s?dc():null}}function j0(t){const{history:e,location:n}=window,r={value:km(t,n)},s={value:e.state};s.value||i(r.value,{back:null,current:r.value,forward:null,position:e.length-1,replaced:!0,scroll:null},!0);function i(c,l,u){const h=t.indexOf("#"),d=h>-1?(n.host&&document.querySelector("base")?t:t.slice(h))+c:$0()+t+c;try{e[u?"replaceState":"pushState"](l,"",d),s.value=l}catch(p){console.error(p),n[u?"replace":"assign"](d)}}function o(c,l){const u=De({},e.state,kf(s.value.back,c,s.value.forward,!0),l,{position:s.value.position});i(c,u,!0),r.value=c}function a(c,l){const u=De({},s.value,e.state,{forward:c,scroll:dc()});i(u.current,u,!0);const h=De({},kf(r.value,c,null),{position:u.position+1},l);i(c,h,!1),r.value=c}return{location:r,state:s,push:a,replace:o}}function q0(t){t=N0(t);const e=j0(t),n=B0(t,e.state,e.location,e.replace);function r(i,o=!0){o||n.pauseListeners(),history.go(i)}const s=De({location:"",base:t,go:r,createHref:M0.bind(null,t)},e,n);return Object.defineProperty(s,"location",{enumerable:!0,get:()=>e.location.value}),Object.defineProperty(s,"state",{enumerable:!0,get:()=>e.state.value}),s}function H0(t){return typeof t=="string"||t&&typeof t=="object"}function Dm(t){return typeof t=="string"||typeof t=="symbol"}const Bn={path:"/",name:void 0,params:{},query:{},hash:"",fullPath:"/",matched:[],meta:{},redirectedFrom:void 0},Nm=Symbol("");var Df;(function(t){t[t.aborted=4]="aborted",t[t.cancelled=8]="cancelled",t[t.duplicated=16]="duplicated"})(Df||(Df={}));function Ss(t,e){return De(new Error,{type:t,[Nm]:!0},e)}function En(t,e){return t instanceof Error&&Nm in t&&(e==null||!!(t.type&e))}const Nf="[^/]+?",K0={sensitive:!1,strict:!1,start:!0,end:!0},z0=/[.+*?^${}()[\]/\\]/g;function W0(t,e){const n=De({},K0,e),r=[];let s=n.start?"^":"";const i=[];for(const l of t){const u=l.length?[]:[90];n.strict&&!l.length&&(s+="/");for(let h=0;h<l.length;h++){const d=l[h];let p=40+(n.sensitive?.25:0);if(d.type===0)h||(s+="/"),s+=d.value.replace(z0,"\\$&"),p+=40;else if(d.type===1){const{value:y,repeatable:E,optional:I,regexp:C}=d;i.push({name:y,repeatable:E,optional:I});const V=C||Nf;if(V!==Nf){p+=10;try{new RegExp(`(${V})`)}catch(N){throw new Error(`Invalid custom RegExp for param "${y}" (${V}): `+N.message)}}let q=E?`((?:${V})(?:/(?:${V}))*)`:`(${V})`;h||(q=I&&l.length<2?`(?:/${q})`:"/"+q),I&&(q+="?"),s+=q,p+=20,I&&(p+=-8),E&&(p+=-20),V===".*"&&(p+=-50)}u.push(p)}r.push(u)}if(n.strict&&n.end){const l=r.length-1;r[l][r[l].length-1]+=.7000000000000001}n.strict||(s+="/?"),n.end?s+="$":n.strict&&(s+="(?:/|$)");const o=new RegExp(s,n.sensitive?"":"i");function a(l){const u=l.match(o),h={};if(!u)return null;for(let d=1;d<u.length;d++){const p=u[d]||"",y=i[d-1];h[y.name]=p&&y.repeatable?p.split("/"):p}return h}function c(l){let u="",h=!1;for(const d of t){(!h||!u.endsWith("/"))&&(u+="/"),h=!1;for(const p of d)if(p.type===0)u+=p.value;else if(p.type===1){const{value:y,repeatable:E,optional:I}=p,C=y in l?l[y]:"";if(Zt(C)&&!E)throw new Error(`Provided param "${y}" is an array but it is not repeatable (* or + modifiers)`);const V=Zt(C)?C.join("/"):C;if(!V)if(I)d.length<2&&(u.endsWith("/")?u=u.slice(0,-1):h=!0);else throw new Error(`Missing required param "${y}"`);u+=V}}return u||"/"}return{re:o,score:r,keys:i,parse:a,stringify:c}}function G0(t,e){let n=0;for(;n<t.length&&n<e.length;){const r=e[n]-t[n];if(r)return r;n++}return t.length<e.length?t.length===1&&t[0]===40+40?-1:1:t.length>e.length?e.length===1&&e[0]===40+40?1:-1:0}function Q0(t,e){let n=0;const r=t.score,s=e.score;for(;n<r.length&&n<s.length;){const i=G0(r[n],s[n]);if(i)return i;n++}if(Math.abs(s.length-r.length)===1){if(Vf(r))return 1;if(Vf(s))return-1}return s.length-r.length}function Vf(t){const e=t[t.length-1];return t.length>0&&e[e.length-1]<0}const Y0={type:0,value:""},J0=/[a-zA-Z0-9_]/;function X0(t){if(!t)return[[]];if(t==="/")return[[Y0]];if(!t.startsWith("/"))throw new Error(`Invalid path "${t}"`);function e(p){throw new Error(`ERR (${n})/"${l}": ${p}`)}let n=0,r=n;const s=[];let i;function o(){i&&s.push(i),i=[]}let a=0,c,l="",u="";function h(){l&&(n===0?i.push({type:0,value:l}):n===1||n===2||n===3?(i.length>1&&(c==="*"||c==="+")&&e(`A repeatable param (${l}) must be alone in its segment. eg: '/:ids+.`),i.push({type:1,value:l,regexp:u,repeatable:c==="*"||c==="+",optional:c==="*"||c==="?"})):e("Invalid state to consume buffer"),l="")}function d(){l+=c}for(;a<t.length;){if(c=t[a++],c==="\\"&&n!==2){r=n,n=4;continue}switch(n){case 0:c==="/"?(l&&h(),o()):c===":"?(h(),n=1):d();break;case 4:d(),n=r;break;case 1:c==="("?n=2:J0.test(c)?d():(h(),n=0,c!=="*"&&c!=="?"&&c!=="+"&&a--);break;case 2:c===")"?u[u.length-1]=="\\"?u=u.slice(0,-1)+c:n=3:u+=c;break;case 3:h(),n=0,c!=="*"&&c!=="?"&&c!=="+"&&a--,u="";break;default:e("Unknown state");break}}return n===2&&e(`Unfinished custom RegExp for param "${l}"`),h(),o(),s}function Z0(t,e,n){const r=W0(X0(t.path),n),s=De(r,{record:t,parent:e,children:[],alias:[]});return e&&!s.record.aliasOf==!e.record.aliasOf&&e.children.push(s),s}function eA(t,e){const n=[],r=new Map;e=Lf({strict:!1,end:!0,sensitive:!1},e);function s(u){return r.get(u)}function i(u,h,d){const p=!d,y=tA(u);y.aliasOf=d&&d.record;const E=Lf(e,u),I=[y];if("alias"in u){const q=typeof u.alias=="string"?[u.alias]:u.alias;for(const N of q)I.push(De({},y,{components:d?d.record.components:y.components,path:N,aliasOf:d?d.record:y}))}let C,V;for(const q of I){const{path:N}=q;if(h&&N[0]!=="/"){const ee=h.record.path,ie=ee[ee.length-1]==="/"?"":"/";q.path=h.record.path+(N&&ie+N)}if(C=Z0(q,h,E),d?d.alias.push(C):(V=V||C,V!==C&&V.alias.push(C),p&&u.name&&!xf(C)&&o(u.name)),y.children){const ee=y.children;for(let ie=0;ie<ee.length;ie++)i(ee[ie],C,d&&d.children[ie])}d=d||C,(C.record.components&&Object.keys(C.record.components).length||C.record.name||C.record.redirect)&&c(C)}return V?()=>{o(V)}:Ei}function o(u){if(Dm(u)){const h=r.get(u);h&&(r.delete(u),n.splice(n.indexOf(h),1),h.children.forEach(o),h.alias.forEach(o))}else{const h=n.indexOf(u);h>-1&&(n.splice(h,1),u.record.name&&r.delete(u.record.name),u.children.forEach(o),u.alias.forEach(o))}}function a(){return n}function c(u){let h=0;for(;h<n.length&&Q0(u,n[h])>=0&&(u.record.path!==n[h].record.path||!Vm(u,n[h]));)h++;n.splice(h,0,u),u.record.name&&!xf(u)&&r.set(u.record.name,u)}function l(u,h){let d,p={},y,E;if("name"in u&&u.name){if(d=r.get(u.name),!d)throw Ss(1,{location:u});E=d.record.name,p=De(Mf(h.params,d.keys.filter(V=>!V.optional).map(V=>V.name)),u.params&&Mf(u.params,d.keys.map(V=>V.name))),y=d.stringify(p)}else if("path"in u)y=u.path,d=n.find(V=>V.re.test(y)),d&&(p=d.parse(y),E=d.record.name);else{if(d=h.name?r.get(h.name):n.find(V=>V.re.test(h.path)),!d)throw Ss(1,{location:u,currentLocation:h});E=d.record.name,p=De({},h.params,u.params),y=d.stringify(p)}const I=[];let C=d;for(;C;)I.unshift(C.record),C=C.parent;return{name:E,path:y,params:p,matched:I,meta:rA(I)}}return t.forEach(u=>i(u)),{addRoute:i,resolve:l,removeRoute:o,getRoutes:a,getRecordMatcher:s}}function Mf(t,e){const n={};for(const r of e)r in t&&(n[r]=t[r]);return n}function tA(t){return{path:t.path,redirect:t.redirect,name:t.name,meta:t.meta||{},aliasOf:void 0,beforeEnter:t.beforeEnter,props:nA(t),children:t.children||[],instances:{},leaveGuards:new Set,updateGuards:new Set,enterCallbacks:{},components:"components"in t?t.components||null:t.component&&{default:t.component}}}function nA(t){const e={},n=t.props||!1;if("component"in t)e.default=n;else for(const r in t.components)e[r]=typeof n=="object"?n[r]:n;return e}function xf(t){for(;t;){if(t.record.aliasOf)return!0;t=t.parent}return!1}function rA(t){return t.reduce((e,n)=>De(e,n.meta),{})}function Lf(t,e){const n={};for(const r in t)n[r]=r in e?e[r]:t[r];return n}function Vm(t,e){return e.children.some(n=>n===t||Vm(t,n))}const Mm=/#/g,sA=/&/g,iA=/\//g,oA=/=/g,aA=/\?/g,xm=/\+/g,cA=/%5B/g,lA=/%5D/g,Lm=/%5E/g,uA=/%60/g,Fm=/%7B/g,hA=/%7C/g,Um=/%7D/g,dA=/%20/g;function gh(t){return encodeURI(""+t).replace(hA,"|").replace(cA,"[").replace(lA,"]")}function fA(t){return gh(t).replace(Fm,"{").replace(Um,"}").replace(Lm,"^")}function lu(t){return gh(t).replace(xm,"%2B").replace(dA,"+").replace(Mm,"%23").replace(sA,"%26").replace(uA,"`").replace(Fm,"{").replace(Um,"}").replace(Lm,"^")}function pA(t){return lu(t).replace(oA,"%3D")}function gA(t){return gh(t).replace(Mm,"%23").replace(aA,"%3F")}function mA(t){return t==null?"":gA(t).replace(iA,"%2F")}function wa(t){try{return decodeURIComponent(""+t)}catch{}return""+t}function _A(t){const e={};if(t===""||t==="?")return e;const r=(t[0]==="?"?t.slice(1):t).split("&");for(let s=0;s<r.length;++s){const i=r[s].replace(xm," "),o=i.indexOf("="),a=wa(o<0?i:i.slice(0,o)),c=o<0?null:wa(i.slice(o+1));if(a in e){let l=e[a];Zt(l)||(l=e[a]=[l]),l.push(c)}else e[a]=c}return e}function Ff(t){let e="";for(let n in t){const r=t[n];if(n=pA(n),r==null){r!==void 0&&(e+=(e.length?"&":"")+n);continue}(Zt(r)?r.map(i=>i&&lu(i)):[r&&lu(r)]).forEach(i=>{i!==void 0&&(e+=(e.length?"&":"")+n,i!=null&&(e+="="+i))})}return e}function yA(t){const e={};for(const n in t){const r=t[n];r!==void 0&&(e[n]=Zt(r)?r.map(s=>s==null?null:""+s):r==null?r:""+r)}return e}const vA=Symbol(""),Uf=Symbol(""),fc=Symbol(""),mh=Symbol(""),uu=Symbol("");function ti(){let t=[];function e(r){return t.push(r),()=>{const s=t.indexOf(r);s>-1&&t.splice(s,1)}}function n(){t=[]}return{add:e,list:()=>t.slice(),reset:n}}function Wn(t,e,n,r,s){const i=r&&(r.enterCallbacks[s]=r.enterCallbacks[s]||[]);return()=>new Promise((o,a)=>{const c=h=>{h===!1?a(Ss(4,{from:n,to:e})):h instanceof Error?a(h):H0(h)?a(Ss(2,{from:e,to:h})):(i&&r.enterCallbacks[s]===i&&typeof h=="function"&&i.push(h),o())},l=t.call(r&&r.instances[s],e,n,c);let u=Promise.resolve(l);t.length<3&&(u=u.then(c)),u.catch(h=>a(h))})}function vl(t,e,n,r){const s=[];for(const i of t)for(const o in i.components){let a=i.components[o];if(!(e!=="beforeRouteEnter"&&!i.instances[o]))if(EA(a)){const l=(a.__vccOpts||a)[e];l&&s.push(Wn(l,n,r,i,o))}else{let c=a();s.push(()=>c.then(l=>{if(!l)return Promise.reject(new Error(`Couldn't resolve component "${o}" at "${i.path}"`));const u=S0(l)?l.default:l;i.components[o]=u;const d=(u.__vccOpts||u)[e];return d&&Wn(d,n,r,i,o)()}))}}return s}function EA(t){return typeof t=="object"||"displayName"in t||"props"in t||"__vccOpts"in t}function $f(t){const e=Kt(fc),n=Kt(mh),r=Se(()=>e.resolve(ot(t.to))),s=Se(()=>{const{matched:c}=r.value,{length:l}=c,u=c[l-1],h=n.matched;if(!u||!h.length)return-1;const d=h.findIndex(Rs.bind(null,u));if(d>-1)return d;const p=Bf(c[l-2]);return l>1&&Bf(u)===p&&h[h.length-1].path!==p?h.findIndex(Rs.bind(null,c[l-2])):d}),i=Se(()=>s.value>-1&&AA(n.params,r.value.params)),o=Se(()=>s.value>-1&&s.value===n.matched.length-1&&Om(n.params,r.value.params));function a(c={}){return IA(c)?e[ot(t.replace)?"replace":"push"](ot(t.to)).catch(Ei):Promise.resolve()}return{route:r,href:Se(()=>r.value.href),isActive:i,isExactActive:o,navigate:a}}const wA=Bs({name:"RouterLink",compatConfig:{MODE:3},props:{to:{type:[String,Object],required:!0},replace:Boolean,activeClass:String,exactActiveClass:String,custom:Boolean,ariaCurrentValue:{type:String,default:"page"}},useLink:$f,setup(t,{slots:e}){const n=rn($f(t)),{options:r}=Kt(fc),s=Se(()=>({[jf(t.activeClass,r.linkActiveClass,"router-link-active")]:n.isActive,[jf(t.exactActiveClass,r.linkExactActiveClass,"router-link-exact-active")]:n.isExactActive}));return()=>{const i=e.default&&e.default(n);return t.custom?i:cs("a",{"aria-current":n.isExactActive?t.ariaCurrentValue:null,href:n.href,onClick:n.navigate,class:s.value},i)}}}),TA=wA;function IA(t){if(!(t.metaKey||t.altKey||t.ctrlKey||t.shiftKey)&&!t.defaultPrevented&&!(t.button!==void 0&&t.button!==0)){if(t.currentTarget&&t.currentTarget.getAttribute){const e=t.currentTarget.getAttribute("target");if(/\b_blank\b/i.test(e))return}return t.preventDefault&&t.preventDefault(),!0}}function AA(t,e){for(const n in e){const r=e[n],s=t[n];if(typeof r=="string"){if(r!==s)return!1}else if(!Zt(s)||s.length!==r.length||r.some((i,o)=>i!==s[o]))return!1}return!0}function Bf(t){return t?t.aliasOf?t.aliasOf.path:t.path:""}const jf=(t,e,n)=>t??e??n,RA=Bs({name:"RouterView",inheritAttrs:!1,props:{name:{type:String,default:"default"},route:Object},compatConfig:{MODE:3},setup(t,{attrs:e,slots:n}){const r=Kt(uu),s=Se(()=>t.route||r.value),i=Kt(Uf,0),o=Se(()=>{let l=ot(i);const{matched:u}=s.value;let h;for(;(h=u[l])&&!h.components;)l++;return l}),a=Se(()=>s.value.matched[o.value]);Zo(Uf,Se(()=>o.value+1)),Zo(vA,a),Zo(uu,s);const c=He();return nr(()=>[c.value,a.value,t.name],([l,u,h],[d,p,y])=>{u&&(u.instances[h]=l,p&&p!==u&&l&&l===d&&(u.leaveGuards.size||(u.leaveGuards=p.leaveGuards),u.updateGuards.size||(u.updateGuards=p.updateGuards))),l&&u&&(!p||!Rs(u,p)||!d)&&(u.enterCallbacks[h]||[]).forEach(E=>E(l))},{flush:"post"}),()=>{const l=s.value,u=t.name,h=a.value,d=h&&h.components[u];if(!d)return qf(n.default,{Component:d,route:l});const p=h.props[u],y=p?p===!0?l.params:typeof p=="function"?p(l):p:null,I=cs(d,De({},y,e,{onVnodeUnmounted:C=>{C.component.isUnmounted&&(h.instances[u]=null)},ref:c}));return qf(n.default,{Component:I,route:l})||I}}});function qf(t,e){if(!t)return null;const n=t(e);return n.length===1?n[0]:n}const $m=RA;function SA(t){const e=eA(t.routes,t),n=t.parseQuery||_A,r=t.stringifyQuery||Ff,s=t.history,i=ti(),o=ti(),a=ti(),c=$g(Bn);let l=Bn;ss&&t.scrollBehavior&&"scrollRestoration"in history&&(history.scrollRestoration="manual");const u=_l.bind(null,T=>""+T),h=_l.bind(null,mA),d=_l.bind(null,wa);function p(T,H){let M,K;return Dm(T)?(M=e.getRecordMatcher(T),K=H):K=T,e.addRoute(K,M)}function y(T){const H=e.getRecordMatcher(T);H&&e.removeRoute(H)}function E(){return e.getRoutes().map(T=>T.record)}function I(T){return!!e.getRecordMatcher(T)}function C(T,H){if(H=De({},H||c.value),typeof T=="string"){const _=yl(n,T,H.path),w=e.resolve({path:_.path},H),S=s.createHref(_.fullPath);return De(_,w,{params:d(w.params),hash:wa(_.hash),redirectedFrom:void 0,href:S})}let M;if("path"in T)M=De({},T,{path:yl(n,T.path,H.path).path});else{const _=De({},T.params);for(const w in _)_[w]==null&&delete _[w];M=De({},T,{params:h(_)}),H.params=h(H.params)}const K=e.resolve(M,H),pe=T.hash||"";K.params=u(d(K.params));const g=P0(r,De({},T,{hash:fA(pe),path:K.path})),m=s.createHref(g);return De({fullPath:g,hash:pe,query:r===Ff?yA(T.query):T.query||{}},K,{redirectedFrom:void 0,href:m})}function V(T){return typeof T=="string"?yl(n,T,c.value.path):De({},T)}function q(T,H){if(l!==T)return Ss(8,{from:H,to:T})}function N(T){return we(T)}function ee(T){return N(De(V(T),{replace:!0}))}function ie(T){const H=T.matched[T.matched.length-1];if(H&&H.redirect){const{redirect:M}=H;let K=typeof M=="function"?M(T):M;return typeof K=="string"&&(K=K.includes("?")||K.includes("#")?K=V(K):{path:K},K.params={}),De({query:T.query,hash:T.hash,params:"path"in K?{}:T.params},K)}}function we(T,H){const M=l=C(T),K=c.value,pe=T.state,g=T.force,m=T.replace===!0,_=ie(M);if(_)return we(De(V(_),{state:typeof _=="object"?De({},pe,_.state):pe,force:g,replace:m}),H||M);const w=M;w.redirectedFrom=H;let S;return!g&&O0(r,K,M)&&(S=Ss(16,{to:w,from:K}),ye(K,K,!0,!1)),(S?Promise.resolve(S):Y(w,K)).catch(P=>En(P)?En(P,2)?P:$(P):O(P,w,K)).then(P=>{if(P){if(En(P,2))return we(De({replace:m},V(P.to),{state:typeof P.to=="object"?De({},pe,P.to.state):pe,force:g}),H||w)}else P=We(w,K,!0,m,pe);return ae(w,K,P),P})}function B(T,H){const M=q(T,H);return M?Promise.reject(M):Promise.resolve()}function G(T){const H=Ve.values().next().value;return H&&typeof H.runWithContext=="function"?H.runWithContext(T):T()}function Y(T,H){let M;const[K,pe,g]=bA(T,H);M=vl(K.reverse(),"beforeRouteLeave",T,H);for(const _ of K)_.leaveGuards.forEach(w=>{M.push(Wn(w,T,H))});const m=B.bind(null,T,H);return M.push(m),Me(M).then(()=>{M=[];for(const _ of i.list())M.push(Wn(_,T,H));return M.push(m),Me(M)}).then(()=>{M=vl(pe,"beforeRouteUpdate",T,H);for(const _ of pe)_.updateGuards.forEach(w=>{M.push(Wn(w,T,H))});return M.push(m),Me(M)}).then(()=>{M=[];for(const _ of g)if(_.beforeEnter)if(Zt(_.beforeEnter))for(const w of _.beforeEnter)M.push(Wn(w,T,H));else M.push(Wn(_.beforeEnter,T,H));return M.push(m),Me(M)}).then(()=>(T.matched.forEach(_=>_.enterCallbacks={}),M=vl(g,"beforeRouteEnter",T,H),M.push(m),Me(M))).then(()=>{M=[];for(const _ of o.list())M.push(Wn(_,T,H));return M.push(m),Me(M)}).catch(_=>En(_,8)?_:Promise.reject(_))}function ae(T,H,M){a.list().forEach(K=>G(()=>K(T,H,M)))}function We(T,H,M,K,pe){const g=q(T,H);if(g)return g;const m=H===Bn,_=ss?history.state:{};M&&(K||m?s.replace(T.fullPath,De({scroll:m&&_&&_.scroll},pe)):s.push(T.fullPath,pe)),c.value=T,ye(T,H,M,m),$()}let rt;function ne(){rt||(rt=s.listen((T,H,M)=>{if(!Qe.listening)return;const K=C(T),pe=ie(K);if(pe){we(De(pe,{replace:!0}),K).catch(Ei);return}l=K;const g=c.value;ss&&F0(Of(g.fullPath,M.delta),dc()),Y(K,g).catch(m=>En(m,12)?m:En(m,2)?(we(m.to,K).then(_=>{En(_,20)&&!M.delta&&M.type===Fi.pop&&s.go(-1,!1)}).catch(Ei),Promise.reject()):(M.delta&&s.go(-M.delta,!1),O(m,K,g))).then(m=>{m=m||We(K,g,!1),m&&(M.delta&&!En(m,8)?s.go(-M.delta,!1):M.type===Fi.pop&&En(m,20)&&s.go(-1,!1)),ae(K,g,m)}).catch(Ei)}))}let U=ti(),b=ti(),L;function O(T,H,M){$(T);const K=b.list();return K.length?K.forEach(pe=>pe(T,H,M)):console.error(T),Promise.reject(T)}function se(){return L&&c.value!==Bn?Promise.resolve():new Promise((T,H)=>{U.add([T,H])})}function $(T){return L||(L=!T,ne(),U.list().forEach(([H,M])=>T?M(T):H()),U.reset()),T}function ye(T,H,M,K){const{scrollBehavior:pe}=t;if(!ss||!pe)return Promise.resolve();const g=!M&&U0(Of(T.fullPath,0))||(K||!M)&&history.state&&history.state.scroll||null;return jr().then(()=>pe(T,H,g)).then(m=>m&&L0(m)).catch(m=>O(m,T,H))}const ve=T=>s.go(T);let Ie;const Ve=new Set,Qe={currentRoute:c,listening:!0,addRoute:p,removeRoute:y,hasRoute:I,getRoutes:E,resolve:C,options:t,push:N,replace:ee,go:ve,back:()=>ve(-1),forward:()=>ve(1),beforeEach:i.add,beforeResolve:o.add,afterEach:a.add,onError:b.add,isReady:se,install(T){const H=this;T.component("RouterLink",TA),T.component("RouterView",$m),T.config.globalProperties.$router=H,Object.defineProperty(T.config.globalProperties,"$route",{enumerable:!0,get:()=>ot(c)}),ss&&!Ie&&c.value===Bn&&(Ie=!0,N(s.location).catch(pe=>{}));const M={};for(const pe in Bn)Object.defineProperty(M,pe,{get:()=>c.value[pe],enumerable:!0});T.provide(fc,H),T.provide(mh,Fg(M)),T.provide(uu,c);const K=T.unmount;Ve.add(T),T.unmount=function(){Ve.delete(T),Ve.size<1&&(l=Bn,rt&&rt(),rt=null,c.value=Bn,Ie=!1,L=!1),K()}}};function Me(T){return T.reduce((H,M)=>H.then(()=>G(M)),Promise.resolve())}return Qe}function bA(t,e){const n=[],r=[],s=[],i=Math.max(e.matched.length,t.matched.length);for(let o=0;o<i;o++){const a=e.matched[o];a&&(t.matched.find(l=>Rs(l,a))?r.push(a):n.push(a));const c=t.matched[o];c&&(e.matched.find(l=>Rs(l,c))||s.push(c))}return[n,r,s]}function gD(){return Kt(fc)}function mD(){return Kt(mh)}function Bm(t){return Qu()?(bg(t),!0):!1}function bs(t){return typeof t=="function"?t():ot(t)}const CA=typeof window<"u"&&typeof document<"u",PA=Object.prototype.toString,OA=t=>PA.call(t)==="[object Object]",jm=()=>{};function kA(t,e){function n(...r){return new Promise((s,i)=>{Promise.resolve(t(()=>e.apply(this,r),{fn:e,thisArg:this,args:r})).then(s).catch(i)})}return n}const qm=t=>t();function DA(t=qm){const e=He(!0);function n(){e.value=!1}function r(){e.value=!0}const s=(...i)=>{e.value&&t(...i)};return{isActive:Za(e),pause:n,resume:r,eventFilter:s}}function NA(...t){if(t.length!==1)return Yw(...t);const e=t[0];return typeof e=="function"?Za(zw(()=>({get:e,set:jm}))):He(e)}function VA(t,e,n={}){const{eventFilter:r=qm,...s}=n;return nr(t,kA(r,e),s)}function MA(t,e,n={}){const{eventFilter:r,...s}=n,{eventFilter:i,pause:o,resume:a,isActive:c}=DA(r);return{stop:VA(t,e,{...s,eventFilter:i}),pause:o,resume:a,isActive:c}}function xA(t,e=!0){hm()?ro(t):e?t():jr(t)}function LA(t=!1,e={}){const{truthyValue:n=!0,falsyValue:r=!1}=e,s=qe(t),i=He(t);function o(a){if(arguments.length)return i.value=a,i.value;{const c=bs(n);return i.value=i.value===c?bs(r):c,i.value}}return s?o:[i,o]}function Hm(t){var e;const n=bs(t);return(e=n==null?void 0:n.$el)!=null?e:n}const Ui=CA?window:void 0;function Hf(...t){let e,n,r,s;if(typeof t[0]=="string"||Array.isArray(t[0])?([n,r,s]=t,e=Ui):[e,n,r,s]=t,!e)return jm;Array.isArray(n)||(n=[n]),Array.isArray(r)||(r=[r]);const i=[],o=()=>{i.forEach(u=>u()),i.length=0},a=(u,h,d,p)=>(u.addEventListener(h,d,p),()=>u.removeEventListener(h,d,p)),c=nr(()=>[Hm(e),bs(s)],([u,h])=>{if(o(),!u)return;const d=OA(h)?{...h}:h;i.push(...n.flatMap(p=>r.map(y=>a(u,p,y,d))))},{immediate:!0,flush:"post"}),l=()=>{c(),o()};return Bm(l),l}function FA(){const t=He(!1);return hm()&&ro(()=>{t.value=!0}),t}function UA(t){const e=FA();return Se(()=>(e.value,!!t()))}function $A(t,e={}){const{window:n=Ui}=e,r=UA(()=>n&&"matchMedia"in n&&typeof n.matchMedia=="function");let s;const i=He(!1),o=l=>{i.value=l.matches},a=()=>{s&&("removeEventListener"in s?s.removeEventListener("change",o):s.removeListener(o))},c=gi(()=>{r.value&&(a(),s=n.matchMedia(bs(t)),"addEventListener"in s?s.addEventListener("change",o):s.addListener(o),i.value=s.matches)});return Bm(()=>{c(),a(),s=void 0}),i}const Uo=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{},$o="__vueuse_ssr_handlers__",BA=jA();function jA(){return $o in Uo||(Uo[$o]=Uo[$o]||{}),Uo[$o]}function Km(t,e){return BA[t]||e}function qA(t){return t==null?"any":t instanceof Set?"set":t instanceof Map?"map":t instanceof Date?"date":typeof t=="boolean"?"boolean":typeof t=="string"?"string":typeof t=="object"?"object":Number.isNaN(t)?"any":"number"}const HA={boolean:{read:t=>t==="true",write:t=>String(t)},object:{read:t=>JSON.parse(t),write:t=>JSON.stringify(t)},number:{read:t=>Number.parseFloat(t),write:t=>String(t)},any:{read:t=>t,write:t=>String(t)},string:{read:t=>t,write:t=>String(t)},map:{read:t=>new Map(JSON.parse(t)),write:t=>JSON.stringify(Array.from(t.entries()))},set:{read:t=>new Set(JSON.parse(t)),write:t=>JSON.stringify(Array.from(t))},date:{read:t=>new Date(t),write:t=>t.toISOString()}},Kf="vueuse-storage";function KA(t,e,n,r={}){var s;const{flush:i="pre",deep:o=!0,listenToStorageChanges:a=!0,writeDefaults:c=!0,mergeDefaults:l=!1,shallow:u,window:h=Ui,eventFilter:d,onError:p=B=>{console.error(B)}}=r,y=(u?$g:He)(e);if(!n)try{n=Km("getDefaultStorage",()=>{var B;return(B=Ui)==null?void 0:B.localStorage})()}catch(B){p(B)}if(!n)return y;const E=bs(e),I=qA(E),C=(s=r.serializer)!=null?s:HA[I],{pause:V,resume:q}=MA(y,()=>N(y.value),{flush:i,deep:o,eventFilter:d});return h&&a&&(Hf(h,"storage",we),Hf(h,Kf,ie)),we(),y;function N(B){try{if(B==null)n.removeItem(t);else{const G=C.write(B),Y=n.getItem(t);Y!==G&&(n.setItem(t,G),h&&h.dispatchEvent(new CustomEvent(Kf,{detail:{key:t,oldValue:Y,newValue:G,storageArea:n}})))}}catch(G){p(G)}}function ee(B){const G=B?B.newValue:n.getItem(t);if(G==null)return c&&E!==null&&n.setItem(t,C.write(E)),E;if(!B&&l){const Y=C.read(G);return typeof l=="function"?l(Y,E):I==="object"&&!Array.isArray(Y)?{...E,...Y}:Y}else return typeof G!="string"?G:C.read(G)}function ie(B){we(B.detail)}function we(B){if(!(B&&B.storageArea!==n)){if(B&&B.key==null){y.value=E;return}if(!(B&&B.key!==t)){V();try{(B==null?void 0:B.newValue)!==C.write(y.value)&&(y.value=ee(B))}catch(G){p(G)}finally{B?jr(q):q()}}}}}function zA(t){return $A("(prefers-color-scheme: dark)",t)}function WA(t={}){const{selector:e="html",attribute:n="class",initialValue:r="auto",window:s=Ui,storage:i,storageKey:o="vueuse-color-scheme",listenToStorageChanges:a=!0,storageRef:c,emitAuto:l,disableTransition:u=!0}=t,h={auto:"",light:"light",dark:"dark",...t.modes||{}},d=zA({window:s}),p=Se(()=>d.value?"dark":"light"),y=c||(o==null?NA(r):KA(o,r,i,{window:s,listenToStorageChanges:a})),E=Se(()=>y.value==="auto"?p.value:y.value),I=Km("updateHTMLAttrs",(N,ee,ie)=>{const we=typeof N=="string"?s==null?void 0:s.document.querySelector(N):Hm(N);if(!we)return;let B;if(u){B=s.document.createElement("style");const G="*,*::before,*::after{-webkit-transition:none!important;-moz-transition:none!important;-o-transition:none!important;-ms-transition:none!important;transition:none!important}";B.appendChild(document.createTextNode(G)),s.document.head.appendChild(B)}if(ee==="class"){const G=ie.split(/\s/g);Object.values(h).flatMap(Y=>(Y||"").split(/\s/g)).filter(Boolean).forEach(Y=>{G.includes(Y)?we.classList.add(Y):we.classList.remove(Y)})}else we.setAttribute(ee,ie);u&&(s.getComputedStyle(B).opacity,document.head.removeChild(B))});function C(N){var ee;I(e,n,(ee=h[N])!=null?ee:N)}function V(N){t.onChanged?t.onChanged(N,C):C(N)}nr(E,V,{flush:"post",immediate:!0}),xA(()=>V(E.value));const q=Se({get(){return l?y.value:E.value},set(N){y.value=N}});try{return Object.assign(q,{store:y,system:p,state:E})}catch{return q}}function GA(t={}){const{valueDark:e="dark",valueLight:n=""}=t,r=WA({...t,onChanged:(i,o)=>{var a;t.onChanged?(a=t.onChanged)==null||a.call(t,i==="dark",o,i):o(i)},modes:{dark:e,light:n}});return Se({get(){return r.value==="dark"},set(i){const o=i?"dark":"light";r.system.value===o?r.value="auto":r.value=o}})}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function It(){return typeof navigator<"u"&&typeof navigator.userAgent=="string"?navigator.userAgent:""}function iR(){return typeof window<"u"&&!!(window.cordova||window.phonegap||window.PhoneGap)&&/ios|iphone|ipod|ipad|android|blackberry|iemobile/i.test(It())}function oR(){const t=typeof chrome=="object"?chrome.runtime:typeof browser=="object"?browser.runtime:void 0;return typeof t=="object"&&t.id!==void 0}function aR(){return typeof navigator=="object"&&navigator.product==="ReactNative"}function cR(){const t=It();return t.indexOf("MSIE ")>=0||t.indexOf("Trident/")>=0}function lR(){try{return typeof indexedDB=="object"}catch{return!1}}function uR(){return new Promise((t,e)=>{try{let n=!0;const r="validate-browser-context-for-indexeddb-analytics-module",s=self.indexedDB.open(r);s.onsuccess=()=>{s.result.close(),n||self.indexedDB.deleteDatabase(r),t(!0)},s.onupgradeneeded=()=>{n=!1},s.onerror=()=>{var i;e(((i=s.error)===null||i===void 0?void 0:i.message)||"")}}catch(n){e(n)}})}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var Ae;(function(t){t[t.DEBUG=0]="DEBUG",t[t.VERBOSE=1]="VERBOSE",t[t.INFO=2]="INFO",t[t.WARN=3]="WARN",t[t.ERROR=4]="ERROR",t[t.SILENT=5]="SILENT"})(Ae||(Ae={}));const TR={debug:Ae.DEBUG,verbose:Ae.VERBOSE,info:Ae.INFO,warn:Ae.WARN,error:Ae.ERROR,silent:Ae.SILENT},IR=Ae.INFO,AR={[Ae.DEBUG]:"log",[Ae.VERBOSE]:"log",[Ae.INFO]:"info",[Ae.WARN]:"warn",[Ae.ERROR]:"error"},RR=(t,e,...n)=>{if(e<t.logLevel)return;const r=new Date().toISOString(),s=AR[e];if(s)console[s](`[${r}]  ${t.name}:`,...n);else throw new Error(`Attempted to log a message with an invalid logType (value: ${e})`)};class yh{constructor(e){this.name=e,this._logLevel=IR,this._logHandler=RR,this._userLogHandler=null}get logLevel(){return this._logLevel}set logLevel(e){if(!(e in Ae))throw new TypeError(`Invalid value "${e}" assigned to \`logLevel\``);this._logLevel=e}setLogLevel(e){this._logLevel=typeof e=="string"?TR[e]:e}get logHandler(){return this._logHandler}set logHandler(e){if(typeof e!="function")throw new TypeError("Value assigned to `logHandler` must be a function");this._logHandler=e}get userLogHandler(){return this._userLogHandler}set userLogHandler(e){this._userLogHandler=e}debug(...e){this._userLogHandler&&this._userLogHandler(this,Ae.DEBUG,...e),this._logHandler(this,Ae.DEBUG,...e)}log(...e){this._userLogHandler&&this._userLogHandler(this,Ae.VERBOSE,...e),this._logHandler(this,Ae.VERBOSE,...e)}info(...e){this._userLogHandler&&this._userLogHandler(this,Ae.INFO,...e),this._logHandler(this,Ae.INFO,...e)}warn(...e){this._userLogHandler&&this._userLogHandler(this,Ae.WARN,...e),this._logHandler(this,Ae.WARN,...e)}error(...e){this._userLogHandler&&this._userLogHandler(this,Ae.ERROR,...e),this._logHandler(this,Ae.ERROR,...e)}}const SR=(t,e)=>e.some(n=>t instanceof n);let Wf,Gf;function bR(){return Wf||(Wf=[IDBDatabase,IDBObjectStore,IDBIndex,IDBCursor,IDBTransaction])}function CR(){return Gf||(Gf=[IDBCursor.prototype.advance,IDBCursor.prototype.continue,IDBCursor.prototype.continuePrimaryKey])}const Xm=new WeakMap,hu=new WeakMap,Zm=new WeakMap,wl=new WeakMap,vh=new WeakMap;function PR(t){const e=new Promise((n,r)=>{const s=()=>{t.removeEventListener("success",i),t.removeEventListener("error",o)},i=()=>{n(rr(t.result)),s()},o=()=>{r(t.error),s()};t.addEventListener("success",i),t.addEventListener("error",o)});return e.then(n=>{n instanceof IDBCursor&&Xm.set(n,t)}).catch(()=>{}),vh.set(e,t),e}function OR(t){if(hu.has(t))return;const e=new Promise((n,r)=>{const s=()=>{t.removeEventListener("complete",i),t.removeEventListener("error",o),t.removeEventListener("abort",o)},i=()=>{n(),s()},o=()=>{r(t.error||new DOMException("AbortError","AbortError")),s()};t.addEventListener("complete",i),t.addEventListener("error",o),t.addEventListener("abort",o)});hu.set(t,e)}let du={get(t,e,n){if(t instanceof IDBTransaction){if(e==="done")return hu.get(t);if(e==="objectStoreNames")return t.objectStoreNames||Zm.get(t);if(e==="store")return n.objectStoreNames[1]?void 0:n.objectStore(n.objectStoreNames[0])}return rr(t[e])},set(t,e,n){return t[e]=n,!0},has(t,e){return t instanceof IDBTransaction&&(e==="done"||e==="store")?!0:e in t}};function kR(t){du=t(du)}function DR(t){return t===IDBDatabase.prototype.transaction&&!("objectStoreNames"in IDBTransaction.prototype)?function(e,...n){const r=t.call(Tl(this),e,...n);return Zm.set(r,e.sort?e.sort():[e]),rr(r)}:CR().includes(t)?function(...e){return t.apply(Tl(this),e),rr(Xm.get(this))}:function(...e){return rr(t.apply(Tl(this),e))}}function NR(t){return typeof t=="function"?DR(t):(t instanceof IDBTransaction&&OR(t),SR(t,bR())?new Proxy(t,du):t)}function rr(t){if(t instanceof IDBRequest)return PR(t);if(wl.has(t))return wl.get(t);const e=NR(t);return e!==t&&(wl.set(t,e),vh.set(e,t)),e}const Tl=t=>vh.get(t);function VR(t,e,{blocked:n,upgrade:r,blocking:s,terminated:i}={}){const o=indexedDB.open(t,e),a=rr(o);return r&&o.addEventListener("upgradeneeded",c=>{r(rr(o.result),c.oldVersion,c.newVersion,rr(o.transaction),c)}),n&&o.addEventListener("blocked",c=>n(c.oldVersion,c.newVersion,c)),a.then(c=>{i&&c.addEventListener("close",()=>i()),s&&c.addEventListener("versionchange",l=>s(l.oldVersion,l.newVersion,l))}).catch(()=>{}),a}const MR=["get","getKey","getAll","getAllKeys","count"],xR=["put","add","delete","clear"],Il=new Map;function Qf(t,e){if(!(t instanceof IDBDatabase&&!(e in t)&&typeof e=="string"))return;if(Il.get(e))return Il.get(e);const n=e.replace(/FromIndex$/,""),r=e!==n,s=xR.includes(n);if(!(n in(r?IDBIndex:IDBObjectStore).prototype)||!(s||MR.includes(n)))return;const i=async function(o,...a){const c=this.transaction(o,s?"readwrite":"readonly");let l=c.store;return r&&(l=l.index(a.shift())),(await Promise.all([l[n](...a),s&&c.done]))[0]};return Il.set(e,i),i}kR(t=>({...t,get:(e,n,r)=>Qf(e,n)||t.get(e,n,r),has:(e,n)=>!!Qf(e,n)||t.has(e,n)}));/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const js=lS;function e_(t,e={}){let n=t;typeof e!="object"&&(e={name:e});const r=Object.assign({name:pu,automaticDataCollectionEnabled:!1},e),s=r.name;if(typeof s!="string"||!s)throw sr.create("bad-app-name",{appName:String(s)});if(n||(n=Ym()),!n)throw sr.create("no-options");const i=Aa.get(s);if(i){if(Ia(n,i.options)&&Ia(r,i.config))return i;throw sr.create("duplicate-app",{appName:s})}const o=new wR(s);for(const c of gu.values())o.addComponent(c);const a=new fS(n,r,o);return Aa.set(s,a),a}function t_(t=pu){const e=Aa.get(t);if(!e&&t===pu&&Ym())return e_();if(!e)throw sr.create("no-app",{appName:t});return e}function ir(t,e,n){var r;let s=(r=uS[t])!==null&&r!==void 0?r:t;n&&(s+=`-${n}`);const i=s.match(/\s|\//),o=e.match(/\s|\//);if(i||o){const a=[`Unable to register library "${s}" with version "${e}":`];i&&a.push(`library name "${s}" contains illegal characters (whitespace or "/")`),i&&o&&a.push("and"),o&&a.push(`version name "${e}" contains illegal characters (whitespace or "/")`),xr.warn(a.join(" "));return}Cs(new Mr(`${s}-version`,()=>({library:s,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function TS(t){Cs(new Mr("platform-logger",e=>new LR(e),"PRIVATE")),Cs(new Mr("heartbeat",e=>new vS(e),"PRIVATE")),ir(fu,Yf,t),ir(fu,Yf,"esm2017"),ir("fire-js","")}TS("");var IS="firebase",AS="10.4.0";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Wo={mapValue:{fields:{__type__:{stringValue:"__max__"}}}};function Ur(t){return"nullValue"in t?0:"booleanValue"in t?1:"integerValue"in t||"doubleValue"in t?2:"timestampValue"in t?3:"stringValue"in t?5:"bytesValue"in t?6:"referenceValue"in t?7:"geoPointValue"in t?8:"arrayValue"in t?9:"mapValue"in t?Kh(t)?4:Gb(t)?9007199254740991:10:ue()}function yn(t,e){if(t===e)return!0;const n=Ur(t);if(n!==Ur(e))return!1;switch(n){case 0:case 9007199254740991:return!0;case 1:return t.booleanValue===e.booleanValue;case 4:return Yi(t).isEqual(Yi(e));case 3:return function(s,i){if(typeof s.timestampValue=="string"&&typeof i.timestampValue=="string"&&s.timestampValue.length===i.timestampValue.length)return s.timestampValue===i.timestampValue;const o=lr(s.timestampValue),a=lr(i.timestampValue);return o.seconds===a.seconds&&o.nanos===a.nanos}(t,e);case 5:return t.stringValue===e.stringValue;case 6:return function(s,i){return Fr(s.bytesValue).isEqual(Fr(i.bytesValue))}(t,e);case 7:return t.referenceValue===e.referenceValue;case 8:return function(s,i){return Je(s.geoPointValue.latitude)===Je(i.geoPointValue.latitude)&&Je(s.geoPointValue.longitude)===Je(i.geoPointValue.longitude)}(t,e);case 2:return function(s,i){if("integerValue"in s&&"integerValue"in i)return Je(s.integerValue)===Je(i.integerValue);if("doubleValue"in s&&"doubleValue"in i){const o=Je(s.doubleValue),a=Je(i.doubleValue);return o===a?Da(o)===Da(a):isNaN(o)&&isNaN(a)}return!1}(t,e);case 9:return ks(t.arrayValue.values||[],e.arrayValue.values||[],yn);case 10:return function(s,i){const o=s.mapValue.fields||{},a=i.mapValue.fields||{};if(gp(o)!==gp(a))return!1;for(const c in o)if(o.hasOwnProperty(c)&&(a[c]===void 0||!yn(o[c],a[c])))return!1;return!0}(t,e);default:return ue()}}function Xi(t,e){return(t.values||[]).find(n=>yn(n,e))!==void 0}function Ds(t,e){if(t===e)return 0;const n=Ur(t),r=Ur(e);if(n!==r)return Pe(n,r);switch(n){case 0:case 9007199254740991:return 0;case 1:return Pe(t.booleanValue,e.booleanValue);case 2:return function(i,o){const a=Je(i.integerValue||i.doubleValue),c=Je(o.integerValue||o.doubleValue);return a<c?-1:a>c?1:a===c?0:isNaN(a)?isNaN(c)?0:-1:1}(t,e);case 3:return _p(t.timestampValue,e.timestampValue);case 4:return _p(Yi(t),Yi(e));case 5:return Pe(t.stringValue,e.stringValue);case 6:return function(i,o){const a=Fr(i),c=Fr(o);return a.compareTo(c)}(t.bytesValue,e.bytesValue);case 7:return function(i,o){const a=i.split("/"),c=o.split("/");for(let l=0;l<a.length&&l<c.length;l++){const u=Pe(a[l],c[l]);if(u!==0)return u}return Pe(a.length,c.length)}(t.referenceValue,e.referenceValue);case 8:return function(i,o){const a=Pe(Je(i.latitude),Je(o.latitude));return a!==0?a:Pe(Je(i.longitude),Je(o.longitude))}(t.geoPointValue,e.geoPointValue);case 9:return function(i,o){const a=i.values||[],c=o.values||[];for(let l=0;l<a.length&&l<c.length;++l){const u=Ds(a[l],c[l]);if(u)return u}return Pe(a.length,c.length)}(t.arrayValue,e.arrayValue);case 10:return function(i,o){if(i===Wo.mapValue&&o===Wo.mapValue)return 0;if(i===Wo.mapValue)return 1;if(o===Wo.mapValue)return-1;const a=i.fields||{},c=Object.keys(a),l=o.fields||{},u=Object.keys(l);c.sort(),u.sort();for(let h=0;h<c.length&&h<u.length;++h){const d=Pe(c[h],u[h]);if(d!==0)return d;const p=Ds(a[c[h]],l[u[h]]);if(p!==0)return p}return Pe(c.length,u.length)}(t.mapValue,e.mapValue);default:throw ue()}}function _p(t,e){if(typeof t=="string"&&typeof e=="string"&&t.length===e.length)return Pe(t,e);const n=lr(t),r=lr(e),s=Pe(n.seconds,r.seconds);return s!==0?s:Pe(n.nanos,r.nanos)}function Ns(t){return Cu(t)}function Cu(t){return"nullValue"in t?"null":"booleanValue"in t?""+t.booleanValue:"integerValue"in t?""+t.integerValue:"doubleValue"in t?""+t.doubleValue:"timestampValue"in t?function(n){const r=lr(n);return`time(${r.seconds},${r.nanos})`}(t.timestampValue):"stringValue"in t?t.stringValue:"bytesValue"in t?function(n){return Fr(n).toBase64()}(t.bytesValue):"referenceValue"in t?function(n){return re.fromName(n).toString()}(t.referenceValue):"geoPointValue"in t?function(n){return`geo(${n.latitude},${n.longitude})`}(t.geoPointValue):"arrayValue"in t?function(n){let r="[",s=!0;for(const i of n.values||[])s?s=!1:r+=",",r+=Cu(i);return r+"]"}(t.arrayValue):"mapValue"in t?function(n){const r=Object.keys(n.fields||{}).sort();let s="{",i=!0;for(const o of r)i?i=!1:s+=",",s+=`${o}:${Cu(n.fields[o])}`;return s+"}"}(t.mapValue):ue()}function yp(t,e){return{referenceValue:`projects/${t.projectId}/databases/${t.database}/documents/${e.path.canonicalString()}`}}function Pu(t){return!!t&&"integerValue"in t}function Wh(t){return!!t&&"arrayValue"in t}function vp(t){return!!t&&"nullValue"in t}function Ep(t){return!!t&&"doubleValue"in t&&isNaN(Number(t.doubleValue))}function sa(t){return!!t&&"mapValue"in t}function Ii(t){if(t.geoPointValue)return{geoPointValue:Object.assign({},t.geoPointValue)};if(t.timestampValue&&typeof t.timestampValue=="object")return{timestampValue:Object.assign({},t.timestampValue)};if(t.mapValue){const e={mapValue:{fields:{}}};return Hr(t.mapValue.fields,(n,r)=>e.mapValue.fields[n]=Ii(r)),e}if(t.arrayValue){const e={arrayValue:{values:[]}};for(let n=0;n<(t.arrayValue.values||[]).length;++n)e.arrayValue.values[n]=Ii(t.arrayValue.values[n]);return e}return Object.assign({},t)}function Gb(t){return(((t.mapValue||{}).fields||{}).__type__||{}).stringValue==="__max__"}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Dt{constructor(e){this.value=e}static empty(){return new Dt({mapValue:{}})}field(e){if(e.isEmpty())return this.value;{let n=this.value;for(let r=0;r<e.length-1;++r)if(n=(n.mapValue.fields||{})[e.get(r)],!sa(n))return null;return n=(n.mapValue.fields||{})[e.lastSegment()],n||null}}set(e,n){this.getFieldsMap(e.popLast())[e.lastSegment()]=Ii(n)}setAll(e){let n=yt.emptyPath(),r={},s=[];e.forEach((o,a)=>{if(!n.isImmediateParentOf(a)){const c=this.getFieldsMap(n);this.applyChanges(c,r,s),r={},s=[],n=a.popLast()}o?r[a.lastSegment()]=Ii(o):s.push(a.lastSegment())});const i=this.getFieldsMap(n);this.applyChanges(i,r,s)}delete(e){const n=this.field(e.popLast());sa(n)&&n.mapValue.fields&&delete n.mapValue.fields[e.lastSegment()]}isEqual(e){return yn(this.value,e.value)}getFieldsMap(e){let n=this.value;n.mapValue.fields||(n.mapValue={fields:{}});for(let r=0;r<e.length;++r){let s=n.mapValue.fields[e.get(r)];sa(s)&&s.mapValue.fields||(s={mapValue:{fields:{}}},n.mapValue.fields[e.get(r)]=s),n=s}return n.mapValue.fields}applyChanges(e,n,r){Hr(n,(s,i)=>e[s]=i);for(const s of r)delete e[s]}clone(){return new Dt(Ii(this.value))}}function uy(t){const e=[];return Hr(t.fields,(n,r)=>{const s=new yt([n]);if(sa(r)){const i=uy(r.mapValue).fields;if(i.length===0)e.push(s);else for(const o of i)e.push(s.child(o))}else e.push(s)}),new Ut(e)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const lC=new Ke(re.comparator);function Dn(){return lC}const Ey=new Ke(re.comparator);function di(...t){let e=Ey;for(const n of t)e=e.insert(n.key,n);return e}function wy(t){let e=Ey;return t.forEach((n,r)=>e=e.insert(n,r.overlayedDocument)),e}function br(){return Ri()}function Ty(){return Ri()}function Ri(){return new Ws(t=>t.toString(),(t,e)=>t.isEqual(e))}const uC=new Ke(re.comparator),hC=new wt(re.comparator);function Te(...t){let e=hC;for(const n of t)e=e.add(n);return e}const dC=new wt(Pe);function fC(){return dC}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Iy(t,e){if(t.useProto3Json){if(isNaN(e))return{doubleValue:"NaN"};if(e===1/0)return{doubleValue:"Infinity"};if(e===-1/0)return{doubleValue:"-Infinity"}}return{doubleValue:Da(e)?"-0":e}}function Ay(t){return{integerValue:""+t}}function pC(t,e){return Kb(e)?Ay(e):Iy(t,e)}/**
 * @license
 * Copyright 2018 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Mc{constructor(){this._=void 0}}function gC(t,e,n){return t instanceof Ma?function(s,i){const o={fields:{__type__:{stringValue:"server_timestamp"},__local_write_time__:{timestampValue:{seconds:s.seconds,nanos:s.nanoseconds}}}};return i&&Kh(i)&&(i=zh(i)),i&&(o.fields.__previous_value__=i),{mapValue:o}}(n,e):t instanceof Vs?Sy(t,e):t instanceof Zi?by(t,e):function(s,i){const o=Ry(s,i),a=Rp(o)+Rp(s.Te);return Pu(o)&&Pu(s.Te)?Ay(a):Iy(s.serializer,a)}(t,e)}function mC(t,e,n){return t instanceof Vs?Sy(t,e):t instanceof Zi?by(t,e):n}function Ry(t,e){return t instanceof xa?function(r){return Pu(r)||function(i){return!!i&&"doubleValue"in i}(r)}(e)?e:{integerValue:0}:null}class Ma extends Mc{}class Vs extends Mc{constructor(e){super(),this.elements=e}}function Sy(t,e){const n=Cy(e);for(const r of t.elements)n.some(s=>yn(s,r))||n.push(r);return{arrayValue:{values:n}}}class Zi extends Mc{constructor(e){super(),this.elements=e}}function by(t,e){let n=Cy(e);for(const r of t.elements)n=n.filter(s=>!yn(s,r));return{arrayValue:{values:n}}}class xa extends Mc{constructor(e,n){super(),this.serializer=e,this.Te=n}}function Rp(t){return Je(t.integerValue||t.doubleValue)}function Cy(t){return Wh(t)&&t.arrayValue.values?t.arrayValue.values.slice():[]}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class _C{constructor(e,n){this.field=e,this.transform=n}}function yC(t,e){return t.field.isEqual(e.field)&&function(r,s){return r instanceof Vs&&s instanceof Vs||r instanceof Zi&&s instanceof Zi?ks(r.elements,s.elements,yn):r instanceof xa&&s instanceof xa?yn(r.Te,s.Te):r instanceof Ma&&s instanceof Ma}(t.transform,e.transform)}class vC{constructor(e,n){this.version=e,this.transformResults=n}}class zt{constructor(e,n){this.updateTime=e,this.exists=n}static none(){return new zt}static exists(e){return new zt(void 0,e)}static updateTime(e){return new zt(e)}get isNone(){return this.updateTime===void 0&&this.exists===void 0}isEqual(e){return this.exists===e.exists&&(this.updateTime?!!e.updateTime&&this.updateTime.isEqual(e.updateTime):!e.updateTime)}}function ia(t,e){return t.updateTime!==void 0?e.isFoundDocument()&&e.version.isEqual(t.updateTime):t.exists===void 0||t.exists===e.isFoundDocument()}class xc{}function Py(t,e){if(!t.hasLocalMutations||e&&e.fields.length===0)return null;if(e===null)return t.isNoDocument()?new Jh(t.key,zt.none()):new vo(t.key,t.data,zt.none());{const n=t.data,r=Dt.empty();let s=new wt(yt.comparator);for(let i of e.fields)if(!s.has(i)){let o=n.field(i);o===null&&i.length>1&&(i=i.popLast(),o=n.field(i)),o===null?r.delete(i):r.set(i,o),s=s.add(i)}return new pr(t.key,r,new Ut(s.toArray()),zt.none())}}function EC(t,e,n){t instanceof vo?function(s,i,o){const a=s.value.clone(),c=bp(s.fieldTransforms,i,o.transformResults);a.setAll(c),i.convertToFoundDocument(o.version,a).setHasCommittedMutations()}(t,e,n):t instanceof pr?function(s,i,o){if(!ia(s.precondition,i))return void i.convertToUnknownDocument(o.version);const a=bp(s.fieldTransforms,i,o.transformResults),c=i.data;c.setAll(Oy(s)),c.setAll(a),i.convertToFoundDocument(o.version,c).setHasCommittedMutations()}(t,e,n):function(s,i,o){i.convertToNoDocument(o.version).setHasCommittedMutations()}(0,e,n)}function Si(t,e,n,r){return t instanceof vo?function(i,o,a,c){if(!ia(i.precondition,o))return a;const l=i.value.clone(),u=Cp(i.fieldTransforms,c,o);return l.setAll(u),o.convertToFoundDocument(o.version,l).setHasLocalMutations(),null}(t,e,n,r):t instanceof pr?function(i,o,a,c){if(!ia(i.precondition,o))return a;const l=Cp(i.fieldTransforms,c,o),u=o.data;return u.setAll(Oy(i)),u.setAll(l),o.convertToFoundDocument(o.version,u).setHasLocalMutations(),a===null?null:a.unionWith(i.fieldMask.fields).unionWith(i.fieldTransforms.map(h=>h.field))}(t,e,n,r):function(i,o,a){return ia(i.precondition,o)?(o.convertToNoDocument(o.version).setHasLocalMutations(),null):a}(t,e,n)}function wC(t,e){let n=null;for(const r of t.fieldTransforms){const s=e.data.field(r.field),i=Ry(r.transform,s||null);i!=null&&(n===null&&(n=Dt.empty()),n.set(r.field,i))}return n||null}function Sp(t,e){return t.type===e.type&&!!t.key.isEqual(e.key)&&!!t.precondition.isEqual(e.precondition)&&!!function(r,s){return r===void 0&&s===void 0||!(!r||!s)&&ks(r,s,(i,o)=>yC(i,o))}(t.fieldTransforms,e.fieldTransforms)&&(t.type===0?t.value.isEqual(e.value):t.type!==1||t.data.isEqual(e.data)&&t.fieldMask.isEqual(e.fieldMask))}class vo extends xc{constructor(e,n,r,s=[]){super(),this.key=e,this.value=n,this.precondition=r,this.fieldTransforms=s,this.type=0}getFieldMask(){return null}}class pr extends xc{constructor(e,n,r,s,i=[]){super(),this.key=e,this.data=n,this.fieldMask=r,this.precondition=s,this.fieldTransforms=i,this.type=1}getFieldMask(){return this.fieldMask}}function Oy(t){const e=new Map;return t.fieldMask.fields.forEach(n=>{if(!n.isEmpty()){const r=t.data.field(n);e.set(n,r)}}),e}function bp(t,e,n){const r=new Map;$e(t.length===n.length);for(let s=0;s<n.length;s++){const i=t[s],o=i.transform,a=e.data.field(i.field);r.set(i.field,mC(o,a,n[s]))}return r}function Cp(t,e,n){const r=new Map;for(const s of t){const i=s.transform,o=n.data.field(s.field);r.set(s.field,gC(i,o,e))}return r}class Jh extends xc{constructor(e,n){super(),this.key=e,this.precondition=n,this.type=2,this.fieldTransforms=[]}getFieldMask(){return null}}class TC extends xc{constructor(e,n){super(),this.key=e,this.precondition=n,this.type=3,this.fieldTransforms=[]}getFieldMask(){return null}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Lc{constructor(e,n,r,s,i){this.snapshotVersion=e,this.targetChanges=n,this.targetMismatches=r,this.documentUpdates=s,this.resolvedLimboDocuments=i}static createSynthesizedRemoteEventForCurrentChange(e,n,r){const s=new Map;return s.set(e,Eo.createSynthesizedTargetChangeForCurrentChange(e,n,r)),new Lc(de.min(),s,new Ke(Pe),Dn(),Te())}}class Eo{constructor(e,n,r,s,i){this.resumeToken=e,this.current=n,this.addedDocuments=r,this.modifiedDocuments=s,this.removedDocuments=i}static createSynthesizedTargetChangeForCurrentChange(e,n,r){return new Eo(r,n,Te(),Te(),Te())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class WC{constructor(e){this.ht=e}}function GC(t){const e=BC({parent:t.parent,structuredQuery:t.structuredQuery});return t.limitType==="LAST"?Va(e,e.limit,"L"):e}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class JC{constructor(){this.changes=new Ws(e=>e.toString(),(e,n)=>e.isEqual(n)),this.changesApplied=!1}addEntry(e){this.assertNotApplied(),this.changes.set(e.key,e)}removeEntry(e,n){this.assertNotApplied(),this.changes.set(e,mt.newInvalidDocument(e).setReadTime(n))}getEntry(e,n){this.assertNotApplied();const r=this.changes.get(n);return r!==void 0?D.resolve(r):this.getFromCache(e,n)}getEntries(e,n){return this.getAllFromCache(e,n)}apply(e){return this.assertNotApplied(),this.changesApplied=!0,this.applyChanges(e)}assertNotApplied(){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class eP{constructor(e){this.serializer=e,this.lr=new Map,this.hr=new Map}getBundleMetadata(e,n){return D.resolve(this.lr.get(n))}saveBundleMetadata(e,n){return this.lr.set(n.id,function(s){return{id:s.id,version:s.version,createTime:fn(s.createTime)}}(n)),D.resolve()}getNamedQuery(e,n){return D.resolve(this.hr.get(n))}saveNamedQuery(e,n){return this.hr.set(n.name,function(s){return{name:s.name,query:GC(s.bundledQuery),readTime:fn(s.readTime)}}(n)),D.resolve()}}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class nP{constructor(e,n){this.indexManager=e,this.referenceDelegate=n,this.mutationQueue=[],this.wr=1,this.Sr=new wt(it.dr)}checkEmpty(e){return D.resolve(this.mutationQueue.length===0)}addMutationBatch(e,n,r,s){const i=this.wr;this.wr++,this.mutationQueue.length>0&&this.mutationQueue[this.mutationQueue.length-1];const o=new IC(i,n,r,s);this.mutationQueue.push(o);for(const a of s)this.Sr=this.Sr.add(new it(a.key,i)),this.indexManager.addToCollectionParentIndex(e,a.key.path.popLast());return D.resolve(o)}lookupMutationBatch(e,n){return D.resolve(this.br(n))}getNextMutationBatchAfterBatchId(e,n){const r=n+1,s=this.Dr(r),i=s<0?0:s;return D.resolve(this.mutationQueue.length>i?this.mutationQueue[i]:null)}getHighestUnacknowledgedBatchId(){return D.resolve(this.mutationQueue.length===0?-1:this.wr-1)}getAllMutationBatches(e){return D.resolve(this.mutationQueue.slice())}getAllMutationBatchesAffectingDocumentKey(e,n){const r=new it(n,0),s=new it(n,Number.POSITIVE_INFINITY),i=[];return this.Sr.forEachInRange([r,s],o=>{const a=this.br(o.yr);i.push(a)}),D.resolve(i)}getAllMutationBatchesAffectingDocumentKeys(e,n){let r=new wt(Pe);return n.forEach(s=>{const i=new it(s,0),o=new it(s,Number.POSITIVE_INFINITY);this.Sr.forEachInRange([i,o],a=>{r=r.add(a.yr)})}),D.resolve(this.Cr(r))}getAllMutationBatchesAffectingQuery(e,n){const r=n.path,s=r.length+1;let i=r;re.isDocumentKey(i)||(i=i.child(""));const o=new it(new re(i),0);let a=new wt(Pe);return this.Sr.forEachWhile(c=>{const l=c.key.path;return!!r.isPrefixOf(l)&&(l.length===s&&(a=a.add(c.yr)),!0)},o),D.resolve(this.Cr(a))}Cr(e){const n=[];return e.forEach(r=>{const s=this.br(r);s!==null&&n.push(s)}),n}removeMutationBatch(e,n){$e(this.vr(n.batchId,"removed")===0),this.mutationQueue.shift();let r=this.Sr;return D.forEach(n.mutations,s=>{const i=new it(s.key,n.batchId);return r=r.delete(i),this.referenceDelegate.markPotentiallyOrphaned(e,s.key)}).next(()=>{this.Sr=r})}xn(e){}containsKey(e,n){const r=new it(n,0),s=this.Sr.firstAfterOrEqual(r);return D.resolve(n.isEqual(s&&s.key))}performConsistencyCheck(e){return this.mutationQueue.length,D.resolve()}vr(e,n){return this.Dr(e)}Dr(e){return this.mutationQueue.length===0?0:e-this.mutationQueue[0].batchId}br(e){const n=this.Dr(e);return n<0||n>=this.mutationQueue.length?null:this.mutationQueue[n]}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class oP{constructor(e,n){this.kr={},this.overlays={},this.qr=new Hh(0),this.Qr=!1,this.Qr=!0,this.referenceDelegate=e(this),this.Kr=new iP(this),this.indexManager=new QC,this.remoteDocumentCache=function(s){return new rP(s)}(r=>this.referenceDelegate.$r(r)),this.serializer=new WC(n),this.Ur=new eP(this.serializer)}start(){return Promise.resolve()}shutdown(){return this.Qr=!1,Promise.resolve()}get started(){return this.Qr}setDatabaseDeletedListener(){}setNetworkEnabled(){}getIndexManager(e){return this.indexManager}getDocumentOverlayCache(e){let n=this.overlays[e.toKey()];return n||(n=new tP,this.overlays[e.toKey()]=n),n}getMutationQueue(e,n){let r=this.kr[e.toKey()];return r||(r=new nP(n,this.referenceDelegate),this.kr[e.toKey()]=r),r}getTargetCache(){return this.Kr}getRemoteDocumentCache(){return this.remoteDocumentCache}getBundleCache(){return this.Ur}runTransaction(e,n,r){X("MemoryPersistence","Starting transaction:",e);const s=new aP(this.qr.next());return this.referenceDelegate.Wr(),r(s).next(i=>this.referenceDelegate.Gr(s).next(()=>i)).toPromise().then(i=>(s.raiseOnCommittedEvent(),i))}zr(e,n){return D.or(Object.values(this.kr).map(r=>()=>r.containsKey(e,n)))}}class aP extends Hb{constructor(e){super(),this.currentSequenceNumber=e}}class nd{constructor(e){this.persistence=e,this.jr=new td,this.Hr=null}static Jr(e){return new nd(e)}get Yr(){if(this.Hr)return this.Hr;throw ue()}addReference(e,n,r){return this.jr.addReference(r,n),this.Yr.delete(r.toString()),D.resolve()}removeReference(e,n,r){return this.jr.removeReference(r,n),this.Yr.add(r.toString()),D.resolve()}markPotentiallyOrphaned(e,n){return this.Yr.add(n.toString()),D.resolve()}removeTarget(e,n){this.jr.mr(n.targetId).forEach(s=>this.Yr.add(s.toString()));const r=this.persistence.getTargetCache();return r.getMatchingKeysForTargetId(e,n.targetId).next(s=>{s.forEach(i=>this.Yr.add(i.toString()))}).next(()=>r.removeTargetData(e,n))}Wr(){this.Hr=new Set}Gr(e){const n=this.persistence.getRemoteDocumentCache().newChangeBuffer();return D.forEach(this.Yr,r=>{const s=re.fromPath(r);return this.Zr(e,s).next(i=>{i||n.removeEntry(s,de.min())})}).next(()=>(this.Hr=null,n.apply(e)))}updateLimboDocument(e,n){return this.Zr(e,n).next(r=>{r?this.Yr.delete(n.toString()):this.Yr.add(n.toString())})}$r(e){return 0}Zr(e,n){return D.or([()=>D.resolve(this.jr.containsKey(n)),()=>this.persistence.getTargetCache().containsKey(e,n),()=>this.persistence.zr(e,n)])}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class rd{constructor(e,n,r,s){this.targetId=e,this.fromCache=n,this.Qi=r,this.Ki=s}static $i(e,n){let r=Te(),s=Te();for(const i of n.docChanges)switch(i.type){case 0:r=r.add(i.doc.key);break;case 1:s=s.add(i.doc.key)}return new rd(e,n.fromCache,r,s)}}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class lP{constructor(){this.Ui=!1,this.Wi=!1,this.Gi=100,this.zi=8}initialize(e,n){this.ji=e,this.indexManager=n,this.Ui=!0}getDocumentsMatchingQuery(e,n,r,s){const i={result:null};return this.Hi(e,n).next(o=>{i.result=o}).next(()=>{if(!i.result)return this.Ji(e,n,s,r).next(o=>{i.result=o})}).next(()=>{if(i.result)return;const o=new cP;return this.Yi(e,n,o).next(a=>{if(i.result=a,this.Wi)return this.Zi(e,n,o,a.size)})}).next(()=>i.result)}Zi(e,n,r,s){return r.documentReadCount<this.Gi?(si()<=Ae.DEBUG&&X("QueryEngine","SDK will not create cache indexes for query:",is(n),"since it only creates cache indexes for collection contains","more than or equal to",this.Gi,"documents"),D.resolve()):(si()<=Ae.DEBUG&&X("QueryEngine","Query:",is(n),"scans",r.documentReadCount,"local documents and returns",s,"documents as results."),r.documentReadCount>this.zi*s?(si()<=Ae.DEBUG&&X("QueryEngine","The SDK decides to create cache indexes for query:",is(n),"as using cache indexes may help improve performance."),this.indexManager.createTargetIndexes(e,dn(n))):D.resolve())}Hi(e,n){if(Ap(n))return D.resolve(null);let r=dn(n);return this.indexManager.getIndexType(e,r).next(s=>s===0?null:(n.limit!==null&&s===1&&(n=Va(n,null,"F"),r=dn(n)),this.indexManager.getDocumentsMatchingTarget(e,r).next(i=>{const o=Te(...i);return this.ji.getDocuments(e,o).next(a=>this.indexManager.getMinOffset(e,r).next(c=>{const l=this.Xi(n,a);return this.es(n,l,o,c.readTime)?this.Hi(e,Va(n,null,"F")):this.ts(e,l,n,c)}))})))}Ji(e,n,r,s){return Ap(n)||s.isEqual(de.min())?D.resolve(null):this.ji.getDocuments(e,r).next(i=>{const o=this.Xi(n,i);return this.es(n,o,r,s)?D.resolve(null):(si()<=Ae.DEBUG&&X("QueryEngine","Re-using previous result from %s to execute query: %s",s.toString(),is(n)),this.ts(e,o,n,$b(s,-1)).next(a=>a))})}Xi(e,n){let r=new wt(vy(e));return n.forEach((s,i)=>{Vc(e,i)&&(r=r.add(i))}),r}es(e,n,r,s){if(e.limit===null)return!1;if(r.size!==n.size)return!0;const i=e.limitType==="F"?n.last():n.first();return!!i&&(i.hasPendingWrites||i.version.compareTo(s)>0)}Yi(e,n,r){return si()<=Ae.DEBUG&&X("QueryEngine","Using full collection scan to execute query:",is(n)),this.ji.getDocumentsMatchingQuery(e,n,cr.min(),r)}ts(e,n,r,s){return this.ji.getDocumentsMatchingQuery(e,r,s).next(i=>(n.forEach(o=>{i=i.insert(o.key,o)}),i))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const pt="WebChannelConnection";class TP extends class{constructor(n){this.databaseInfo=n,this.databaseId=n.databaseId;const r=n.ssl?"https":"http",s=encodeURIComponent(this.databaseId.projectId),i=encodeURIComponent(this.databaseId.database);this.po=r+"://"+n.host,this.yo=`projects/${s}/databases/${i}`,this.wo=this.databaseId.database==="(default)"?`project_id=${s}`:`project_id=${s}&database_id=${i}`}get So(){return!1}bo(n,r,s,i,o){const a=Vl(),c=this.Do(n,r);X("RestConnection",`Sending RPC '${n}' ${a}:`,c,s);const l={"google-cloud-resource-prefix":this.yo,"x-goog-request-params":this.wo};return this.Co(l,i,o),this.vo(n,c,l,s).then(u=>(X("RestConnection",`Received RPC '${n}' ${a}: `,u),u),u=>{throw Os("RestConnection",`RPC '${n}' ${a} failed with error: `,u,"url: ",c,"request:",s),u})}Fo(n,r,s,i,o,a){return this.bo(n,r,s,i,o)}Co(n,r,s){n["X-Goog-Api-Client"]=function(){return"gl-js/ fire/"+Ks}(),n["Content-Type"]="text/plain",this.databaseInfo.appId&&(n["X-Firebase-GMPID"]=this.databaseInfo.appId),r&&r.headers.forEach((i,o)=>n[o]=i),s&&s.headers.forEach((i,o)=>n[o]=i)}Do(n,r){const s=EP[n];return`${this.po}/v1/${r}:${s}`}}{constructor(e){super(e),this.forceLongPolling=e.forceLongPolling,this.autoDetectLongPolling=e.autoDetectLongPolling,this.useFetchStreams=e.useFetchStreams,this.longPollingOptions=e.longPollingOptions}vo(e,n,r,s){const i=Vl();return new Promise((o,a)=>{const c=new Pb;c.setWithCredentials(!0),c.listenOnce(bb.COMPLETE,()=>{try{switch(c.getLastErrorCode()){case Dl.NO_ERROR:const u=c.getResponseJson();X(pt,`XHR for RPC '${e}' ${i} received:`,JSON.stringify(u)),o(u);break;case Dl.TIMEOUT:X(pt,`RPC '${e}' ${i} timed out`),a(new W(R.DEADLINE_EXCEEDED,"Request time out"));break;case Dl.HTTP_ERROR:const h=c.getStatus();if(X(pt,`RPC '${e}' ${i} failed with status:`,h,"response text:",c.getResponseText()),h>0){let d=c.getResponseJson();Array.isArray(d)&&(d=d[0]);const p=d==null?void 0:d.error;if(p&&p.status&&p.message){const y=function(I){const C=I.toLowerCase().replace(/_/g,"-");return Object.values(R).indexOf(C)>=0?C:R.UNKNOWN}(p.status);a(new W(y,p.message))}else a(new W(R.UNKNOWN,"Server responded with status "+c.getStatus()))}else a(new W(R.UNAVAILABLE,"Connection failed."));break;default:ue()}}finally{X(pt,`RPC '${e}' ${i} completed.`)}});const l=JSON.stringify(s);X(pt,`RPC '${e}' ${i} sending request:`,s),c.send(n,"POST",l,r,15)})}Mo(e,n,r){const s=Vl(),i=[this.po,"/","google.firestore.v1.Firestore","/",e,"/channel"],o=Rb(),a=Sb(),c={httpSessionIdParam:"gsessionid",initMessageHeaders:{},messageUrlParams:{database:`projects/${this.databaseId.projectId}/databases/${this.databaseId.database}`},sendRawJson:!0,supportsCrossDomainXhr:!0,internalChannelParams:{forwardChannelRequestTimeoutMs:6e5},forceLongPolling:this.forceLongPolling,detectBufferingProxy:this.autoDetectLongPolling},l=this.longPollingOptions.timeoutSeconds;l!==void 0&&(c.longPollingTimeout=Math.round(1e3*l)),this.useFetchStreams&&(c.useFetchStreams=!0),this.Co(c.initMessageHeaders,n,r),c.encodeInitMessageHeaders=!0;const u=i.join("");X(pt,`Creating RPC '${e}' stream ${s}: ${u}`,c);const h=o.createWebChannel(u,c);let d=!1,p=!1;const y=new wP({ho:I=>{p?X(pt,`Not sending because RPC '${e}' stream ${s} is closed:`,I):(d||(X(pt,`Opening RPC '${e}' stream ${s} transport.`),h.open(),d=!0),X(pt,`RPC '${e}' stream ${s} sending:`,I),h.send(I))},Po:()=>h.close()}),E=(I,C,V)=>{I.listen(C,q=>{try{V(q)}catch(N){setTimeout(()=>{throw N},0)}})};return E(h,Ko.EventType.OPEN,()=>{p||X(pt,`RPC '${e}' stream ${s} transport opened.`)}),E(h,Ko.EventType.CLOSE,()=>{p||(p=!0,X(pt,`RPC '${e}' stream ${s} transport closed`),y.mo())}),E(h,Ko.EventType.ERROR,I=>{p||(p=!0,Os(pt,`RPC '${e}' stream ${s} transport errored:`,I),y.mo(new W(R.UNAVAILABLE,"The operation could not be completed")))}),E(h,Ko.EventType.MESSAGE,I=>{var C;if(!p){const V=I.data[0];$e(!!V);const q=V,N=q.error||((C=q[0])===null||C===void 0?void 0:C.error);if(N){X(pt,`RPC '${e}' stream ${s} received error:`,N);const ee=N.status;let ie=function(G){const Y=Ye[G];if(Y!==void 0)return ky(Y)}(ee),we=N.message;ie===void 0&&(ie=R.INTERNAL,we="Unknown error status: "+ee+" with message "+N.message),p=!0,y.mo(new W(ie,we)),h.close()}else X(pt,`RPC '${e}' stream ${s} received:`,V),y.fo(V)}}),E(a,Cb.STAT_EVENT,I=>{I.stat===fp.PROXY?X(pt,`RPC '${e}' stream ${s} detected buffering proxy`):I.stat===fp.NOPROXY&&X(pt,`RPC '${e}' stream ${s} detected no buffering proxy`)}),setTimeout(()=>{y.Vo()},0),y}}function Ml(){return typeof document<"u"?document:null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class bP{constructor(e,n,r,s,i){this.localStore=e,this.datastore=n,this.asyncQueue=r,this.remoteSyncer={},this.C_=[],this.v_=new Map,this.F_=new Set,this.M_=[],this.x_=i,this.x_.so(o=>{r.enqueueAndForget(async()=>{Kr(this)&&(X("RemoteStore","Restarting streams for network reachability change."),await async function(c){const l=me(c);l.F_.add(4),await wo(l),l.O_.set("Unknown"),l.F_.delete(4),await Uc(l)}(this))})}),this.O_=new SP(r,s)}}async function Uc(t){if(Kr(t))for(const e of t.M_)await e(!0)}async function wo(t){for(const e of t.M_)await e(!1)}function Hy(t,e){const n=me(t);n.v_.has(e.targetId)||(n.v_.set(e.targetId,e),od(n)?id(n):Gs(n).Yo()&&sd(n,e))}function Ky(t,e){const n=me(t),r=Gs(n);n.v_.delete(e),r.Yo()&&zy(n,e),n.v_.size===0&&(r.Yo()?r.e_():Kr(n)&&n.O_.set("Unknown"))}function sd(t,e){if(t.N_.Le(e.targetId),e.resumeToken.approximateByteSize()>0||e.snapshotVersion.compareTo(de.min())>0){const n=t.remoteSyncer.getRemoteKeysForTarget(e.targetId).size;e=e.withExpectedCount(n)}Gs(t).l_(e)}function zy(t,e){t.N_.Le(e),Gs(t).h_(e)}function id(t){t.N_=new PC({getRemoteKeysForTarget:e=>t.remoteSyncer.getRemoteKeysForTarget(e),lt:e=>t.v_.get(e)||null,st:()=>t.datastore.serializer.databaseId}),Gs(t).start(),t.O_.y_()}function od(t){return Kr(t)&&!Gs(t).Jo()&&t.v_.size>0}function Kr(t){return me(t).F_.size===0}function Wy(t){t.N_=void 0}async function CP(t){t.v_.forEach((e,n)=>{sd(t,e)})}async function PP(t,e){Wy(t),od(t)?(t.O_.b_(e),id(t)):t.O_.set("Unknown")}async function OP(t,e,n){if(t.O_.set("Online"),e instanceof Ny&&e.state===2&&e.cause)try{await async function(s,i){const o=i.cause;for(const a of i.targetIds)s.v_.has(a)&&(await s.remoteSyncer.rejectListen(a,o),s.v_.delete(a),s.N_.removeTarget(a))}(t,e)}catch(r){X("RemoteStore","Failed to remove targets %s: %s ",e.targetIds.join(","),r),await Fa(t,r)}else if(e instanceof oa?t.N_.Ge(e):e instanceof Dy?t.N_.Xe(e):t.N_.He(e),!n.isEqual(de.min()))try{const r=await By(t.localStore);n.compareTo(r)>=0&&await function(i,o){const a=i.N_._t(o);return a.targetChanges.forEach((c,l)=>{if(c.resumeToken.approximateByteSize()>0){const u=i.v_.get(l);u&&i.v_.set(l,u.withResumeToken(c.resumeToken,o))}}),a.targetMismatches.forEach((c,l)=>{const u=i.v_.get(c);if(!u)return;i.v_.set(c,u.withResumeToken(At.EMPTY_BYTE_STRING,u.snapshotVersion)),zy(i,c);const h=new Xn(u.target,c,l,u.sequenceNumber);sd(i,h)}),i.remoteSyncer.applyRemoteEvent(a)}(t,n)}catch(r){X("RemoteStore","Failed to raise snapshot:",r),await Fa(t,r)}}async function Fa(t,e,n){if(!yo(e))throw e;t.F_.add(1),await wo(t),t.O_.set("Offline"),n||(n=()=>By(t.localStore)),t.asyncQueue.enqueueRetryable(async()=>{X("RemoteStore","Retrying IndexedDB access"),await n(),t.F_.delete(1),await Uc(t)})}function Gy(t,e){return e().catch(n=>Fa(t,n,e))}async function $c(t){const e=me(t),n=ur(e);let r=e.C_.length>0?e.C_[e.C_.length-1].batchId:-1;for(;kP(e);)try{const s=await gP(e.localStore,r);if(s===null){e.C_.length===0&&n.e_();break}r=s.batchId,DP(e,s)}catch(s){await Fa(e,s)}Qy(e)&&Yy(e)}function kP(t){return Kr(t)&&t.C_.length<10}function DP(t,e){t.C_.push(e);const n=ur(t);n.Yo()&&n.I_&&n.d_(e.mutations)}function Qy(t){return Kr(t)&&!ur(t).Jo()&&t.C_.length>0}function Yy(t){ur(t).start()}async function NP(t){ur(t).A_()}async function VP(t){const e=ur(t);for(const n of t.C_)e.d_(n.mutations)}async function MP(t,e,n){const r=t.C_.shift(),s=Xh.from(r,e,n);await Gy(t,()=>t.remoteSyncer.applySuccessfulWrite(s)),await $c(t)}async function xP(t,e){e&&ur(t).I_&&await async function(r,s){if(function(o){return SC(o)&&o!==R.ABORTED}(s.code)){const i=r.C_.shift();ur(r).Xo(),await Gy(r,()=>r.remoteSyncer.rejectFailedWrite(i.batchId,s)),await $c(r)}}(t,e),Qy(t)&&Yy(t)}async function Fp(t,e){const n=me(t);n.asyncQueue.verifyOperationInProgress(),X("RemoteStore","RemoteStore received new credentials");const r=Kr(n);n.F_.add(3),await wo(n),r&&n.O_.set("Unknown"),await n.remoteSyncer.handleCredentialChange(e),n.F_.delete(3),await Uc(n)}async function LP(t,e){const n=me(t);e?(n.F_.delete(2),await Uc(n)):e||(n.F_.add(2),await wo(n),n.O_.set("Unknown"))}function Gs(t){return t.B_||(t.B_=function(n,r,s){const i=me(n);return i.V_(),new IP(r,i.connection,i.authCredentials,i.appCheckCredentials,i.serializer,s)}(t.datastore,t.asyncQueue,{Io:CP.bind(null,t),Eo:PP.bind(null,t),c_:OP.bind(null,t)}),t.M_.push(async e=>{e?(t.B_.Xo(),od(t)?id(t):t.O_.set("Unknown")):(await t.B_.stop(),Wy(t))})),t.B_}function ur(t){return t.L_||(t.L_=function(n,r,s){const i=me(n);return i.V_(),new AP(r,i.connection,i.authCredentials,i.appCheckCredentials,i.serializer,s)}(t.datastore,t.asyncQueue,{Io:NP.bind(null,t),Eo:xP.bind(null,t),E_:VP.bind(null,t),T_:MP.bind(null,t)}),t.M_.push(async e=>{e?(t.L_.Xo(),await $c(t)):(await t.L_.stop(),t.C_.length>0&&(X("RemoteStore",`Stopping write stream with ${t.C_.length} pending writes`),t.C_=[]))})),t.L_}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class FP{constructor(){this.Q_=void 0,this.listeners=[]}}class UP{constructor(){this.queries=new Ws(e=>yy(e),Nc),this.onlineState="Unknown",this.K_=new Set}}async function ld(t,e){const n=me(t),r=e.query;let s=!1,i=n.queries.get(r);if(i||(s=!0,i=new FP),s)try{i.Q_=await n.onListen(r)}catch(o){const a=cd(o,`Initialization of query '${is(e.query)}' failed`);return void e.onError(a)}n.queries.set(r,i),i.listeners.push(e),e.U_(n.onlineState),i.Q_&&e.W_(i.Q_)&&hd(n)}async function ud(t,e){const n=me(t),r=e.query;let s=!1;const i=n.queries.get(r);if(i){const o=i.listeners.indexOf(e);o>=0&&(i.listeners.splice(o,1),s=i.listeners.length===0)}if(s)return n.queries.delete(r),n.onUnlisten(r)}function $P(t,e){const n=me(t);let r=!1;for(const s of e){const i=s.query,o=n.queries.get(i);if(o){for(const a of o.listeners)a.W_(s)&&(r=!0);o.Q_=s}}r&&hd(n)}function BP(t,e,n){const r=me(t),s=r.queries.get(e);if(s)for(const i of s.listeners)i.onError(n);r.queries.delete(e)}function hd(t){t.K_.forEach(e=>{e.next()})}class dd{constructor(e,n,r){this.query=e,this.G_=n,this.z_=!1,this.j_=null,this.onlineState="Unknown",this.options=r||{}}W_(e){if(!this.options.includeMetadataChanges){const r=[];for(const s of e.docChanges)s.type!==3&&r.push(s);e=new xs(e.query,e.docs,e.oldDocs,r,e.mutatedKeys,e.fromCache,e.syncStateChanged,!0,e.hasCachedResults)}let n=!1;return this.z_?this.H_(e)&&(this.G_.next(e),n=!0):this.J_(e,this.onlineState)&&(this.Y_(e),n=!0),this.j_=e,n}onError(e){this.G_.error(e)}U_(e){this.onlineState=e;let n=!1;return this.j_&&!this.z_&&this.J_(this.j_,e)&&(this.Y_(this.j_),n=!0),n}J_(e,n){if(!e.fromCache)return!0;const r=n!=="Offline";return(!this.options.Z_||!r)&&(!e.docs.isEmpty()||e.hasCachedResults||n==="Offline")}H_(e){if(e.docChanges.length>0)return!0;const n=this.j_&&this.j_.hasPendingWrites!==e.hasPendingWrites;return!(!e.syncStateChanged&&!n)&&this.options.includeMetadataChanges===!0}Y_(e){e=xs.fromInitialDocuments(e.query,e.docs,e.mutatedKeys,e.fromCache,e.hasCachedResults),this.z_=!0,this.G_.next(e)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Jy{constructor(e){this.key=e}}class Xy{constructor(e){this.key=e}}class jP{constructor(e,n){this.query=e,this.oa=n,this._a=null,this.hasCachedResults=!1,this.current=!1,this.aa=Te(),this.mutatedKeys=Te(),this.ua=vy(e),this.ca=new vs(this.ua)}get la(){return this.oa}ha(e,n){const r=n?n.Pa:new Up,s=n?n.ca:this.ca;let i=n?n.mutatedKeys:this.mutatedKeys,o=s,a=!1;const c=this.query.limitType==="F"&&s.size===this.query.limit?s.last():null,l=this.query.limitType==="L"&&s.size===this.query.limit?s.first():null;if(e.inorderTraversal((u,h)=>{const d=s.get(u),p=Vc(this.query,h)?h:null,y=!!d&&this.mutatedKeys.has(d.key),E=!!p&&(p.hasLocalMutations||this.mutatedKeys.has(p.key)&&p.hasCommittedMutations);let I=!1;d&&p?d.data.isEqual(p.data)?y!==E&&(r.track({type:3,doc:p}),I=!0):this.Ia(d,p)||(r.track({type:2,doc:p}),I=!0,(c&&this.ua(p,c)>0||l&&this.ua(p,l)<0)&&(a=!0)):!d&&p?(r.track({type:0,doc:p}),I=!0):d&&!p&&(r.track({type:1,doc:d}),I=!0,(c||l)&&(a=!0)),I&&(p?(o=o.add(p),i=E?i.add(u):i.delete(u)):(o=o.delete(u),i=i.delete(u)))}),this.query.limit!==null)for(;o.size>this.query.limit;){const u=this.query.limitType==="F"?o.last():o.first();o=o.delete(u.key),i=i.delete(u.key),r.track({type:1,doc:u})}return{ca:o,Pa:r,es:a,mutatedKeys:i}}Ia(e,n){return e.hasLocalMutations&&n.hasCommittedMutations&&!n.hasLocalMutations}applyChanges(e,n,r){const s=this.ca;this.ca=e.ca,this.mutatedKeys=e.mutatedKeys;const i=e.Pa.q_();i.sort((l,u)=>function(d,p){const y=E=>{switch(E){case 0:return 1;case 2:case 3:return 2;case 1:return 0;default:return ue()}};return y(d)-y(p)}(l.type,u.type)||this.ua(l.doc,u.doc)),this.da(r);const o=n?this.Ta():[],a=this.aa.size===0&&this.current?1:0,c=a!==this._a;return this._a=a,i.length!==0||c?{snapshot:new xs(this.query,e.ca,s,i,e.mutatedKeys,a===0,c,!1,!!r&&r.resumeToken.approximateByteSize()>0),Ea:o}:{Ea:o}}U_(e){return this.current&&e==="Offline"?(this.current=!1,this.applyChanges({ca:this.ca,Pa:new Up,mutatedKeys:this.mutatedKeys,es:!1},!1)):{Ea:[]}}Aa(e){return!this.oa.has(e)&&!!this.ca.has(e)&&!this.ca.get(e).hasLocalMutations}da(e){e&&(e.addedDocuments.forEach(n=>this.oa=this.oa.add(n)),e.modifiedDocuments.forEach(n=>{}),e.removedDocuments.forEach(n=>this.oa=this.oa.delete(n)),this.current=e.current)}Ta(){if(!this.current)return[];const e=this.aa;this.aa=Te(),this.ca.forEach(r=>{this.Aa(r.key)&&(this.aa=this.aa.add(r.key))});const n=[];return e.forEach(r=>{this.aa.has(r)||n.push(new Xy(r))}),this.aa.forEach(r=>{e.has(r)||n.push(new Jy(r))}),n}Ra(e){this.oa=e.Ps,this.aa=Te();const n=this.ha(e.documents);return this.applyChanges(n,!0)}Va(){return xs.fromInitialDocuments(this.query,this.ca,this.mutatedKeys,this._a===0,this.hasCachedResults)}}class qP{constructor(e,n,r){this.query=e,this.targetId=n,this.view=r}}class HP{constructor(e){this.key=e,this.ma=!1}}class KP{constructor(e,n,r,s,i,o){this.localStore=e,this.remoteStore=n,this.eventManager=r,this.sharedClientState=s,this.currentUser=i,this.maxConcurrentLimboResolutions=o,this.fa={},this.ga=new Ws(a=>yy(a),Nc),this.pa=new Map,this.ya=new Set,this.wa=new Ke(re.comparator),this.Sa=new Map,this.ba=new td,this.Da={},this.Ca=new Map,this.va=Ms.Ln(),this.onlineState="Unknown",this.Fa=void 0}get isPrimaryClient(){return this.Fa===!0}}async function zP(t,e){const n=n1(t);let r,s;const i=n.ga.get(e);if(i)r=i.targetId,n.sharedClientState.addLocalQueryTarget(r),s=i.view.Va();else{const o=await mP(n.localStore,dn(e)),a=n.sharedClientState.addLocalQueryTarget(o.targetId);r=o.targetId,s=await WP(n,e,r,a==="current",o.resumeToken),n.isPrimaryClient&&Hy(n.remoteStore,o)}return s}async function WP(t,e,n,r,s){t.Ma=(h,d,p)=>async function(E,I,C,V){let q=I.view.ha(C);q.es&&(q=await Mp(E.localStore,I.query,!1).then(({documents:ie})=>I.view.ha(ie,q)));const N=V&&V.targetChanges.get(I.targetId),ee=I.view.applyChanges(q,E.isPrimaryClient,N);return Bp(E,I.targetId,ee.Ea),ee.snapshot}(t,h,d,p);const i=await Mp(t.localStore,e,!0),o=new jP(e,i.Ps),a=o.ha(i.documents),c=Eo.createSynthesizedTargetChangeForCurrentChange(n,r&&t.onlineState!=="Offline",s),l=o.applyChanges(a,t.isPrimaryClient,c);Bp(t,n,l.Ea);const u=new qP(e,n,o);return t.ga.set(e,u),t.pa.has(n)?t.pa.get(n).push(e):t.pa.set(n,[e]),l.snapshot}async function GP(t,e){const n=me(t),r=n.ga.get(e),s=n.pa.get(r.targetId);if(s.length>1)return n.pa.set(r.targetId,s.filter(i=>!Nc(i,e))),void n.ga.delete(e);n.isPrimaryClient?(n.sharedClientState.removeLocalQueryTarget(r.targetId),n.sharedClientState.isActiveQueryTarget(r.targetId)||await Lu(n.localStore,r.targetId,!1).then(()=>{n.sharedClientState.clearQueryState(r.targetId),Ky(n.remoteStore,r.targetId),Fu(n,r.targetId)}).catch(_o)):(Fu(n,r.targetId),await Lu(n.localStore,r.targetId,!0))}async function QP(t,e,n){const r=r1(t);try{const s=await function(o,a){const c=me(o),l=Ze.now(),u=a.reduce((p,y)=>p.add(y.key),Te());let h,d;return c.persistence.runTransaction("Locally write mutations","readwrite",p=>{let y=Dn(),E=Te();return c._s.getEntries(p,u).next(I=>{y=I,y.forEach((C,V)=>{V.isValidDocument()||(E=E.add(C))})}).next(()=>c.localDocuments.getOverlayedDocuments(p,y)).next(I=>{h=I;const C=[];for(const V of a){const q=wC(V,h.get(V.key).overlayedDocument);q!=null&&C.push(new pr(V.key,q,uy(q.value.mapValue),zt.exists(!0)))}return c.mutationQueue.addMutationBatch(p,l,C,a)}).next(I=>{d=I;const C=I.applyToLocalDocumentSet(h,E);return c.documentOverlayCache.saveOverlays(p,I.batchId,C)})}).then(()=>({batchId:d.batchId,changes:wy(h)}))}(r.localStore,e);r.sharedClientState.addPendingMutation(s.batchId),function(o,a,c){let l=o.Da[o.currentUser.toKey()];l||(l=new Ke(Pe)),l=l.insert(a,c),o.Da[o.currentUser.toKey()]=l}(r,s.batchId,n),await To(r,s.changes),await $c(r.remoteStore)}catch(s){const i=cd(s,"Failed to persist write");n.reject(i)}}async function Zy(t,e){const n=me(t);try{const r=await fP(n.localStore,e);e.targetChanges.forEach((s,i)=>{const o=n.Sa.get(i);o&&($e(s.addedDocuments.size+s.modifiedDocuments.size+s.removedDocuments.size<=1),s.addedDocuments.size>0?o.ma=!0:s.modifiedDocuments.size>0?$e(o.ma):s.removedDocuments.size>0&&($e(o.ma),o.ma=!1))}),await To(n,r,e)}catch(r){await _o(r)}}function $p(t,e,n){const r=me(t);if(r.isPrimaryClient&&n===0||!r.isPrimaryClient&&n===1){const s=[];r.ga.forEach((i,o)=>{const a=o.view.U_(e);a.snapshot&&s.push(a.snapshot)}),function(o,a){const c=me(o);c.onlineState=a;let l=!1;c.queries.forEach((u,h)=>{for(const d of h.listeners)d.U_(a)&&(l=!0)}),l&&hd(c)}(r.eventManager,e),s.length&&r.fa.c_(s),r.onlineState=e,r.isPrimaryClient&&r.sharedClientState.setOnlineState(e)}}async function YP(t,e,n){const r=me(t);r.sharedClientState.updateQueryState(e,"rejected",n);const s=r.Sa.get(e),i=s&&s.key;if(i){let o=new Ke(re.comparator);o=o.insert(i,mt.newNoDocument(i,de.min()));const a=Te().add(i),c=new Lc(de.min(),new Map,new Ke(Pe),o,a);await Zy(r,c),r.wa=r.wa.remove(i),r.Sa.delete(e),fd(r)}else await Lu(r.localStore,e,!1).then(()=>Fu(r,e,n)).catch(_o)}async function JP(t,e){const n=me(t),r=e.batch.batchId;try{const s=await dP(n.localStore,e);tv(n,r,null),ev(n,r),n.sharedClientState.updateMutationState(r,"acknowledged"),await To(n,s)}catch(s){await _o(s)}}async function XP(t,e,n){const r=me(t);try{const s=await function(o,a){const c=me(o);return c.persistence.runTransaction("Reject batch","readwrite-primary",l=>{let u;return c.mutationQueue.lookupMutationBatch(l,a).next(h=>($e(h!==null),u=h.keys(),c.mutationQueue.removeMutationBatch(l,h))).next(()=>c.mutationQueue.performConsistencyCheck(l)).next(()=>c.documentOverlayCache.removeOverlaysForBatchId(l,u,a)).next(()=>c.localDocuments.recalculateAndSaveOverlaysForDocumentKeys(l,u)).next(()=>c.localDocuments.getDocuments(l,u))})}(r.localStore,e);tv(r,e,n),ev(r,e),r.sharedClientState.updateMutationState(e,"rejected",n),await To(r,s)}catch(s){await _o(s)}}function ev(t,e){(t.Ca.get(e)||[]).forEach(n=>{n.resolve()}),t.Ca.delete(e)}function tv(t,e,n){const r=me(t);let s=r.Da[r.currentUser.toKey()];if(s){const i=s.get(e);i&&(n?i.reject(n):i.resolve(),s=s.remove(e)),r.Da[r.currentUser.toKey()]=s}}function Fu(t,e,n=null){t.sharedClientState.removeLocalQueryTarget(e);for(const r of t.pa.get(e))t.ga.delete(r),n&&t.fa.xa(r,n);t.pa.delete(e),t.isPrimaryClient&&t.ba.mr(e).forEach(r=>{t.ba.containsKey(r)||nv(t,r)})}function nv(t,e){t.ya.delete(e.path.canonicalString());const n=t.wa.get(e);n!==null&&(Ky(t.remoteStore,n),t.wa=t.wa.remove(e),t.Sa.delete(n),fd(t))}function Bp(t,e,n){for(const r of n)r instanceof Jy?(t.ba.addReference(r.key,e),ZP(t,r)):r instanceof Xy?(X("SyncEngine","Document no longer in limbo: "+r.key),t.ba.removeReference(r.key,e),t.ba.containsKey(r.key)||nv(t,r.key)):ue()}function ZP(t,e){const n=e.key,r=n.path.canonicalString();t.wa.get(n)||t.ya.has(r)||(X("SyncEngine","New document in limbo: "+n),t.ya.add(r),fd(t))}function fd(t){for(;t.ya.size>0&&t.wa.size<t.maxConcurrentLimboResolutions;){const e=t.ya.values().next().value;t.ya.delete(e);const n=new re(Fe.fromString(e)),r=t.va.next();t.Sa.set(r,new HP(n)),t.wa=t.wa.insert(n,r),Hy(t.remoteStore,new Xn(dn(kc(n.path)),r,"TargetPurposeLimboResolution",Hh.ae))}}async function To(t,e,n){const r=me(t),s=[],i=[],o=[];r.ga.isEmpty()||(r.ga.forEach((a,c)=>{o.push(r.Ma(c,e,n).then(l=>{if((l||n)&&r.isPrimaryClient&&r.sharedClientState.updateQueryState(c.targetId,l!=null&&l.fromCache?"not-current":"current"),l){s.push(l);const u=rd.$i(c.targetId,l);i.push(u)}}))}),await Promise.all(o),r.fa.c_(s),await async function(c,l){const u=me(c);try{await u.persistence.runTransaction("notifyLocalViewChanges","readwrite",h=>D.forEach(l,d=>D.forEach(d.Qi,p=>u.persistence.referenceDelegate.addReference(h,d.targetId,p)).next(()=>D.forEach(d.Ki,p=>u.persistence.referenceDelegate.removeReference(h,d.targetId,p)))))}catch(h){if(!yo(h))throw h;X("LocalStore","Failed to update sequence numbers: "+h)}for(const h of l){const d=h.targetId;if(!h.fromCache){const p=u.rs.get(d),y=p.snapshotVersion,E=p.withLastLimboFreeSnapshotVersion(y);u.rs=u.rs.insert(d,E)}}}(r.localStore,i))}async function e1(t,e){const n=me(t);if(!n.currentUser.isEqual(e)){X("SyncEngine","User change. New user:",e.toKey());const r=await $y(n.localStore,e);n.currentUser=e,function(i,o){i.Ca.forEach(a=>{a.forEach(c=>{c.reject(new W(R.CANCELLED,o))})}),i.Ca.clear()}(n,"'waitForPendingWrites' promise is rejected due to a user change."),n.sharedClientState.handleUserChange(e,r.removedBatchIds,r.addedBatchIds),await To(n,r.cs)}}function t1(t,e){const n=me(t),r=n.Sa.get(e);if(r&&r.ma)return Te().add(r.key);{let s=Te();const i=n.pa.get(e);if(!i)return s;for(const o of i){const a=n.ga.get(o);s=s.unionWith(a.view.la)}return s}}function n1(t){const e=me(t);return e.remoteStore.remoteSyncer.applyRemoteEvent=Zy.bind(null,e),e.remoteStore.remoteSyncer.getRemoteKeysForTarget=t1.bind(null,e),e.remoteStore.remoteSyncer.rejectListen=YP.bind(null,e),e.fa.c_=$P.bind(null,e.eventManager),e.fa.xa=BP.bind(null,e.eventManager),e}function r1(t){const e=me(t);return e.remoteStore.remoteSyncer.applySuccessfulWrite=JP.bind(null,e),e.remoteStore.remoteSyncer.rejectFailedWrite=XP.bind(null,e),e}class jp{constructor(){this.synchronizeTabs=!1}async initialize(e){this.serializer=Fc(e.databaseInfo.databaseId),this.sharedClientState=this.createSharedClientState(e),this.persistence=this.createPersistence(e),await this.persistence.start(),this.localStore=this.createLocalStore(e),this.gcScheduler=this.createGarbageCollectionScheduler(e,this.localStore),this.indexBackfillerScheduler=this.createIndexBackfillerScheduler(e,this.localStore)}createGarbageCollectionScheduler(e,n){return null}createIndexBackfillerScheduler(e,n){return null}createLocalStore(e){return hP(this.persistence,new lP,e.initialUser,this.serializer)}createPersistence(e){return new oP(nd.Jr,this.serializer)}createSharedClientState(e){return new yP}async terminate(){this.gcScheduler&&this.gcScheduler.stop(),await this.sharedClientState.shutdown(),await this.persistence.shutdown()}}class s1{async initialize(e,n){this.localStore||(this.localStore=e.localStore,this.sharedClientState=e.sharedClientState,this.datastore=this.createDatastore(n),this.remoteStore=this.createRemoteStore(n),this.eventManager=this.createEventManager(n),this.syncEngine=this.createSyncEngine(n,!e.synchronizeTabs),this.sharedClientState.onlineStateHandler=r=>$p(this.syncEngine,r,1),this.remoteStore.remoteSyncer.handleCredentialChange=e1.bind(null,this.syncEngine),await LP(this.remoteStore,this.syncEngine.isPrimaryClient))}createEventManager(e){return function(){return new UP}()}createDatastore(e){const n=Fc(e.databaseInfo.databaseId),r=function(i){return new TP(i)}(e.databaseInfo);return function(i,o,a,c){return new RP(i,o,a,c)}(e.authCredentials,e.appCheckCredentials,r,n)}createRemoteStore(e){return function(r,s,i,o,a){return new bP(r,s,i,o,a)}(this.localStore,this.datastore,e.asyncQueue,n=>$p(this.syncEngine,n,0),function(){return Lp.C()?new Lp:new vP}())}createSyncEngine(e,n){return function(s,i,o,a,c,l,u){const h=new KP(s,i,o,a,c,l);return u&&(h.Fa=!0),h}(this.localStore,this.remoteStore,this.eventManager,this.sharedClientState,e.initialUser,e.maxConcurrentLimboResolutions,n)}terminate(){return async function(n){const r=me(n);X("RemoteStore","RemoteStore shutting down."),r.F_.add(5),await wo(r),r.x_.shutdown(),r.O_.set("Unknown")}(this.remoteStore)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Fn{constructor(e,n,r){this.converter=n,this._query=r,this.type="query",this.firestore=e}withConverter(e){return new Fn(this.firestore,e,this._query)}}class Tt{constructor(e,n,r){this.converter=n,this._key=r,this.type="document",this.firestore=e}get _path(){return this._key.path}get id(){return this._key.path.lastSegment()}get path(){return this._key.path.canonicalString()}get parent(){return new or(this.firestore,this.converter,this._key.path.popLast())}withConverter(e){return new Tt(this.firestore,e,this._key)}}class or extends Fn{constructor(e,n,r){super(e,n,kc(r)),this._path=r,this.type="collection"}get id(){return this._query.path.lastSegment()}get path(){return this._query.path.canonicalString()}get parent(){const e=this._path.popLast();return e.isEmpty()?null:new Tt(this.firestore,null,new re(e))}withConverter(e){return new or(this.firestore,e,this._path)}}function bi(t,e,...n){if(t=nt(t),iv("collection","path",e),t instanceof jc){const r=Fe.fromString(e,...n);return zp(r),new or(t,null,r)}{if(!(t instanceof Tt||t instanceof or))throw new W(R.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const r=t._path.child(Fe.fromString(e,...n));return zp(r),new or(t.firestore,null,r)}}function Cr(t,e,...n){if(t=nt(t),arguments.length===1&&(e=ay.V()),iv("doc","path",e),t instanceof jc){const r=Fe.fromString(e,...n);return Kp(r),new Tt(t,null,new re(r))}{if(!(t instanceof Tt||t instanceof or))throw new W(R.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const r=t._path.child(Fe.fromString(e,...n));return Kp(r),new Tt(t.firestore,t instanceof or?t.converter:null,new re(r))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class gd{constructor(e,n){if(!isFinite(e)||e<-90||e>90)throw new W(R.INVALID_ARGUMENT,"Latitude must be a number between -90 and 90, but was: "+e);if(!isFinite(n)||n<-180||n>180)throw new W(R.INVALID_ARGUMENT,"Longitude must be a number between -180 and 180, but was: "+n);this._lat=e,this._long=n}get latitude(){return this._lat}get longitude(){return this._long}isEqual(e){return this._lat===e._lat&&this._long===e._long}toJSON(){return{latitude:this._lat,longitude:this._long}}_compareTo(e){return Pe(this._lat,e._lat)||Pe(this._long,e._long)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ca(t){t=Vt(t,Tt);const e=Vt(t.firestore,Nn);return l1(qc(e),t._key).then(n=>wv(e,t,n))}class Id extends C1{constructor(e){super(),this.firestore=e}convertBytes(e){return new Ls(e)}convertReference(e){const n=this.convertDocumentKey(e,this.firestore._databaseId);return new Tt(this.firestore,null,n)}}function Xp(t){t=Vt(t,Fn);const e=Vt(t.firestore,Nn),n=qc(e),r=new Id(e);return pv(t._query),u1(n,t._query).then(s=>new vv(e,r,t,s))}function O1(t,e,n){t=Vt(t,Tt);const r=Vt(t.firestore,Nn),s=_v(t.converter,e,n);return Jc(r,[lv(Wc(r),"setDoc",t._key,s,t.converter!==null,n).toMutation(t._key,zt.none())])}function k1(t,e,n,...r){t=Vt(t,Tt);const s=Vt(t.firestore,Nn),i=Wc(s);let o;return o=typeof(e=nt(e))=="string"||e instanceof Hc?T1(i,"updateDoc",t._key,e,n,r):w1(i,"updateDoc",t._key,e),Jc(s,[o.toMutation(t._key,zt.exists(!0))])}function D1(t){return Jc(Vt(t.firestore,Nn),[new Jh(t._key,zt.none())])}function Ev(t,e){const n=Vt(t.firestore,Nn),r=Cr(t),s=_v(t.converter,e);return Jc(n,[lv(Wc(t.firestore),"addDoc",r._key,s,t.converter!==null,{}).toMutation(r._key,zt.exists(!1))]).then(()=>r)}function N1(t,...e){var n,r,s;t=nt(t);let i={includeMetadataChanges:!1},o=0;typeof e[o]!="object"||Gp(e[o])||(i=e[o],o++);const a={includeMetadataChanges:i.includeMetadataChanges};if(Gp(e[o])){const h=e[o];e[o]=(n=h.next)===null||n===void 0?void 0:n.bind(h),e[o+1]=(r=h.error)===null||r===void 0?void 0:r.bind(h),e[o+2]=(s=h.complete)===null||s===void 0?void 0:s.bind(h)}let c,l,u;if(t instanceof Tt)l=Vt(t.firestore,Nn),u=kc(t._key.path),c={next:h=>{e[o]&&e[o](wv(l,t,h))},error:e[o+1],complete:e[o+2]};else{const h=Vt(t,Fn);l=Vt(h.firestore,Nn),u=h._query;const d=new Id(l);c={next:p=>{e[o]&&e[o](new vv(l,d,h,p))},error:e[o+1],complete:e[o+2]},pv(t._query)}return function(d,p,y,E){const I=new pd(E),C=new dd(p,I,y);return d.asyncQueue.enqueueAndForget(async()=>ld(await Ua(d),C)),()=>{I.La(),d.asyncQueue.enqueueAndForget(async()=>ud(await Ua(d),C))}}(qc(l),u,a,c)}function Jc(t,e){return function(r,s){const i=new Cn;return r.asyncQueue.enqueueAndForget(async()=>QP(await c1(r),s,i)),i.promise}(qc(t),e)}function wv(t,e,n){const r=n.docs.get(e._key),s=new Id(t);return new yv(t,s,e._key,r,new pi(n.hasPendingWrites,n.fromCache),e.converter)}function ED(...t){return new E1("arrayUnion",t)}(function(e,n=!0){(function(s){Ks=s})(js),Cs(new Mr("firestore",(r,{instanceIdentifier:s,options:i})=>{const o=r.getProvider("app").getImmediate(),a=new Nn(new Nb(r.getProvider("auth-internal")),new Lb(r.getProvider("app-check-internal")),function(l,u){if(!Object.prototype.hasOwnProperty.apply(l.options,["projectId"]))throw new W(R.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new Ji(l.options.projectId,u)}(o,s),o);return i=Object.assign({useFetchStreams:n},i),a._setSettings(i),a},"PUBLIC").setMultipleInstances(!0)),ir(pp,"4.2.0",e),ir(pp,"4.2.0","esm2017")})();function Ad(t,e){var n={};for(var r in t)Object.prototype.hasOwnProperty.call(t,r)&&e.indexOf(r)<0&&(n[r]=t[r]);if(t!=null&&typeof Object.getOwnPropertySymbols=="function")for(var s=0,r=Object.getOwnPropertySymbols(t);s<r.length;s++)e.indexOf(r[s])<0&&Object.prototype.propertyIsEnumerable.call(t,r[s])&&(n[r[s]]=t[r[s]]);return n}function Zp(t){return t!==void 0&&t.enterprise!==void 0}class V1{constructor(e){if(this.siteKey="",this.emailPasswordEnabled=!1,e.recaptchaKey===void 0)throw new Error("recaptchaKey undefined");this.siteKey=e.recaptchaKey.split("/")[3],this.emailPasswordEnabled=e.recaptchaEnforcementState.some(n=>n.provider==="EMAIL_PASSWORD_PROVIDER"&&n.enforcementState!=="OFF")}}function Tv(){return{"dependent-sdk-initialized-before-auth":"Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK."}}const M1=Tv,Iv=new oo("auth","Firebase",Tv());/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function nn(t,...e){throw Rd(t,...e)}function pn(t,...e){return Rd(t,...e)}function L1(t,e,n){const r=Object.assign(Object.assign({},M1()),{[e]:n});return new oo("auth","Firebase",r).create(e,{appName:t.name})}function Rd(t,...e){if(typeof t!="string"){const n=e[0],r=[...e.slice(1)];return r[0]&&(r[0].appName=t.name),t._errorFactory.create(n,...r)}return Iv.create(t,...e)}function le(t,e,...n){if(!t)throw Rd(e,...n)}function Sn(t){const e="INTERNAL ASSERTION FAILED: "+t;throw la(e),new Error(e)}function Vn(t,e){t||Sn(e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Io{constructor(e,n){this.shortDelay=e,this.longDelay=n,Vn(n>e,"Short delay should be less than long delay!"),this.isMobile=iR()||aR()}get(){return U1()?this.isMobile?this.longDelay:this.shortDelay:Math.min(5e3,this.shortDelay)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Cv{constructor(){this.type="NONE",this.storage={}}async _isAvailable(){return!0}async _set(e,n){this.storage[e]=n}async _get(e){const n=this.storage[e];return n===void 0?null:n}async _remove(e){delete this.storage[e]}_addListener(e,n){}_removeListener(e,n){}}Cv.type="NONE";const ng=Cv;/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function rg(t){const e=t.toLowerCase();if(e.includes("opera/")||e.includes("opr/")||e.includes("opios/"))return"Opera";if(kv(e))return"IEMobile";if(e.includes("msie")||e.includes("trident/"))return"IE";if(e.includes("edge/"))return"Edge";if(Pv(e))return"Firefox";if(e.includes("silk/"))return"Silk";if(Nv(e))return"Blackberry";if(Vv(e))return"Webos";if(Cd(e))return"Safari";if((e.includes("chrome/")||Ov(e))&&!e.includes("edge/"))return"Chrome";if(Dv(e))return"Android";{const n=/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/,r=t.match(n);if((r==null?void 0:r.length)===2)return r[1]}return"Other"}function Pv(t=It()){return/firefox\//i.test(t)}function Cd(t=It()){const e=t.toLowerCase();return e.includes("safari/")&&!e.includes("chrome/")&&!e.includes("crios/")&&!e.includes("android")}function Ov(t=It()){return/crios\//i.test(t)}function kv(t=It()){return/iemobile/i.test(t)}function Dv(t=It()){return/android/i.test(t)}function Nv(t=It()){return/blackberry/i.test(t)}function Vv(t=It()){return/webos/i.test(t)}function Xc(t=It()){return/iphone|ipad|ipod/i.test(t)||/macintosh/i.test(t)&&/mobile/i.test(t)}function tO(t=It()){var e;return Xc(t)&&!!(!((e=window.navigator)===null||e===void 0)&&e.standalone)}function nO(){return cR()&&document.documentMode===10}function Mv(t=It()){return Xc(t)||Dv(t)||Vv(t)||Nv(t)||/windows phone/i.test(t)||kv(t)}function rO(){try{return!!(window&&window!==window.top)}catch{return!1}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function xv(t,e=[]){let n;switch(t){case"Browser":n=rg(It());break;case"Worker":n=`${rg(It())}-${t}`;break;default:n=t}const r=e.length?e.join(","):"FirebaseCore-web";return`${n}/JsCore/${js}/${r}`}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function gO(t,e){const n=Eh(t,"auth");if(n.isInitialized()){const s=n.getImmediate(),i=n.getOptions();if(Ia(i,e??{}))return s;nn(s,"already-initialized")}return n.initialize({options:e})}function mO(t,e){const n=(e==null?void 0:e.persistence)||[],r=(Array.isArray(n)?n:[n]).map(bn);e!=null&&e.errorMap&&t._updateErrorMap(e.errorMap),t._initializeWithPersistence(r,e==null?void 0:e.popupRedirectResolver)}function _O(t,e,n){const r=Gr(t);le(r._canInitEmulator,r,"emulator-config-failed"),le(/^https?:\/\//.test(e),r,"invalid-emulator-scheme");const s=!!(n!=null&&n.disableWarnings),i=Fv(e),{host:o,port:a}=yO(e),c=a===null?"":`:${a}`;r.config.emulator={url:`${i}//${o}${c}/`},r.settings.appVerificationDisabledForTesting=!0,r.emulatorConfig=Object.freeze({host:o,port:a,protocol:i.replace(":",""),options:Object.freeze({disableWarnings:s})}),s||vO()}function Fv(t){const e=t.indexOf(":");return e<0?"":t.substr(0,e+1)}function yO(t){const e=Fv(t),n=/(\/\/)?([^?#/]+)/.exec(t.substr(e.length));if(!n)return{host:"",port:null};const r=n[2].split("@").pop()||"",s=/^(\[[^\]]+\])(:|$)/.exec(r);if(s){const i=s[1];return{host:i,port:ig(r.substr(i.length+1))}}else{const[i,o]=r.split(":");return{host:i,port:ig(o)}}}function ig(t){if(!t)return null;const e=Number(t);return isNaN(e)?null:e}function vO(){function t(){const e=document.createElement("p"),n=e.style;e.innerText="Running in emulator mode. Do not use with production credentials.",n.position="fixed",n.width="100%",n.backgroundColor="#ffffff",n.border=".1em solid #000000",n.color="#b50000",n.bottom="0px",n.left="0px",n.margin="0px",n.zIndex="10000",n.textAlign="center",e.classList.add("firebase-emulator-warning"),document.body.appendChild(e)}typeof console<"u"&&typeof console.info=="function"&&console.info("WARNING: You are using the Auth Emulator, which is intended for local testing only.  Do not use with production credentials."),typeof window<"u"&&typeof document<"u"&&(document.readyState==="loading"?window.addEventListener("DOMContentLoaded",t):t())}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function wO(t,e){return Ao(t,"POST","/v1/accounts:signInWithEmailLink",zr(t,e))}async function TO(t,e){return Ao(t,"POST","/v1/accounts:signInWithEmailLink",zr(t,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Bv(t,e,n=!1){const r="signIn",s=await $v(t,r,e),i=await Br._fromIdTokenResponse(t,r,s);return n||await t._updateCurrentUser(i.user),i}async function CO(t,e){return Bv(Gr(t),e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function gn(){return window}function BO(t){gn().location.href=t}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Wv(){return typeof gn().WorkerGlobalScope<"u"&&typeof gn().importScripts=="function"}async function jO(){if(!(navigator!=null&&navigator.serviceWorker))return null;try{return(await navigator.serviceWorker.ready).active}catch{return null}}function qO(){var t;return((t=navigator==null?void 0:navigator.serviceWorker)===null||t===void 0?void 0:t.controller)||null}function HO(){return Wv()?self:null}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const tk=new Io(2e3,1e4);class hs extends Jv{constructor(e,n,r,s,i){super(e,n,s,i),this.provider=r,this.authWindow=null,this.pollId=null,hs.currentPopupAction&&hs.currentPopupAction.cancel(),hs.currentPopupAction=this}async executeNotNull(){const e=await this.execute();return le(e,this.auth,"internal-error"),e}async onExecution(){Vn(this.filter.length===1,"Popup operations only handle one event");const e=kd();this.authWindow=await this.resolver._openPopup(this.auth,this.provider,this.filter[0],e),this.authWindow.associatedEvent=e,this.resolver._originValidation(this.auth).catch(n=>{this.reject(n)}),this.resolver._isIframeWebStorageSupported(this.auth,n=>{n||this.reject(pn(this.auth,"web-storage-unsupported"))}),this.pollUserCancellation()}get eventId(){var e;return((e=this.authWindow)===null||e===void 0?void 0:e.associatedEvent)||null}cancel(){this.reject(pn(this.auth,"cancelled-popup-request"))}cleanUp(){this.authWindow&&this.authWindow.close(),this.pollId&&window.clearTimeout(this.pollId),this.authWindow=null,this.pollId=null,hs.currentPopupAction=null}pollUserCancellation(){const e=()=>{var n,r;if(!((r=(n=this.authWindow)===null||n===void 0?void 0:n.window)===null||r===void 0)&&r.closed){this.pollId=window.setTimeout(()=>{this.pollId=null,this.reject(pn(this.auth,"popup-closed-by-user"))},8e3);return}this.pollId=window.setTimeout(e,tk.get())};e()}}hs.currentPopupAction=null;/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const _k=new Io(3e4,6e4);function ug(){const t=gn().___jsl;if(t!=null&&t.H){for(const e of Object.keys(t.H))if(t.H[e].r=t.H[e].r||[],t.H[e].L=t.H[e].L||[],t.H[e].r=[...t.H[e].L],t.CP)for(let n=0;n<t.CP.length;n++)t.CP[n]=null}}function yk(t){return new Promise((e,n)=>{var r,s,i;function o(){ug(),gapi.load("gapi.iframes",{callback:()=>{e(gapi.iframes.getContext())},ontimeout:()=>{ug(),n(pn(t,"network-request-failed"))},timeout:_k.get()})}if(!((s=(r=gn().gapi)===null||r===void 0?void 0:r.iframes)===null||s===void 0)&&s.Iframe)e(gapi.iframes.getContext());else if(!((i=gn().gapi)===null||i===void 0)&&i.load)o();else{const a=uO("iframefcb");return gn()[a]=()=>{gapi.load?o():n(pn(t,"network-request-failed"))},Lv(`https://apis.google.com/js/api.js?onload=${a}`).catch(c=>n(c))}}).catch(e=>{throw da=null,e})}let da=null;function vk(t){return da=da||yk(t),da}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ek=new Io(5e3,15e3),wk="__/auth/iframe",Tk="emulator/auth/iframe",Ik={style:{position:"absolute",top:"-100px",width:"1px",height:"1px"},"aria-hidden":"true",tabindex:"-1"},Ak=new Map([["identitytoolkit.googleapis.com","p"],["staging-identitytoolkit.sandbox.googleapis.com","s"],["test-identitytoolkit.sandbox.googleapis.com","t"]]);function Rk(t){const e=t.config;le(e.authDomain,t,"auth-domain-config-required");const n=e.emulator?Sd(e,Tk):`https://${t.config.authDomain}/${wk}`,r={apiKey:e.apiKey,appName:t.name,v:js},s=Ak.get(t.config.apiHost);s&&(r.eid=s);const i=t._getFrameworks();return i.length&&(r.fw=i.join(",")),`${n}?${ao(r).slice(1)}`}async function Sk(t){const e=await vk(t),n=gn().gapi;return le(n,t,"internal-error"),e.open({where:document.body,url:Rk(t),messageHandlersFilter:n.iframes.CROSS_ORIGIN_IFRAMES_FILTER,attributes:Ik,dontclear:!0},r=>new Promise(async(s,i)=>{await r.restyle({setHideOnLeave:!1});const o=pn(t,"network-request-failed"),a=gn().setTimeout(()=>{i(o)},Ek.get());function c(){gn().clearTimeout(a),s(r)}r.ping(c).then(c,()=>{i(o)})}))}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const bk={location:"yes",resizable:"yes",statusbar:"yes",toolbar:"no"},Ck=500,Pk=600,Ok="_blank",kk="http://localhost";class hg{constructor(e){this.window=e,this.associatedEvent=null}close(){if(this.window)try{this.window.close()}catch{}}}function Dk(t,e,n,r=Ck,s=Pk){const i=Math.max((window.screen.availHeight-s)/2,0).toString(),o=Math.max((window.screen.availWidth-r)/2,0).toString();let a="";const c=Object.assign(Object.assign({},bk),{width:r.toString(),height:s.toString(),top:i,left:o}),l=It().toLowerCase();n&&(a=Ov(l)?Ok:n),Pv(l)&&(e=e||kk,c.scrollbars="yes");const u=Object.entries(c).reduce((d,[p,y])=>`${d}${p}=${y},`,"");if(tO(l)&&a!=="_self")return Nk(e||"",a),new hg(null);const h=window.open(e||"",a,u);le(h,t,"popup-blocked");try{h.focus()}catch{}return new hg(h)}function Nk(t,e){const n=document.createElement("a");n.href=t,n.target=e;const r=document.createEvent("MouseEvent");r.initMouseEvent("click",!0,!0,window,1,0,0,0,0,!1,!1,!1,!1,1,null),n.dispatchEvent(r)}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Bk(t){switch(t){case"Node":return"node";case"ReactNative":return"rn";case"Worker":return"webworker";case"Cordova":return"cordova";default:return}}function jk(t){Cs(new Mr("auth",(e,{options:n})=>{const r=e.getProvider("app").getImmediate(),s=e.getProvider("heartbeat"),i=e.getProvider("app-check-internal"),{apiKey:o,authDomain:a}=r.options;le(o&&!o.includes(":"),"invalid-api-key",{appName:r.name});const c={apiKey:o,authDomain:a,clientPlatform:t,apiHost:"identitytoolkit.googleapis.com",tokenApiHost:"securetoken.googleapis.com",apiScheme:"https",sdkClientVersion:xv(t)},l=new cO(r,s,i,c);return mO(l,n),l},"PUBLIC").setInstantiationMode("EXPLICIT").setInstanceCreatedCallback((e,n,r)=>{e.getProvider("auth-internal").initialize()})),Cs(new Mr("auth-internal",e=>{const n=Gr(e.getProvider("auth").getImmediate());return(r=>new $k(r))(n)},"PRIVATE").setInstantiationMode("EXPLICIT")),ir(fg,pg,Bk(t)),ir(fg,pg,"esm2017")}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
