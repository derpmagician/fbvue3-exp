 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function TS(t){Ps(new Mr("platform-logger",e=>new LR(e),"PRIVATE")),Ps(new Mr("heartbeat",e=>new vS(e),"PRIVATE")),ir(fu,Yf,t),ir(fu,Yf,"esm2017"),ir("fire-js","")}TS("");var IS="firebase",AS="10.4.0";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const lP=new Ke(re.comparator);function Dn(){return lP}const Ey=new Ke(re.comparator);function di(...t){let e=Ey;for(const n of t)e=e.insert(n.key,n);return e}function wy(t){let e=Ey;return t.forEach((n,r)=>e=e.insert(n,r.overlayedDocument)),e}function br(){return Ri()}function Ty(){return Ri()}function Ri(){return new Ws(t=>t.toString(),(t,e)=>t.isEqual(e))}const uP=new Ke(re.comparator),hP=new wt(re.comparator);function Te(...t){let e=hP;for(const n of t)e=e.add(n);return e}const dP=new wt(Ce);function fP(){return dP}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Iy(t,e){if(t.useProto3Json){if(isNaN(e))return{doubleValue:"NaN"};if(e===1/0)return{doubleValue:"Infinity"};if(e===-1/0)return{doubleValue:"-Infinity"}}return{doubleValue:Da(e)?"-0":e}}function Ay(t){return{integerValue:""+t}}function pP(t,e){return Kb(e)?Ay(e):Iy(t,e)}/**
 * @license
 * Copyright 2018 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Lc{constructor(e,n,r,s,i){this.snapshotVersion=e,this.targetChanges=n,this.targetMismatches=r,this.documentUpdates=s,this.resolvedLimboDocuments=i}static createSynthesizedRemoteEventForCurrentChange(e,n,r){const s=new Map;return s.set(e,Eo.createSynthesizedTargetChangeForCurrentChange(e,n,r)),new Lc(de.min(),s,new Ke(Ce),Dn(),Te())}}class Eo{constructor(e,n,r,s,i){this.resumeToken=e,this.current=n,this.addedDocuments=r,this.modifiedDocuments=s,this.removedDocuments=i}static createSynthesizedTargetChangeForCurrentChange(e,n,r){return new Eo(r,n,Te(),Te(),Te())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
